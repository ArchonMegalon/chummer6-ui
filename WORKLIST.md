...
| WL-204 | queued | P1 | Publish runnable backlog evidence for Richer Hub client UX queue coverage and enforce queue/worklist consistency for this slice. | agent | Runnable slice command chain: `bash scripts/ai/milestones/b8-runtime-inspector-check.sh && bash scripts/ai/milestones/ui-milestone-coverage-check.sh && bash scripts/ai/verify.sh` |

## Current repo truth

- Repo-local live queue: active (`WL-204`)
