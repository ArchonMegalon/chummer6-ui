...
* build-lane Windows Authenticode signing and macOS codesign/notarization hooks, plus an explicit unsigned-public-release posture that is only allowed when `CHUMMER_ALLOW_UNSIGNED_PUBLIC_RELEASE=1` is set for the lane
