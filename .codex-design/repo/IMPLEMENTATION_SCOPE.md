...
* automatic post-build publication of the latest successful mainline desktop bundle into configured self-hosted downloads targets, with Windows `win-x64` and Linux `linux-x64` treated as the rolling public-release scope
