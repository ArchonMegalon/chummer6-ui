...
* build-lane Windows Authenticode signing and macOS codesign/notarization hooks that fail closed when `release_candidate` or `public_stable` publication is requested
