...
public sealed class CatalogOnlyRulesetShellCatalogResolver : IRulesetShellCatalogResolver
{
    ...
    [
        ...
        Action("tab-adept.complexforms", "Complex Forms", "tab-adept", WorkspaceSurfaceActionKind.Section, "complexforms"),
        Action("tab-adept.aiprograms", "Programs", "tab-adept", WorkspaceSurfaceActionKind.Section, "aiprograms"),
