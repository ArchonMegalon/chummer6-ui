...
public sealed class CatalogOnlyRulesetShellCatalogResolver : IRulesetShellCatalogResolver
{
    ...
    [
        ...
        Tab("tab-cyberware", "Cyberware", "cyberwares", "character"),
        Tab("tab-adept", "Adept", "powers", "character"),
        Tab("tab-critter", "Critter", "critterpowers", "character"),
        Tab("tab-stats", "Stats", "profile", "character"),
        Tab("tab-technomancer", "Technomancer", "complexforms", "character"),
        Tab("tab-contacts", "Contacts", "contacts", "character"),
        Tab("tab-calendar", "Career", "calendar", "character"),
    ...
    [
        ...
        Action("tab-cyberware.cyberwares", "Cyberware", "tab-cyberware", WorkspaceSurfaceActionKind.Section, "cyberwares"),
        ...
        Action("tab-critter.critterpowers", "Critter Powers", "tab-critter", WorkspaceSurfaceActionKind.Section, "critterpowers"),
        Action("tab-stats.profile", "Runner Intelligence", "tab-stats", WorkspaceSurfaceActionKind.Section, "profile"),
        ...
        Action("tab-calendar.calendar", "Career Log", "tab-calendar", WorkspaceSurfaceActionKind.Section, "calendar"),
