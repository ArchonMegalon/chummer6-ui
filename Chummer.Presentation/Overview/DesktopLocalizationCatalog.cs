...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.preference.title"] = "Alice and dossiers",
        ["desktop.install_link.preference.summary"] = "Choose whether this install shows Alice, Origin Dossier, and guided-help buttons.",
        ["desktop.install_link.preference.checkbox"] = "Show Alice and dossier features",
        ["desktop.install_link.preference.on"] = "Visible in this install.",
        ["desktop.install_link.preference.off"] = "Hidden in this install. You can turn them back on in Settings.",
        ["desktop.install_link.preference.tip"] = "Turn this off to hide Alice, Origin Dossier, and guided-help entry points from the desktop UI.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Alice und Dossiers";
            localized["desktop.install_link.preference.summary"] = "Wahlen Sie, ob diese Installation Alice, Origin Dossier und gefuhrte Hilfe zeigt.";
            localized["desktop.install_link.preference.checkbox"] = "Alice- und Dossier-Funktionen anzeigen";
            localized["desktop.install_link.preference.on"] = "In dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "In dieser Installation ausgeblendet. Sie konnen es in den Einstellungen wieder einschalten.";
            localized["desktop.install_link.preference.tip"] = "Ausschalten, um Alice, Origin Dossier und gefuhrte Hilfe im Desktop auszublenden.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Alice et dossiers";
            localized["desktop.install_link.preference.summary"] = "Choisissez si cette installation affiche Alice, Origin Dossier et l'aide guidee.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher Alice et les dossiers";
            localized["desktop.install_link.preference.on"] = "Visible dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Masque dans cette installation. Vous pouvez le reactiver dans Parametres.";
            localized["desktop.install_link.preference.tip"] = "Desactivez cette option pour masquer Alice, Origin Dossier et l'aide guidee dans le client desktop.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Alice とドシエ";
            localized["desktop.install_link.preference.summary"] = "このインストールで Alice、Origin Dossier、ガイド付きヘルプを表示するか選びます。";
            localized["desktop.install_link.preference.checkbox"] = "Alice とドシエ機能を表示";
            localized["desktop.install_link.preference.on"] = "このインストールで表示します。";
            localized["desktop.install_link.preference.off"] = "このインストールでは非表示です。設定で再度有効にできます。";
            localized["desktop.install_link.preference.tip"] = "オフにすると、デスクトップ UI から Alice、Origin Dossier、ガイド付きヘルプを隠します。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Alice e dossies";
            localized["desktop.install_link.preference.summary"] = "Escolha se esta instalacao mostra Alice, Origin Dossier e ajuda guiada.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar recursos de Alice e dossie";
            localized["desktop.install_link.preference.on"] = "Visivel nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Oculto nesta instalacao. Voce pode reativar em Configuracoes.";
            localized["desktop.install_link.preference.tip"] = "Desative para esconder Alice, Origin Dossier e ajuda guiada da interface desktop.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Alice 与档案";
            localized["desktop.install_link.preference.summary"] = "选择此安装是否显示 Alice、Origin Dossier 与引导帮助入口。";
            localized["desktop.install_link.preference.checkbox"] = "显示 Alice 与档案功能";
            localized["desktop.install_link.preference.on"] = "此安装中可见。";
            localized["desktop.install_link.preference.off"] = "此安装中隐藏。可在设置中重新开启。";
            localized["desktop.install_link.preference.tip"] = "关闭后会从桌面界面隐藏 Alice、Origin Dossier 与引导帮助入口。";
