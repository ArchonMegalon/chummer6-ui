...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.preference.hidden_choice"] = "no, emotionally im a scared caveman",
        ...
        ["desktop.devices.button.reload"] = "Reload status",
        ...
        ["desktop.support_case.intro.preview"] = "This is a local support-case preview shown when no signed-in support case is reachable from this desktop.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.feedback.install_linking_reviewed"] = "Status: Kopie-Claim wurde gepruft.";
            ...
            localized["desktop.campaign.readiness.local_fallback"] = "Runboard-Details sind derzeit auf lokal verfugbare Kampagnendaten begrenzt, bis die Live-Serverebene zuruckkehrt.";
            localized["desktop.campaign.restore.latest_workspace"] = "Letzter lokaler Arbeitsbereich: {0} . {1} UTC";
            localized["desktop.campaign.restore.no_workspace"] = "Noch ist kein lokaler Arbeitsbereich angeheftet, daher bleibt die Wiederherstellung auf Kampagnenzusammenfassung und verknupften Geraetestatus begrenzt.";
            ...
            localized["desktop.install_link.preference.summary"] = "Zeigt oder versteckt Alice, Origin Dossier und generierte Story-Werkzeuge. Die Charaktererstellung funktioniert weiterhin normal.";
            ...
            localized["desktop.install_link.status.opened_account"] = "Die Claim-Seite fur diese Kopie wurde geoffnet.";
            ...
            localized["desktop.update.intro.available"] = "Fur diese Installation ist ein Update verfugbar.";
            localized["desktop.update.intro.attention"] = "Diese Installation braucht Aufmerksamkeit, bevor Sie sich darauf verlassen.";
            localized["desktop.update.intro.never_checked"] = "Fur diese Installation wurde noch kein Update-Status geladen.";
            ...
            localized["desktop.support_case.intro.preview"] = "Dies ist eine lokale Vorschau eines verfolgten Falls, wenn von diesem Desktop kein angemeldeter Support-Fall erreichbar ist.";
            ...
            localized["desktop.support_case.context.verification"] = "Bestatigung: {0}";
            ...
            localized["desktop.devices.section.claimed"] = "Verknüpfte Kopien";
            ...
            localized["desktop.devices.section.current_description"] = "Version, Update-Kanal und Kontolink für diese Installation.";
            localized["desktop.devices.section.claimed_description"] = "Andere Installationen im selben Konto.";
