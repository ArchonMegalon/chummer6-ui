...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.campaign.intro.guest"] = "This campaign dossier is still local-only. Claim this copy before you rely on restore, device status, or support.",
        ["desktop.campaign.intro.local_fallback"] = "The campaign service is unavailable, so this dossier is showing the best local campaign summary and restore status available on this desktop.",
        ["desktop.campaign.intro.watchouts"] = "This campaign dossier is ready to continue, but a few things still need review before you jump back into live session work.",
        ["desktop.campaign.intro.ready"] = "This campaign dossier can reopen session context, runboard context, and support status from the desktop.",
        ["desktop.campaign.status.local_fallback"] = "Campaign dossier status: local campaign data is shown because the live campaign service is unavailable.",
        ["desktop.campaign.status.server_generated"] = "Campaign dossier status: live service updated {0} UTC.",
        ["desktop.campaign.status.refresh_failed"] = "Campaign dossier status: refresh failed, so the last good local state is still shown.",
        ...
        ["desktop.install_link.preference.title"] = "Do u want the AI features enabeld?",
        ...
        ["desktop.install_link.preference.checkbox"] = "Enable AI features",
        ["desktop.install_link.preference.visible_choice"] = "Yes, I'm ready for a modern world like Shadowrun is",
        ["desktop.install_link.preference.hidden_choice"] = "No, emotionally I'm a scared caveman",
        ["desktop.install_link.preference.on"] = "AI features are enabled in this install.",
        ["desktop.install_link.preference.off"] = "AI features are disabled in this install.",
        ["desktop.install_link.preference.tip"] = "Disables Alice, Origin Dossier, and generated story entry points. Character creation, rules, updates, and downloads stay available.",
        ...
        ["desktop.home.intro.ready_current_campaign_workspace"] = "This copy is linked, current enough to continue, and ready to reopen the current campaign dossier.",
        ...
        ["desktop.home.workspace_summary.empty"] = "No recent dossiers were restored yet. Import or create a runner to get started.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Willst du die KI-Funktionen aktivieren?";
            ...
            localized["desktop.install_link.preference.checkbox"] = "KI-Funktionen aktivieren";
            localized["desktop.install_link.preference.visible_choice"] = "Ja, ich bin bereit für eine moderne Welt wie Shadowrun";
            localized["desktop.install_link.preference.hidden_choice"] = "Nein, emotional bin ich ein ängstlicher Höhlenmensch";
            localized["desktop.install_link.preference.on"] = "KI-Funktionen sind in dieser Installation aktiviert.";
            localized["desktop.install_link.preference.off"] = "KI-Funktionen sind in dieser Installation deaktiviert.";
            localized["desktop.install_link.preference.tip"] = "Deaktiviert Alice, Origin Dossier und generierte Story-Einstiege. Charaktererstellung, Regeln, Updates und Downloads bleiben verfügbar.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Voulez-vous activer les fonctions IA ?";
            ...
            localized["desktop.install_link.preference.checkbox"] = "Activer les fonctions IA";
            localized["desktop.install_link.preference.visible_choice"] = "Oui, je suis pret pour un monde moderne comme Shadowrun";
            localized["desktop.install_link.preference.hidden_choice"] = "Non, emotionnellement je suis un homme des cavernes effraye";
            localized["desktop.install_link.preference.on"] = "Les fonctions IA sont activees dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les fonctions IA sont desactivees dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Desactive Alice, Origin Dossier et les entrees narratives generees. Creation de personnage, regles, mises a jour et telechargements restent disponibles.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "AI機能を有効にしますか？";
            localized["desktop.install_link.preference.summary"] = "Alice、Origin Dossier、生成ストーリーツールの表示を切り替えます。キャラクター作成は通常どおり使えます。";
            localized["desktop.install_link.preference.checkbox"] = "AI機能を有効にする";
            localized["desktop.install_link.preference.visible_choice"] = "はい、Shadowrunのような現代世界への準備はできています";
            localized["desktop.install_link.preference.hidden_choice"] = "いいえ、感情的には怖がりな原始人です";
            localized["desktop.install_link.preference.on"] = "このインストールではAI機能が有効です。";
            localized["desktop.install_link.preference.off"] = "このインストールではAI機能が無効です。";
            localized["desktop.install_link.preference.tip"] = "Alice、Origin Dossier、生成ストーリー入口を無効にします。キャラクター作成、ルール、更新、ダウンロードは利用できます。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Quer ativar os recursos de IA?";
            ...
            localized["desktop.install_link.preference.checkbox"] = "Ativar recursos de IA";
            localized["desktop.install_link.preference.visible_choice"] = "Sim, estou pronto para um mundo moderno como Shadowrun";
            localized["desktop.install_link.preference.hidden_choice"] = "Nao, emocionalmente sou um homem das cavernas assustado";
            localized["desktop.install_link.preference.on"] = "Recursos de IA estao ativados nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Recursos de IA estao desativados nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Desativa Alice, Origin Dossier e entradas de historia geradas. Criacao de personagem, regras, atualizacoes e downloads continuam disponiveis.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "要启用 AI 功能吗？";
            localized["desktop.install_link.preference.summary"] = "显示或隐藏 Alice、Origin Dossier 和生成的故事工具。角色创建仍可正常使用。";
            localized["desktop.install_link.preference.checkbox"] = "启用 AI 功能";
            localized["desktop.install_link.preference.visible_choice"] = "是的，我准备好迎接像 Shadowrun 一样的现代世界";
            localized["desktop.install_link.preference.hidden_choice"] = "不，情绪上我是个害怕的穴居人";
            localized["desktop.install_link.preference.on"] = "此安装中 AI 功能已启用。";
            localized["desktop.install_link.preference.off"] = "此安装中 AI 功能已禁用。";
            localized["desktop.install_link.preference.tip"] = "禁用 Alice、Origin Dossier 和生成的故事入口。角色创建、规则、更新和下载仍可使用。";
