...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.preference.title"] = "Feature visibility",
        ["desktop.install_link.preference.summary"] = "Choose what this copy shows after linking. You can change this later in Settings.",
        ["desktop.install_link.preference.checkbox"] = "Show Alice and dossier features",
        ["desktop.install_link.preference.visible_choice"] = "Show Alice, dossiers, and guided help",
        ["desktop.install_link.preference.hidden_choice"] = "Hide Alice, dossiers, and guided help",
        ["desktop.install_link.preference.on"] = "Guided tools are visible in this install.",
        ["desktop.install_link.preference.off"] = "Guided tools are hidden in this install.",
        ["desktop.install_link.preference.tip"] = "This controls whether Alice, Origin Dossier, and guided-help entry points appear in the desktop UI.",
        ...
        ["desktop.install_link.status.alice_visible"] = "Alice and dossier features are visible.",
        ["desktop.install_link.status.alice_hidden"] = "Alice and dossier features are hidden.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Feature-Sichtbarkeit";
            localized["desktop.install_link.preference.summary"] = "Wahlen Sie, was diese Installation nach dem Verknupfen zeigt. Das kann spater in Einstellungen geandert werden.";
            localized["desktop.install_link.preference.checkbox"] = "Alice- und Dossier-Funktionen anzeigen";
            localized["desktop.install_link.preference.visible_choice"] = "Alice, Dossiers und gefuhrte Hilfe anzeigen";
            localized["desktop.install_link.preference.hidden_choice"] = "Alice, Dossiers und gefuhrte Hilfe ausblenden";
            localized["desktop.install_link.preference.on"] = "Gefuhrte Werkzeuge sind in dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "Gefuhrte Werkzeuge sind in dieser Installation ausgeblendet.";
            localized["desktop.install_link.preference.tip"] = "Diese Einstellung steuert, ob Alice, Origin Dossier und gefuhrte Hilfe im Desktop sichtbar sind.";
            ...
            localized["desktop.install_link.status.alice_visible"] = "Alice- und Dossier-Funktionen sind sichtbar.";
            localized["desktop.install_link.status.alice_hidden"] = "Alice- und Dossier-Funktionen sind ausgeblendet.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Visibilite des fonctions";
            localized["desktop.install_link.preference.summary"] = "Choisissez ce que cette installation affiche apres la liaison. Vous pourrez le modifier plus tard dans Parametres.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher Alice et les dossiers";
            localized["desktop.install_link.preference.visible_choice"] = "Afficher Alice, les dossiers et l'aide guidee";
            localized["desktop.install_link.preference.hidden_choice"] = "Masquer Alice, les dossiers et l'aide guidee";
            localized["desktop.install_link.preference.on"] = "Les outils guides sont visibles dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les outils guides sont masques dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Ce reglage controle si Alice, Origin Dossier et l'aide guidee apparaissent dans le client desktop.";
            ...
            localized["desktop.install_link.status.alice_visible"] = "Alice et les dossiers sont visibles.";
            localized["desktop.install_link.status.alice_hidden"] = "Alice et les dossiers sont masques.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "機能の表示";
            localized["desktop.install_link.preference.summary"] = "リンク後にこのコピーで表示する機能を選びます。後で設定から変更できます。";
            localized["desktop.install_link.preference.checkbox"] = "Alice とドシエ機能を表示";
            localized["desktop.install_link.preference.visible_choice"] = "Alice、ドシエ、ガイド付きヘルプを表示";
            localized["desktop.install_link.preference.hidden_choice"] = "Alice、ドシエ、ガイド付きヘルプを非表示";
            localized["desktop.install_link.preference.on"] = "ガイド付きツールはこのインストールで表示されます。";
            localized["desktop.install_link.preference.off"] = "ガイド付きツールはこのインストールで非表示です。";
            localized["desktop.install_link.preference.tip"] = "この設定は、Alice、Origin Dossier、ガイド付きヘルプをデスクトップ UI に表示するかを制御します。";
            ...
            localized["desktop.install_link.status.alice_visible"] = "Alice とドシエ機能は表示されています。";
            localized["desktop.install_link.status.alice_hidden"] = "Alice とドシエ機能は非表示です。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Visibilidade de recursos";
            localized["desktop.install_link.preference.summary"] = "Escolha o que esta instalacao mostra depois de vincular. Voce pode alterar depois em Configuracoes.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar recursos de Alice e dossie";
            localized["desktop.install_link.preference.visible_choice"] = "Mostrar Alice, dossies e ajuda guiada";
            localized["desktop.install_link.preference.hidden_choice"] = "Ocultar Alice, dossies e ajuda guiada";
            localized["desktop.install_link.preference.on"] = "Ferramentas guiadas estao visiveis nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Ferramentas guiadas estao ocultas nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Esta configuracao controla se Alice, Origin Dossier e ajuda guiada aparecem na interface desktop.";
            ...
            localized["desktop.install_link.status.alice_visible"] = "Recursos de Alice e dossie estao visiveis.";
            localized["desktop.install_link.status.alice_hidden"] = "Recursos de Alice e dossie estao ocultos.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "功能可见性";
            localized["desktop.install_link.preference.summary"] = "选择此副本在绑定后显示哪些功能。稍后可在设置中更改。";
            localized["desktop.install_link.preference.checkbox"] = "显示 Alice 与档案功能";
            localized["desktop.install_link.preference.visible_choice"] = "显示 Alice、档案和引导帮助";
            localized["desktop.install_link.preference.hidden_choice"] = "隐藏 Alice、档案和引导帮助";
            localized["desktop.install_link.preference.on"] = "引导工具在此安装中可见。";
            localized["desktop.install_link.preference.off"] = "引导工具在此安装中隐藏。";
            localized["desktop.install_link.preference.tip"] = "此设置控制 Alice、Origin Dossier 和引导帮助入口是否显示在桌面界面中。";
            ...
            localized["desktop.install_link.status.alice_visible"] = "Alice 与档案功能已显示。";
            localized["desktop.install_link.status.alice_hidden"] = "Alice 与档案功能已隐藏。";
