...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.shell.tool.horizons"] = "Tools",
        ["desktop.shell.tool.campaign_workspace"] = "Campaign",
        ["desktop.shell.tool.update_status"] = "Update Status",
        ["desktop.shell.tool.link_copy"] = "Claim your copy",
        ...
        ["desktop.shell.tool.status_idle"] = "Idle",
        ...
        ["desktop.shell.state.error"] = "Error - {0}",
        ...
        ["desktop.shell.feedback.import_raw_required"] = "Paste character XML before importing.",
        ["desktop.shell.feedback.import_file_unavailable"] = "File picker is unavailable on this platform.",
        ["desktop.shell.feedback.import_file_cancelled"] = "{0} selection cancelled.",
        ["desktop.shell.feedback.demo_runner_unavailable"] = "The bundled sample character is unavailable in this build.",
        ["desktop.shell.feedback.demo_runner_loading"] = "Opening bundled sample character from {0}.",
        ["desktop.shell.feedback.no_active_workspace"] = "No active runner to close.",
        ["desktop.shell.feedback.desktop_home_reviewed"] = "Desktop home reviewed.",
        ["desktop.shell.feedback.campaign_workspace_reviewed"] = "Campaign reviewed.",
        ["desktop.shell.feedback.update_reviewed"] = "Update reviewed.",
        ["desktop.shell.feedback.install_linking_reviewed"] = "Copy claim reviewed.",
        ["desktop.shell.feedback.support_reviewed"] = "Support reviewed.",
        ["desktop.shell.feedback.report_issue_reviewed"] = "Report issue reviewed.",
        ["desktop.shell.feedback.settings_reviewed"] = "Settings reviewed.",
        ["desktop.shell.feedback.install_support_unavailable"] = "Support is unavailable on this host.",
        ["desktop.shell.feedback.operation_failed_state"] = "{0} failed: {1}",
        ...
        ["desktop.home.section.update_posture"] = "Updates",
        ["desktop.home.section.campaign_return"] = "Campaign return and restore",
        ["desktop.home.section.support_closure"] = "Support and fix notices",
        ...
        ["desktop.horizons.intro"] = "Open Chummer tools from one desktop hub. Stay in the app first; open the signed-in or public page only when it is the right target.",
        ["desktop.horizons.button.open_public_index"] = "Open roadmap",
        ["desktop.campaign.title"] = "Campaign",
        ["desktop.campaign.heading"] = "Campaign",
        ...
        ["desktop.campaign.intro.watchouts"] = "This campaign is ready to continue, but a few things still need review before you jump back into live session work.",
        ["desktop.campaign.intro.ready"] = "This campaign can reopen session context, runboard context, and support status from the desktop.",
        ["desktop.campaign.status.local_fallback"] = "Campaign status: local campaign data is shown because the live campaign service is unavailable.",
        ...
        ["desktop.install_link.summary"] = "Downloaded files stay public. Claim this copy online when you want account return, recovery, or support attached to this install.",
        ["desktop.install_link.shipping_locales"] = "Available languages: {0}.",
        ["desktop.install_link.claim_code_label"] = "Fallback claim code",
        ["desktop.install_link.more_tools"] = "More tools",
        ["desktop.install_link.next_step"] = "Next step",
        ["desktop.install_link.preference.title"] = "Show optional story tools?",
        ["desktop.install_link.preference.summary"] = "Choose whether Chummer shows Alice, Origin Dossier, and optional story tools. Character creation works normally either way.",
        ["desktop.install_link.preference.checkbox"] = "Show optional story tools",
        ["desktop.install_link.preference.visible_choice"] = "Show Alice and Origin Dossier",
        ["desktop.install_link.preference.hidden_choice"] = "Keep character creation focused",
        ["desktop.install_link.preference.on"] = "Optional story tools are shown in this install.",
        ["desktop.install_link.preference.off"] = "Optional story tools are hidden in this install.",
        ["desktop.install_link.preference.tip"] = "Hides Alice, Origin Dossier, and optional story entry points. Character creation, rules, updates, and downloads stay available.",
        ...
        ["desktop.home.install_summary.linked_status"] = "Linked to account. Grant expires {0} UTC.",
        ["desktop.home.install_summary.unlinked_status"] = "Not linked yet. Support gets stronger once this copy is claimed.",
        ...
        ["desktop.home.update_summary"] = "Build: {1}\nUpdated: {3} UTC\nChannel: {4}\nUpdate setting: {6}\nStatus: {0}\nNext step: {15}\nIssue: {16}",
        ...
        ["desktop.home.button.open_horizons_public"] = "Open roadmap",
        ...
        ["desktop.dialog.global_settings.message"] = "Language changes apply after restart. Available languages: {0}",
        ...
        ["desktop.dialog.global_settings.notice.updated_restart"] = "Settings updated. Restart Chummer to apply {0} everywhere.",
        ...
        ["desktop.install_link.status.opened_support"] = "Opened support for this copy.",
        ["desktop.install_link.status.unable_open_support"] = "Unable to open support from this host.",
        ["desktop.install_link.status.claim_code_required"] = "Paste the fallback claim code first.",
        ["desktop.install_link.status.linking"] = "Claiming this installation...",
        ["desktop.install_link.status.guided_tools_visible"] = "Helper buttons are visible.",
        ["desktop.install_link.status.guided_tools_hidden"] = "Helper buttons are hidden.",
        ["desktop.install_link.summary.installation_id"] = "Installation ID: {0}",
        ["desktop.install_link.summary.head"] = "App: {0}",
        ...
        ["desktop.install_link.summary.status"] = "{0}",
        ...
        ["desktop.devices.section.current"] = "This install",
        ["desktop.devices.section.claimed"] = "Linked copies",
        ["desktop.devices.section.claims"] = "Claim this copy",
        ["desktop.devices.section.follow_through"] = "Support and recovery",
        ["desktop.devices.section.current_description"] = "Version, update channel, and account link for this install.",
        ["desktop.devices.section.claimed_description"] = "Other installs linked to the same account.",
        ...
        ["desktop.update.heading"] = "Updates",
        ["desktop.update.section.current"] = "Current version",
        ["desktop.update.section.follow_through"] = "What happens next",
        ["desktop.update.section.install"] = "Install context",
        ["desktop.update.button.check_now"] = "Check for Updates",
        ["desktop.update.button.open_pending_installer"] = "Open Downloaded Installer",
        ["desktop.update.button.copy_install_command"] = "Copy Install Command",
        ["desktop.update.button.refresh"] = "Check again",
        ["desktop.update.intro.disabled"] = "Updates are not configured for this install yet.",
        ["desktop.update.intro.available"] = "An update is available for this install.",
        ["desktop.update.intro.attention"] = "This install needs attention before you rely on it.",
        ["desktop.update.intro.never_checked"] = "No update status has been loaded yet for this install.",
        ["desktop.update.intro.current"] = "This install is current enough to continue.",
        ["desktop.update.checking"] = "Looking for updates.",
        ["desktop.update.checked"] = "Update check finished: {0}.",
        ...
        ["desktop.update.mode"] = "Update mode: {0}",
        ["desktop.update.status.clipboard_unavailable"] = "Clipboard access is unavailable in this desktop host.",
        ["desktop.update.status.install_command_copied"] = "The install command was copied.",
        ["desktop.update.status.install_command_unavailable"] = "No local install command is available for this update.",
        ["desktop.update.manifest_location"] = "Update source: {0}",
        ["desktop.update.updates_enabled"] = "Updates enabled: {0}",
        ["desktop.support.title"] = "Support",
        ["desktop.support.heading"] = "Support",
        ["desktop.support.section.case"] = "Current case",
        ["desktop.support.section.release"] = "Release and install context",
        ["desktop.support.section.follow_through"] = "Next steps",
        ["desktop.support.section.diagnostics"] = "System summary",
        ["desktop.support.button.refresh"] = "Reload support state",
        ["desktop.support.intro.guest"] = "This install is not linked. Link it to enable install-specific fixes and notices.",
        ["desktop.support.intro.quiet"] = "No tracked case is attached right now. Support will show next steps when a real case exists.",
        ["desktop.support.intro.action_needed"] = "This tracked case still needs one more step on this install.",
        ["desktop.support.intro.tracked"] = "A tracked support case is attached to this install.",
        ["desktop.support.status.current"] = "Support status: current support view loaded.",
        ["desktop.support.status.refresh_failed"] = "Support status: refresh failed, so the last good view is still shown.",
        ...
        ["desktop.support.follow_through.claimed"] = "This claimed copy can open updates, case details, and confirmation from one place.",
        ["desktop.support.follow_through.guest"] = "Support is limited to guest mode until this copy is linked.",
        ["desktop.support.follow_through.attention"] = "One confirmation step is still needed before this case can be closed.",
        ["desktop.support_case.title"] = "Tracked support case",
        ["desktop.support_case.heading"] = "Support case",
        ["desktop.support_case.section.summary"] = "Case summary and status",
        ["desktop.support_case.section.timeline"] = "Timeline and attachments",
        ["desktop.support_case.section.follow_through"] = "Next steps",
        ["desktop.support_case.section.diagnostics"] = "System summary",
        ["desktop.support_case.button.refresh"] = "Reload case",
        ["desktop.support_case.button.open_attachment"] = "Open Attachment",
        ["desktop.support_case.intro.preview"] = "This is a local preview shown when no signed-in case can be reached from this desktop.",
        ["desktop.support_case.intro.fallback"] = "Live case details are unavailable right now, so Chummer is showing the best local summary instead.",
        ["desktop.support_case.intro.action_needed"] = "This case still needs one more step before it can be closed for this copy.",
        ["desktop.support_case.intro.current"] = "This case explains what changed, why it is still open, and what is safe to do next.",
        ["desktop.support_case.status.current"] = "Tracked case status: current detail is loaded.",
        ["desktop.support_case.status.preview"] = "Tracked case status: local preview loaded.",
        ["desktop.support_case.status.case_unavailable"] = "Tracked case status: detailed case data is unavailable, so the local summary is still shown.",
        ["desktop.support_case.status.refresh_failed"] = "Tracked case status: refresh failed, so the last good case view is still shown.",
        ...
        ["desktop.support_case.context.timeline_fallback"] = "Timeline detail is limited to the local case summary until the live support record is reachable again.",
        ["desktop.support_case.context.attachment"] = "Attachment: {0} | {1} | uploaded {2} UTC",
        ["desktop.support_case.follow_through.current"] = "You can continue from this window without leaving the app.",
        ["desktop.support_case.follow_through.attention"] = "This case still needs one more step before it can be closed.",
        ["desktop.support_case.follow_through.link_install"] = "Next safe action: open Your Copy and reclaim the affected install before you trust the fix here.",
        ["desktop.support_case.follow_through.update_install"] = "Next safe action: open Update status and install the listed fix before you verify it here.",
        ["desktop.support_case.follow_through.verify"] = "This copy already has the fix. Use account support to record final confirmation.",
        ["desktop.crash.title"] = "Crash recovery",
        ["desktop.crash.heading"] = "Crash recovery",
        ["desktop.crash.section.summary"] = "Crash summary and details",
        ["desktop.crash.section.recovery"] = "Recovery",
        ...
        ["desktop.crash.intro.preview"] = "This is a local crash-recovery preview. A real pending crash would appear here on the next launch after failure.",
        ...
        ["desktop.crash.recovery.private_local"] = "Diagnostics stay local by default. Automatic send uses a redacted crash report and does not replace support.",
        ["desktop.crash.recovery.retry"] = "If the last automatic send failed, retry from here, keep the report local only, or send a support report.",
        ["desktop.crash.recovery.preview"] = "Preview mode skips hosted send and only opens this recovery window.",
        ...
        ["desktop.crash.status.current"] = "Crash status: local crash details are available.",
        ["desktop.crash.status.preview"] = "Crash status: preview loaded without a real pending crash.",
        ...
        ["desktop.report.intro"] = "Send a clear report with the details support needs. You can open it in the browser or copy it.",
        ["desktop.report.private_split"] = "Reports include app context only. Add screenshots or files yourself if needed.",
        ["desktop.report.section.context"] = "Desktop context",
        ["desktop.report.section.bug"] = "Bug report",
        ["desktop.report.section.feedback"] = "Feedback",
        ["desktop.report.context.manifest"] = "Update source: {0}",
        ["desktop.report.context.supportability"] = "Support status: {0}",
        ["desktop.report.bug.intro"] = "Use this for reproducible behavior. Expected versus actual detail and repro steps help support fix the problem.",
        ...
        ["desktop.report.bug.evidence_label"] = "Screenshot or attachment note",
        ["desktop.report.bug.evidence_watermark"] = "Optional: screenshot path, attachment note, or crash id",
        ["desktop.report.feedback.intro"] = "Use this for ideas, confusion, or anything that does not need a full bug report.",
        ...
        ["desktop.report.feedback.detail_watermark"] = "Optional detail for triage, design review, or next steps",
        ["desktop.report.button.open_bug"] = "Open Bug Report",
        ["desktop.report.button.copy_bug"] = "Copy Bug Report",
        ["desktop.report.button.open_feedback"] = "Open Feedback",
        ["desktop.report.button.copy_feedback"] = "Copy Feedback",
        ["desktop.report.status.ready"] = "Ready.",
        ["desktop.report.status.bug_opened"] = "Opened bug report.",
        ["desktop.report.status.feedback_opened"] = "Opened feedback.",
        ["desktop.report.status.bug_copied"] = "Bug report copied.",
        ["desktop.report.status.feedback_copied"] = "Feedback copied.",
        ["desktop.report.status.bug_copied_fallback"] = "The browser did not open, so the bug report was copied instead.",
        ["desktop.report.status.feedback_copied_fallback"] = "The browser did not open, so the feedback was copied instead.",
        ["desktop.report.status.clipboard_unavailable"] = "Clipboard access is unavailable.",
        ["desktop.report.status.portal_unavailable"] = "Unable to open the browser or copy the report."
    };
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.horizons"] = "Werkzeuge";
            localized["desktop.shell.tool.campaign_workspace"] = "Kampagne";
            ...
            localized["desktop.shell.tool.status_idle"] = "inaktiv";
            ...
            localized["desktop.shell.state.snapshot"] = "{0}, arbeitsbereich={1}, offen={2}, gespeichert={3}, letzter-befehl={4}";
            localized["desktop.shell.state.error"] = "Fehler - {0}";
            localized["desktop.shell.feedback.import_raw_required"] = "Fugen Sie vor dem Import Charakter-XML ein.";
            localized["desktop.shell.feedback.import_file_unavailable"] = "Dateiauswahl ist auf dieser Plattform nicht verfügbar.";
            localized["desktop.shell.feedback.import_file_cancelled"] = "Auswahl für {0} wurde abgebrochen.";
            localized["desktop.shell.feedback.demo_runner_unavailable"] = "Der mitgelieferte Beispielcharakter ist in diesem Build nicht verfügbar.";
            localized["desktop.shell.feedback.demo_runner_loading"] = "Mitgelieferter Beispielcharakter wird aus {0} geöffnet.";
            localized["desktop.shell.feedback.no_active_workspace"] = "Kein aktiver Runner zum Schließen.";
            localized["desktop.shell.feedback.desktop_home_reviewed"] = "Desktop-Start wurde geprüft.";
            localized["desktop.shell.feedback.campaign_workspace_reviewed"] = "Kampagne geprüft.";
            localized["desktop.shell.feedback.update_reviewed"] = "Update-Status wurde geprüft.";
            localized["desktop.shell.feedback.install_linking_reviewed"] = "Kopie-Claim wurde geprüft.";
            localized["desktop.shell.feedback.support_reviewed"] = "Support wurde geprüft.";
            localized["desktop.shell.feedback.report_issue_reviewed"] = "Fehlerbericht wurde geprüft.";
            localized["desktop.shell.feedback.settings_reviewed"] = "Einstellungen wurden geprüft.";
            localized["desktop.shell.feedback.install_support_unavailable"] = "Support-Nachverfolgung ist auf diesem Host nicht verfügbar.";
            localized["desktop.shell.feedback.operation_failed_state"] = "Fehler - {0} fehlgeschlagen: {1}";
            ...
            localized["desktop.shell.notice.download_unavailable"] = "Hinweis: Download angefordert, aber Dateispeichern ist auf dieser Plattform nicht verfügbar.";
            ...
            localized["desktop.shell.notice.export_unavailable"] = "Hinweis: Export angefordert, aber Dateispeichern ist auf dieser Plattform nicht verfügbar.";
            ...
            localized["desktop.shell.notice.print_unavailable"] = "Hinweis: Druckvorschau angefordert, aber Dateispeichern ist auf dieser Plattform nicht verfügbar.";
            ...
            localized["desktop.home.section.update_posture"] = "Aktualisierungen";
            localized["desktop.home.section.campaign_return"] = "Kampagnen-Rückkehr und Wiederherstellung";
            localized["desktop.home.section.support_closure"] = "Support und Fix-Hinweise";
            ...
            localized["desktop.horizons.intro"] = "Öffne Chummer-Werkzeuge aus einem Desktop-Hub. Bleib zuerst in der App; öffne die angemeldete oder öffentliche Webseite nur, wenn sie das richtige Ziel ist.";
            localized["desktop.horizons.button.open_public_index"] = "Roadmap öffnen";
            ...
            localized["desktop.home.button.open_horizons_public"] = "Roadmap öffnen";
            localized["desktop.home.install_summary.install_id"] = "Installations-ID: {0}";
            localized["desktop.home.install_summary.head"] = "App: {0}";
            ...
            localized["desktop.home.install_summary.linked_status"] = "Mit Konto verknüpft. Grant läuft um {0} UTC ab.";
            localized["desktop.home.install_summary.unlinked_status"] = "Noch nicht verknüpft. Support und Abschluss sind stärker, sobald die Installation beansprucht ist.";
            localized["desktop.home.install_summary.last_guest_defer"] = "Letzte Gast-Zurückstellung: {0} UTC.";
            ...
            localized["desktop.install_link.claim_code_label"] = "Anmeldecode";
            localized["desktop.install_link.more_tools"] = "Weitere Tools";
            localized["desktop.install_link.next_step"] = "Nächster Schritt";
            localized["desktop.install_link.preference.title"] = "Optionale Story-Werkzeuge anzeigen?";
            localized["desktop.install_link.preference.summary"] = "Wähle, ob Chummer Alice, Origin Dossier und optionale Story-Werkzeuge zeigt. Die Charaktererstellung funktioniert in beiden Fällen normal.";
            localized["desktop.install_link.preference.checkbox"] = "Optionale Story-Werkzeuge anzeigen";
            localized["desktop.install_link.preference.visible_choice"] = "Alice und Origin Dossier anzeigen";
            localized["desktop.install_link.preference.hidden_choice"] = "Charaktererstellung fokussiert halten";
            localized["desktop.install_link.preference.on"] = "Optionale Story-Werkzeuge sind in dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "Optionale Story-Werkzeuge sind in dieser Installation ausgeblendet.";
            localized["desktop.install_link.preference.tip"] = "Blendet Alice, Origin Dossier und optionale Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfügbar.";
            ...
            localized["desktop.install_link.status.unable_open_support"] = "Support kann auf diesem Host nicht geöffnet werden.";
            localized["desktop.install_link.button.copy_login_url"] = "Claim-Link kopieren";
            localized["desktop.install_link.status.login_url_copied"] = "Der Claim-Link wurde kopiert. Öffnen Sie ihn im Browser, um diese Kopie zu beanspruchen.";
            localized["desktop.install_link.status.manual_login_url"] = "Der Browser-Claim wurde nicht automatisch geöffnet. Öffnen oder kopieren Sie diesen Claim-Link, um diese Kopie zu beanspruchen:";
            localized["desktop.install_link.summary.browser_open_attempt"] = "Browser-Claim-Versuch: {0} UTC.";
            localized["desktop.install_link.summary.browser_open_error"] = "Browser-Claim-Fehler: {0}";
            localized["desktop.install_link.status.claim_code_required"] = "Fugen Sie zuerst den Anmeldecode ein.";
            localized["desktop.install_link.status.linking"] = "Diese Kopie wird beansprucht...";
            localized["desktop.install_link.status.guided_tools_visible"] = "Helfer-Buttons sind sichtbar.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Helfer-Buttons sind ausgeblendet.";
            localized["desktop.install_link.summary.installation_id"] = "Installations-ID: {0}";
            localized["desktop.install_link.summary.head"] = "App: {0}";
            ...
            localized["desktop.install_link.summary.status"] = "{0}";
            localized["desktop.install_link.summary.linked_status"] = "Beansprucht. Zugriff läuft um {0} UTC ab.";
            localized["desktop.install_link.summary.guest_status"] = "Noch nicht beansprucht. Sie konnen diese Kopie als Gast weiterverwenden.";
            ...
            localized["desktop.update.heading"] = "Aktualisierungen";
            localized["desktop.update.section.current"] = "Aktuelle Version";
            localized["desktop.update.section.follow_through"] = "Nächste Schritte";
            ...
            localized["desktop.update.button.open_pending_installer"] = "Geladenen Installer öffnen";
            localized["desktop.update.button.copy_install_command"] = "Installationsbefehl kopieren";
            localized["desktop.update.button.refresh"] = "Erneut prüfen";
            localized["desktop.update.intro.disabled"] = "Selbstaktualisierung ist für diese Installation noch nicht konfiguriert.";
            localized["desktop.update.intro.available"] = "Für diese Installation ist ein Update verfügbar.";
            localized["desktop.update.intro.attention"] = "Diese Installation braucht Aufmerksamkeit, bevor Sie sich darauf verlassen.";
            localized["desktop.update.intro.never_checked"] = "Für diese Installation wurde noch kein Update-Status geladen.";
            localized["desktop.update.intro.current"] = "Diese Installation ist aktuell genug, um fortzufahren.";
            localized["desktop.update.checking"] = "Suche nach Updates.";
            localized["desktop.update.checked"] = "Update-Ergebnis: {0}.";
            ...
            localized["desktop.update.last_checked"] = "Zuletzt geprüft: {0} UTC.";
            ...
            localized["desktop.update.mode"] = "Update-Modus: {0}";
            localized["desktop.update.status.clipboard_unavailable"] = "Zwischenablage ist in dieser Desktop-Umgebung nicht verfügbar.";
            localized["desktop.update.status.install_command_copied"] = "Der Installationsbefehl wurde kopiert.";
            localized["desktop.update.status.install_command_unavailable"] = "Für dieses Update ist kein lokaler Installationsbefehl verfügbar.";
            localized["desktop.update.manifest_location"] = "Update-Quelle: {0}";
            localized["desktop.update.updates_enabled"] = "Updates aktiviert: {0}";
            localized["desktop.support.heading"] = "Support";
            localized["desktop.support.section.case"] = "Aktueller Fall";
            localized["desktop.support.section.release"] = "Release- und Installationskontext";
            localized["desktop.support.section.follow_through"] = "Nächste Schritte";
            localized["desktop.support.section.diagnostics"] = "Systemübersicht";
            ...
            localized["desktop.support.intro.quiet"] = "Aktuell ist kein verfolgter Fall angebunden. Support zeigt die nachsten Schritte, sobald ein echter Fall existiert.";
            localized["desktop.support.intro.action_needed"] = "Dieser verfolgte Fall braucht auf dieser Installation noch einen Schritt.";
            localized["desktop.support.intro.tracked"] = "Dieser Installation ist ein verfolgter Support-Fall zugeordnet.";
            localized["desktop.support.status.current"] = "Support-Status: aktuelle Support-Ansicht ist geladen.";
            localized["desktop.support.status.refresh_failed"] = "Support-Status: Aktualisierung fehlgeschlagen, daher wird weiter die letzte gute Ansicht gezeigt.";
            ...
            localized["desktop.support.context.fix_availability"] = "Fix-Verfügbarkeit: {0}";
            localized["desktop.support.context.last_error"] = "Letzter Update-Fehler: {0}";
            localized["desktop.support.follow_through.claimed"] = "Diese verknüpfte Kopie öffnet Updates, Falldetails und Bestätigung an einem Ort.";
            localized["desktop.support.follow_through.guest"] = "Support ist auf den Gastmodus begrenzt, bis diese Kopie verknüpft ist.";
            localized["desktop.support.follow_through.attention"] = "Für diesen Fall fehlt noch ein Bestätigungsschritt.";
            localized["desktop.crash.title"] = "Crash-Wiederherstellung";
            localized["desktop.crash.section.summary"] = "Crash-Zusammenfassung und Details";
            ...
            localized["desktop.crash.intro.preview"] = "Dies ist eine lokale Crash-Vorschau ohne echten ausstehenden Absturz.";
            localized["desktop.crash.intro.current"] = "Die letzte Crash-Aufnahme für diese Installation ist verfügbar und kann jetzt sicher nachverfolgt werden.";
            ...
            localized["desktop.crash.heading"] = "Crash-Wiederherstellung";
            localized["desktop.report.title"] = "Problem melden";
            localized["desktop.report.heading"] = "Bug melden oder Feedback teilen";
            localized["desktop.report.section.context"] = "Desktop-Kontext";
            localized["desktop.report.section.bug"] = "Fehlerbericht";
            localized["desktop.report.section.feedback"] = "Feedback";
            localized["desktop.report.button.open_bug"] = "Fehlerbericht öffnen";
            localized["desktop.report.button.open_feedback"] = "Feedback öffnen";
            ...
            localized["desktop.report.bug.evidence_label"] = "Screenshot- oder Anhang-Hinweis";
            localized["desktop.report.bug.evidence_watermark"] = "Optional: Screenshot-Pfad, Anhang-Hinweis oder Crash-ID";
            localized["desktop.report.bug.intro"] = "Nutzen Sie diesen Weg für reproduzierbare Fehler. Erwartetes Verhalten, tatsächliches Verhalten und Repro-Schritte helfen beim Eingrenzen.";
            localized["desktop.report.feedback.intro"] = "Nutzen Sie diesen Weg für kurze Rückmeldungen, wenn es keinen reproduzierbaren Fehler gibt.";
            ...
            localized["desktop.report.context.manifest"] = "Update-Quelle: {0}";
            localized["desktop.report.context.supportability"] = "Supportstatus: {0}";
            localized["desktop.support_case.title"] = "Verfolgter Support-Fall";
            localized["desktop.support_case.section.summary"] = "Fallzusammenfassung und Status";
            localized["desktop.support_case.section.timeline"] = "Zeitachse und Anhange";
            localized["desktop.support_case.section.follow_through"] = "Nächste Schritte";
            localized["desktop.support_case.section.diagnostics"] = "Systemübersicht";
            ...
            localized["desktop.support_case.heading"] = "Support-Fall";
            localized["desktop.support_case.intro.preview"] = "Dies ist eine lokale Vorschau, wenn von diesem Desktop kein angemeldeter Fall erreichbar ist.";
            localized["desktop.support_case.intro.fallback"] = "Live-Falldetails sind derzeit nicht verfügbar, daher zeigt Chummer stattdessen die beste lokale Zusammenfassung.";
            localized["desktop.support_case.intro.action_needed"] = "Dieser Fall braucht noch einen Schritt, bevor er für diese Kopie geschlossen werden kann.";
            localized["desktop.support_case.intro.current"] = "Dieser Fall erklärt, was sich geändert hat, warum er noch offen ist und was als Nächstes sicher ist.";
            localized["desktop.support_case.status.current"] = "Fallstatus: aktuelle Details sind geladen.";
            localized["desktop.support_case.status.preview"] = "Verfolgter-Fall-Status: lokale Vorschau geladen.";
            localized["desktop.support_case.status.case_unavailable"] = "Fallstatus: detaillierte Falldaten sind nicht verfügbar, daher bleibt die lokale Zusammenfassung sichtbar.";
            localized["desktop.support_case.status.refresh_failed"] = "Verfolgter-Fall-Status: Aktualisierung fehlgeschlagen, daher wird weiterhin die letzte gute Fallansicht angezeigt.";
            ...
            localized["desktop.support_case.follow_through.current"] = "Sie können von diesem Fenster aus fortfahren, ohne die App zu verlassen.";
            localized["desktop.support_case.follow_through.attention"] = "Dieser Fall braucht noch einen Schritt, bevor er geschlossen werden kann.";
            localized["desktop.support_case.follow_through.link_install"] = "Nächste sichere Aktion: Öffnen Sie Geräte und Zugriff und verknüpfen oder beanspruchen Sie die betroffene Installation neu, bevor Sie dem Fix-Abschluss hier vertrauen.";
            localized["desktop.support_case.follow_through.update_install"] = "Nächste sichere Aktion: Öffnen Sie Update-Status und installieren Sie den angezeigten Fix, bevor Sie ihn hier verifizieren.";
            localized["desktop.support_case.follow_through.verify"] = "Diese Kopie hat den Fix bereits. Nutzen Sie den Account-Support für die finale Bestätigung.";
            ...
            localized["desktop.crash.status.current"] = "Crash-Status: lokale Details sind verfügbar und der Wiederherstellungsweg ist bereit.";
            ...
            localized["desktop.report.intro"] = "Schreiben Sie einen klaren Bericht mit den Details, die Support braucht. Sie können ihn im Browser öffnen oder kopieren.";
            localized["desktop.report.private_split"] = "Berichte enthalten nur App-Kontext. Screenshots oder Dateien fügen Sie selbst hinzu.";
            localized["desktop.report.button.copy_bug"] = "Fehlerbericht kopieren";
            localized["desktop.report.button.copy_feedback"] = "Feedback kopieren";
            localized["desktop.report.status.ready"] = "Bereit.";
            localized["desktop.report.status.bug_opened"] = "Fehlerbericht geöffnet.";
            localized["desktop.report.status.feedback_opened"] = "Feedback geöffnet.";
            localized["desktop.report.status.bug_copied"] = "Fehlerbericht kopiert.";
            localized["desktop.report.status.feedback_copied"] = "Feedback kopiert.";
            localized["desktop.report.status.bug_copied_fallback"] = "Der Browser wurde nicht geöffnet, daher wurde der Fehlerbericht kopiert.";
            localized["desktop.report.status.feedback_copied_fallback"] = "Der Browser wurde nicht geöffnet, daher wurde das Feedback kopiert.";
            localized["desktop.report.status.clipboard_unavailable"] = "Zwischenablage ist nicht verfügbar.";
            localized["desktop.report.status.portal_unavailable"] = "Browser kann nicht geöffnet und Bericht nicht kopiert werden.";

            localized["desktop.devices.title"] = "Deine Kopie";
            localized["desktop.devices.heading"] = "Deine Kopie";
            localized["desktop.devices.section.current"] = "Diese Installation";
            localized["desktop.devices.section.claimed"] = "Beanspruchte Kopien";
            localized["desktop.devices.section.claims"] = "Diese Kopie claimen";
            localized["desktop.devices.section.follow_through"] = "Support und Wiederherstellung";
            localized["desktop.devices.section.current_description"] = "Version, Update-Kanal und Konto für diese Installation.";
            localized["desktop.devices.section.claimed_description"] = "Andere Kopien im selben Konto.";
            ...
            localized["desktop.devices.intro.claimed_single"] = "Diese Installation ist verknüpft.";
            localized["desktop.devices.intro.claimed_multi"] = "Diese Installation ist zusammen mit weiteren Kopien in Ihrem Konto verknüpft.";
            ...
            localized["desktop.devices.context.current_account_match"] = "Kontoeintrag: {0} auf {1}/{2}, aktualisiert {3} UTC.";
            localized["desktop.devices.context.current_grant"] = "Zugriffsgrant: {0} bis {1} UTC.";
            localized["desktop.devices.context.current_unlinked"] = "Diese Installation ist noch nicht verknüpft.";
            localized["desktop.devices.context.claimed_none"] = "Noch keine verknüpften Installationen sind diesem Konto zugeordnet.";
            ...
            localized["desktop.dialog.global_settings.message"] = "Sprachanderungen gelten nach dem Neustart. Verfügbare Sprachen: {0}";
            ...
            localized["desktop.dialog.global_settings.notice.updated_restart"] = "Einstellungen aktualisiert. Starten Sie Chummer neu, um {0} uberall anzuwenden.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.state.snapshot"] = "{0}, espace={1}, ouvert={2}, sauvegarde={3}, derniere-commande={4}";
            localized["desktop.shell.state.error"] = "erreur - {0}";
            localized["desktop.shell.feedback.import_raw_required"] = "Fournissez le XML du personnage avant l'import.";
            localized["desktop.shell.feedback.import_file_unavailable"] = "le selecteur de fichier est indisponible sur cette plateforme.";
            localized["desktop.shell.feedback.import_file_cancelled"] = "la selection de fichier {0} a ete annulee.";
            localized["desktop.shell.feedback.demo_runner_unavailable"] = "le personnage d'exemple fourni est indisponible dans ce build.";
            localized["desktop.shell.feedback.demo_runner_loading"] = "ouverture du personnage d'exemple fourni depuis {0}.";
            localized["desktop.shell.feedback.no_active_workspace"] = "aucun workspace actif a fermer.";
            localized["desktop.shell.feedback.desktop_home_reviewed"] = "accueil desktop verifie.";
            localized["desktop.shell.feedback.campaign_workspace_reviewed"] = "workspace de campagne verifie.";
            localized["desktop.shell.feedback.update_reviewed"] = "posture de mise a jour verifiee.";
            localized["desktop.shell.feedback.install_linking_reviewed"] = "reclamation de la copie verifiee.";
            localized["desktop.shell.feedback.support_reviewed"] = "support verifie.";
            localized["desktop.shell.feedback.report_issue_reviewed"] = "signalement verifie.";
            localized["desktop.shell.feedback.settings_reviewed"] = "parametres verifies.";
            localized["desktop.shell.feedback.install_support_unavailable"] = "le suivi support est indisponible sur cet hote.";
            localized["desktop.shell.feedback.operation_failed_state"] = "erreur - {0} a echoue : {1}";
            ...
            localized["desktop.home.section.update_posture"] = "Mises a jour";
            ...
            localized["desktop.horizons.intro"] = "Ouvrez les outils Chummer depuis un hub desktop. Restez d'abord dans l'application ; ouvrez la page web connectée ou publique seulement quand c'est la bonne cible.";
            localized["desktop.horizons.button.open_public_index"] = "Ouvrir la feuille de route";
            ...
            localized["desktop.home.button.open_horizons_public"] = "Ouvrir la feuille de route";
            ...
            localized["desktop.install_link.preference.title"] = "Afficher les outils narratifs optionnels ?";
            localized["desktop.install_link.preference.summary"] = "Choisissez si Chummer affiche Alice, Origin Dossier et les outils narratifs optionnels. La creation de personnage fonctionne normalement dans les deux cas.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher les outils narratifs optionnels";
            localized["desktop.install_link.preference.visible_choice"] = "Afficher Alice et Origin Dossier";
            localized["desktop.install_link.preference.hidden_choice"] = "Garder la creation de personnage concentree";
            localized["desktop.install_link.preference.on"] = "Les outils narratifs optionnels sont affiches dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les outils narratifs optionnels sont masques dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Masque Alice, Origin Dossier et les entrees narratives optionnelles. Creation de personnage, regles, mises a jour et telechargements restent disponibles.";
            ...
            localized["desktop.install_link.button.unlink_copy"] = "Délier cette copie";
            ...
            localized["desktop.install_link.fallback.heading"] = "Ouvrir le lien manuellement";
            localized["desktop.install_link.fallback.summary"] = "Chummer n'a pas pu ouvrir le navigateur automatiquement. Ouvrez ou copiez ce lien, reclamez cette copie, puis revenez ici. Le rappel local terminera l'operation quand il arrivera.";
            localized["desktop.install_link.fallback.detail"] = "Si le navigateur est bloque sur ce desktop, vous pouvez terminer la reclamation dans un autre navigateur et revenir ensuite.";
            localized["desktop.install_link.fallback.detail_with_reason"] = "Detail du navigateur : {0}";
            ...
            localized["desktop.install_link.status.opened_downloads"] = "Les telechargements ont ete ouverts.";
            localized["desktop.install_link.status.unable_open_downloads"] = "Impossible d'ouvrir les telechargements depuis cet hote.";
            localized["desktop.install_link.status.opened_support"] = "Le support de cette copie a ete ouvert.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Les boutons d'aide sont visibles.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Les boutons d'aide sont masques.";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "Copier le lien de reclamation";
            localized["desktop.install_link.status.login_url_copied"] = "Le lien de reclamation a ete copie. Ouvrez-le dans votre navigateur pour reclamer cette copie.";
            ...
            localized["desktop.update.heading"] = "Etat des mises a jour";
            localized["desktop.update.section.current"] = "Version actuelle";
            localized["desktop.update.section.follow_through"] = "Étapes suivantes";
            ...
            localized["desktop.update.button.open_pending_installer"] = "Ouvrir l'installateur téléchargé";
            localized["desktop.update.button.copy_install_command"] = "Copier la commande d'installation";
            localized["desktop.update.button.refresh"] = "Vérifier à nouveau";
            localized["desktop.update.intro.disabled"] = "L'auto-mise-a-jour n'est pas encore configuree pour cette installation.";
            localized["desktop.update.intro.available"] = "Une mise a jour est disponible pour cette installation. Verifiez-la avant de reprendre.";
            localized["desktop.update.intro.attention"] = "Cette installation doit etre revue avant que vous la traitiez comme a jour.";
            localized["desktop.update.intro.never_checked"] = "Aucun etat de mise a jour n'a encore ete charge pour cette installation.";
            localized["desktop.update.intro.current"] = "Cette installation est assez a jour pour continuer.";
            localized["desktop.update.checking"] = "Verification des mises a jour.";
            localized["desktop.update.checked"] = "Verification de mise a jour terminee. Resultat : {0}.";
            localized["desktop.update.apply_scheduled"] = "Une mise a jour compatible a ete preparee. Chummer va se fermer pour l'installer.";
            ...
            localized["desktop.update.mode"] = "Mode de mise a jour : {0}";
            localized["desktop.update.status.clipboard_unavailable"] = "L'accès au presse-papiers n'est pas disponible dans cet hôte de bureau.";
            localized["desktop.update.status.install_command_copied"] = "La commande d'installation a été copiée.";
            localized["desktop.update.status.install_command_unavailable"] = "Aucune commande d'installation locale n'est disponible pour cette mise à jour.";
            localized["desktop.update.manifest_location"] = "Source de mise a jour : {0}";
            ...
            localized["desktop.support.section.follow_through"] = "Étapes suivantes";
            localized["desktop.support.section.diagnostics"] = "Résumé système";
            ...
            localized["desktop.report.button.open_bug"] = "Ouvrir le rapport de bug";
            localized["desktop.report.button.open_feedback"] = "Ouvrir le retour";
            ...
            localized["desktop.support_case.section.follow_through"] = "Étapes suivantes";
            localized["desktop.support_case.section.diagnostics"] = "Résumé système";
            ...
            localized["desktop.report.intro"] = "Envoyez un rapport clair avec les détails utiles au support. Vous pouvez l'ouvrir dans le navigateur ou le copier.";
            localized["desktop.report.private_split"] = "Les rapports incluent seulement le contexte de l'app. Ajoutez vous-même captures ou fichiers si besoin.";
            localized["desktop.report.button.copy_bug"] = "Copier le rapport de bug";
            localized["desktop.report.button.copy_feedback"] = "Copier le retour";
            localized["desktop.report.status.ready"] = "Prêt.";
            localized["desktop.report.status.bug_opened"] = "Rapport de bug ouvert.";
            localized["desktop.report.status.feedback_opened"] = "Retour ouvert.";
            localized["desktop.report.status.bug_copied"] = "Rapport de bug copié.";
            localized["desktop.report.status.feedback_copied"] = "Retour copié.";
            localized["desktop.report.status.bug_copied_fallback"] = "Le navigateur ne s'est pas ouvert, le rapport de bug a donc été copié.";
            localized["desktop.report.status.feedback_copied_fallback"] = "Le navigateur ne s'est pas ouvert, le retour a donc été copié.";
            localized["desktop.report.status.clipboard_unavailable"] = "Presse-papiers indisponible.";
            localized["desktop.report.status.portal_unavailable"] = "Impossible d'ouvrir le navigateur ou de copier le rapport.";

            localized["desktop.devices.title"] = "Your Copy";
            localized["desktop.devices.heading"] = "Your copy";
            localized["desktop.devices.section.current"] = "This install";
            localized["desktop.devices.section.claimed"] = "Linked copies";
            localized["desktop.devices.section.claims"] = "Claim this copy";
            localized["desktop.devices.section.follow_through"] = "Support and recovery";
            localized["desktop.devices.section.current_description"] = "Version, update channel, and account link for this install.";
            localized["desktop.devices.section.claimed_description"] = "Other installs linked to the same account.";
            ...
            localized["desktop.dialog.action.cancel"] = "Cancel";
            localized["desktop.dialog.global_settings.title"] = "Global Settings";
            localized["desktop.dialog.global_settings.message"] = "Les changements de langue s'appliquent apres redemarrage. Langues disponibles : {0}";
            localized["desktop.dialog.global_settings.field.ui_scale"] = "UI Scale (%)";
            localized["desktop.dialog.global_settings.field.theme"] = "Theme";
            localized["desktop.dialog.global_settings.field.language"] = "Language";
            localized["desktop.dialog.global_settings.field.compact_mode"] = "Compact Mode";
            localized["desktop.dialog.global_settings.notice.updated"] = "Global settings updated.";
            localized["desktop.dialog.global_settings.notice.updated_restart"] = "Parametres mis a jour. Redemarrez Chummer pour appliquer {0} partout.";
            localized["desktop.dialog.translator.title"] = "Translator";
            localized["desktop.dialog.translator.message"] = "Langue du desktop definie sur {0}. Redemarrez Chummer pour l'appliquer partout.";
            localized["desktop.dialog.translator.field.search"] = "Language Search";
            localized["desktop.dialog.translator.field.search_placeholder"] = "filter languages";
            localized["desktop.dialog.character_settings.notice.updated"] = "Runner settings updated.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.status_idle"] = "アイドル";
            ...
            localized["desktop.shell.state.snapshot"] = "{0}, workspace={1}, open={2}, saved={3}, last-command={4}";
            localized["desktop.shell.state.error"] = "エラー - {0}";
            localized["desktop.shell.feedback.import_raw_required"] = "インポート前にキャラクター XML を入力してください。";
            localized["desktop.shell.feedback.import_file_unavailable"] = "このプラットフォームではファイルピッカーを利用できません。";
            localized["desktop.shell.feedback.import_file_cancelled"] = "{0} のファイル選択は取り消されました。";
            localized["desktop.shell.feedback.demo_runner_unavailable"] = "このビルドでは同梱サンプルキャラクターを利用できません。";
            localized["desktop.shell.feedback.demo_runner_loading"] = "同梱サンプルキャラクターを {0} から開いています。";
            localized["desktop.shell.feedback.no_active_workspace"] = "閉じるアクティブワークスペースがありません。";
            localized["desktop.shell.feedback.desktop_home_reviewed"] = "デスクトップホームを確認しました。";
            localized["desktop.shell.feedback.campaign_workspace_reviewed"] = "キャンペーンワークスペースを確認しました。";
            localized["desktop.shell.feedback.update_reviewed"] = "更新ステータスを確認しました。";
            localized["desktop.shell.feedback.install_linking_reviewed"] = "コピーの請求を確認しました。";
            localized["desktop.shell.feedback.support_reviewed"] = "サポートを確認しました。";
            localized["desktop.shell.feedback.report_issue_reviewed"] = "問題報告を確認しました。";
            localized["desktop.shell.feedback.settings_reviewed"] = "設定を確認しました。";
            localized["desktop.shell.feedback.install_support_unavailable"] = "このホストではサポート追跡を利用できません。";
            localized["desktop.shell.feedback.operation_failed_state"] = "エラー - {0} に失敗しました: {1}";
            ...
            localized["desktop.home.section.update_posture"] = "更新";
            ...
            localized["desktop.horizons.intro"] = "1 つのデスクトップハブから Chummer のツールを開きます。まずアプリ内に留まり、必要な場合だけサインイン済みまたは公開 Web ページを開きます。";
            localized["desktop.horizons.button.open_public_index"] = "ロードマップを開く";
            ...
            localized["desktop.home.button.open_horizons_public"] = "ロードマップを開く";
            localized["desktop.home.install_summary.install_id"] = "インストール ID: {0}";
            localized["desktop.home.install_summary.head"] = "アプリ: {0}";
            ...
            localized["desktop.home.install_summary.linked_status"] = "アカウントにリンク済み。付与期限は {0} UTC です。";
            localized["desktop.home.install_summary.unlinked_status"] = "まだリンクされていません。インストールを請求するとサポートとクローズが強化されます。";
            ...
            localized["desktop.home.update_summary"] = "{0}\nインストール済み: {1}\nリリース一覧: {2}\n一覧更新: {3} UTC\nチャンネル: {4}\n最終確認: {5} UTC\n更新モード: {6}\nリリース状態: {7}\nリリースメモ: {8}\nサポート状態: {9}\nサポートメモ: {10}\nローカル状態: {11}\n状態更新: {12} UTC\n既知の問題: {13}\n修正提供状況: {14}\n推奨アクション: {15}\n最終エラー: {16}";
            ...
            localized["desktop.install_link.preference.title"] = "任意のストーリーツールを表示しますか？";
            localized["desktop.install_link.preference.summary"] = "Alice、Origin Dossier、任意のストーリーツールを表示するか選べます。キャラクター作成はどちらでも通常どおり使えます。";
            localized["desktop.install_link.preference.checkbox"] = "任意のストーリーツールを表示する";
            localized["desktop.install_link.preference.visible_choice"] = "Alice と Origin Dossier を表示";
            localized["desktop.install_link.preference.hidden_choice"] = "キャラクター作成に集中する";
            localized["desktop.install_link.preference.on"] = "このインストールでは任意のストーリーツールを表示します。";
            localized["desktop.install_link.preference.off"] = "このインストールでは任意のストーリーツールを非表示にします。";
            localized["desktop.install_link.preference.tip"] = "Alice、Origin Dossier、任意のストーリー入口を非表示にします。キャラクター作成、ルール、更新、ダウンロードは利用できます。";
            ...
            localized["desktop.install_link.button.unlink_copy"] = "このコピーのリンクを解除";
            ...
            localized["desktop.install_link.fallback.heading"] = "請求リンクを手動で開く";
            localized["desktop.install_link.fallback.summary"] = "Chummer はブラウザーを自動で開けませんでした。このリンクを開くかコピーして、このコピーを請求してから戻ってください。ローカルコールバックが届くと自動で完了します。";
            localized["desktop.install_link.fallback.detail"] = "このデスクトップでブラウザーがブロックされている場合でも、別のブラウザーで請求を完了してから戻れます。";
            localized["desktop.install_link.fallback.detail_with_reason"] = "ブラウザー詳細: {0}";
            ...
            localized["desktop.install_link.status.opened_downloads"] = "ダウンロードを開きました。";
            localized["desktop.install_link.status.unable_open_downloads"] = "このホストではダウンロードを開けません。";
            localized["desktop.install_link.status.opened_support"] = "このコピーのサポートを開きました。";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "ヘルプボタンは表示されています。";
            localized["desktop.install_link.status.guided_tools_hidden"] = "ヘルプボタンは非表示です。";
            localized["desktop.install_link.summary.installation_id"] = "インストール ID: {0}";
            localized["desktop.install_link.summary.head"] = "アプリ: {0}";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "取得リンクをコピー";
            localized["desktop.install_link.status.login_url_copied"] = "取得リンクをコピーしました。ブラウザーで開いてこのコピーを取得してください。";
            ...
            localized["desktop.update.heading"] = "更新ステータス";
            localized["desktop.update.section.current"] = "現在のバージョン";
            localized["desktop.update.section.follow_through"] = "次の手順";
            localized["desktop.update.section.install"] = "インストールコンテキスト";
            localized["desktop.update.button.check_now"] = "更新を確認";
            localized["desktop.update.button.open_pending_installer"] = "ダウンロード済みインストーラーを開く";
            localized["desktop.update.button.copy_install_command"] = "インストールコマンドをコピー";
            localized["desktop.update.button.refresh"] = "再チェック";
            localized["desktop.update.intro.disabled"] = "このインストールでは自己更新がまだ設定されていません。";
            localized["desktop.update.intro.available"] = "このインストールで利用できる更新があります。再開する前に確認してください。";
            localized["desktop.update.intro.attention"] = "続ける前に、このインストールの更新状態を確認してください。";
            localized["desktop.update.intro.never_checked"] = "このインストールでは、まだ更新状態が読み込まれていません。";
            localized["desktop.update.intro.current"] = "このインストールはそのまま使い続けられます。";
            localized["desktop.update.checking"] = "更新を確認しています。";
            ...
            localized["desktop.update.mode"] = "更新モード: {0}";
            localized["desktop.update.status.clipboard_unavailable"] = "このデスクトップ環境ではクリップボードを利用できません。";
            localized["desktop.update.status.install_command_copied"] = "インストールコマンドをコピーしました。";
            localized["desktop.update.status.install_command_unavailable"] = "この更新に使えるローカルなインストールコマンドはありません。";
            localized["desktop.update.manifest_location"] = "更新元: {0}";
            ...
            localized["desktop.support.section.follow_through"] = "次の手順";
            localized["desktop.support.section.diagnostics"] = "システム概要";
            ...
            localized["desktop.support.intro.quiet"] = "現在は追跡ケースが接続されていません。実ケースがあればサポートに次の手順が表示されます。";
            ...
            localized["desktop.report.button.open_bug"] = "バグ報告を開く";
            localized["desktop.report.button.open_feedback"] = "フィードバックを開く";
            ...
            localized["desktop.support_case.section.follow_through"] = "次の手順";
            localized["desktop.support_case.section.diagnostics"] = "システム概要";
            ...
            localized["desktop.support_case.intro.action_needed"] = "この追跡ケースは、このコピーで閉じる前に追加のフォローアップが必要です。";
            ...
            localized["desktop.support_case.follow_through.link_install"] = "次の手順: Your Copy を開き、影響を受けるインストールをリンクし直してください。";
            ...
            localized["desktop.report.intro"] = "サポートに必要な内容をまとめて送れます。ブラウザーで開くか、コピーできます。";
            localized["desktop.report.private_split"] = "レポートに含まれるのはアプリの状況だけです。スクリーンショットやファイルは必要に応じて追加してください。";
            localized["desktop.report.button.copy_bug"] = "バグ報告をコピー";
            localized["desktop.report.button.copy_feedback"] = "フィードバックをコピー";
            localized["desktop.report.status.ready"] = "準備完了。";
            localized["desktop.report.status.bug_opened"] = "バグ報告を開きました。";
            localized["desktop.report.status.feedback_opened"] = "フィードバックを開きました。";
            localized["desktop.report.status.bug_copied"] = "バグ報告をコピーしました。";
            localized["desktop.report.status.feedback_copied"] = "フィードバックをコピーしました。";
            localized["desktop.report.status.bug_copied_fallback"] = "ブラウザーを開けなかったため、バグ報告をコピーしました。";
            localized["desktop.report.status.feedback_copied_fallback"] = "ブラウザーを開けなかったため、フィードバックをコピーしました。";
            localized["desktop.report.status.clipboard_unavailable"] = "クリップボードを利用できません。";
            localized["desktop.report.status.portal_unavailable"] = "ブラウザーを開けず、レポートもコピーできません。";
            ...
            localized["desktop.dialog.action.cancel"] = "Cancel";
            localized["desktop.dialog.global_settings.title"] = "Global Settings";
            localized["desktop.dialog.global_settings.message"] = "言語の変更は再起動後に適用されます。利用できる言語: {0}";
            localized["desktop.dialog.global_settings.field.ui_scale"] = "UI Scale (%)";
            localized["desktop.dialog.global_settings.field.theme"] = "Theme";
            localized["desktop.dialog.global_settings.field.language"] = "Language";
            localized["desktop.dialog.global_settings.field.compact_mode"] = "Compact Mode";
            localized["desktop.dialog.global_settings.notice.updated"] = "Global settings updated.";
            localized["desktop.dialog.global_settings.notice.updated_restart"] = "設定を更新しました。{0} をすべてに適用するには Chummer を再起動してください。";
            localized["desktop.dialog.translator.title"] = "Translator";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.status_idle"] = "ocioso";
            ...
            localized["desktop.shell.value.na"] = "n/d";
            localized["desktop.shell.state.snapshot"] = "{0}, workspace={1}, aberto={2}, salvo={3}, ultimo-comando={4}";
            localized["desktop.shell.state.error"] = "erro - {0}";
            localized["desktop.shell.feedback.import_raw_required"] = "forneca o XML do personagem antes de importar.";
            localized["desktop.shell.feedback.import_file_unavailable"] = "seletor de arquivo indisponivel nesta plataforma.";
            localized["desktop.shell.feedback.import_file_cancelled"] = "selecao de arquivo {0} cancelada.";
            localized["desktop.shell.feedback.demo_runner_unavailable"] = "o personagem de exemplo incluido esta indisponivel neste build.";
            localized["desktop.shell.feedback.demo_runner_loading"] = "abrindo personagem de exemplo incluido de {0}.";
            localized["desktop.shell.feedback.no_active_workspace"] = "nenhum workspace ativo para fechar.";
            localized["desktop.shell.feedback.desktop_home_reviewed"] = "painel inicial revisado.";
            localized["desktop.shell.feedback.campaign_workspace_reviewed"] = "workspace de campanha revisado.";
            localized["desktop.shell.feedback.update_reviewed"] = "postura de atualizacao revisada.";
            localized["desktop.shell.feedback.install_linking_reviewed"] = "reivindicacao da copia revisada.";
            localized["desktop.shell.feedback.support_reviewed"] = "suporte revisado.";
            localized["desktop.shell.feedback.report_issue_reviewed"] = "relato de problema revisado.";
            localized["desktop.shell.feedback.settings_reviewed"] = "configuracoes revisadas.";
            localized["desktop.shell.feedback.install_support_unavailable"] = "acompanhamento de suporte indisponivel neste host.";
            localized["desktop.shell.feedback.operation_failed_state"] = "erro - {0} falhou: {1}";
            ...
            localized["desktop.home.section.update_posture"] = "Atualizacoes";
            ...
            localized["desktop.horizons.intro"] = "Abra as ferramentas do Chummer em um único hub do desktop. Fique primeiro no app; abra a página web autenticada ou pública só quando ela for o alvo certo.";
            localized["desktop.horizons.button.open_public_index"] = "Abrir roteiro";
            ...
            localized["desktop.home.button.open_horizons_public"] = "Abrir roteiro";
            ...
            localized["desktop.home.install_summary.linked_status"] = "vinculado a conta. O grant expira em {0} UTC.";
            localized["desktop.home.install_summary.unlinked_status"] = "ainda nao vinculado. Suporte e fechamento ficam mais fortes depois que a instalacao for reivindicada.";
            ...
            localized["desktop.install_link.preference.title"] = "Mostrar ferramentas opcionais de historia?";
            localized["desktop.install_link.preference.summary"] = "Escolha se Chummer mostra Alice, Origin Dossier e ferramentas opcionais de historia. A criacao de personagem funciona normalmente nos dois casos.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar ferramentas opcionais de historia";
            localized["desktop.install_link.preference.visible_choice"] = "Mostrar Alice e Origin Dossier";
            localized["desktop.install_link.preference.hidden_choice"] = "Manter foco na criacao de personagem";
            localized["desktop.install_link.preference.on"] = "Ferramentas opcionais de historia estao visiveis nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Ferramentas opcionais de historia estao ocultas nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Oculta Alice, Origin Dossier e entradas opcionais de historia. Criacao de personagem, regras, atualizacoes e downloads continuam disponiveis.";
            ...
            localized["desktop.install_link.button.unlink_copy"] = "Desvincular esta cópia";
            ...
            localized["desktop.install_link.fallback.heading"] = "Abrir o link manualmente";
            localized["desktop.install_link.fallback.summary"] = "O Chummer nao conseguiu abrir o navegador automaticamente. Abra ou copie este link, reivindique esta copia e volte aqui. O retorno local termina sozinho quando chegar.";
            localized["desktop.install_link.fallback.detail"] = "Se o navegador estiver bloqueado neste desktop, voce ainda pode concluir a reivindicacao em outro navegador e voltar depois.";
            localized["desktop.install_link.fallback.detail_with_reason"] = "Detalhe do navegador: {0}";
            ...
            localized["desktop.install_link.status.opened_downloads"] = "Downloads foram abertos.";
            localized["desktop.install_link.status.unable_open_downloads"] = "Nao foi possivel abrir downloads neste host.";
            localized["desktop.install_link.status.opened_support"] = "O suporte desta copia foi aberto.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Botoes de ajuda estao visiveis.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Botoes de ajuda estao ocultos.";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "Copiar link de reivindicacao";
            localized["desktop.install_link.status.login_url_copied"] = "O link de reivindicacao foi copiado. Abra-o no navegador para reivindicar esta copia.";
            ...
            localized["desktop.update.heading"] = "Status da atualizacao";
            localized["desktop.update.section.current"] = "Versao atual";
            localized["desktop.update.section.follow_through"] = "Próximos passos";
            ...
            localized["desktop.update.button.open_pending_installer"] = "Abrir instalador baixado";
            localized["desktop.update.button.copy_install_command"] = "Copiar comando de instalação";
            localized["desktop.update.button.refresh"] = "Verificar novamente";
            localized["desktop.update.intro.disabled"] = "A autoatualizacao ainda nao esta configurada para esta instalacao.";
            localized["desktop.update.intro.available"] = "Ha uma atualizacao disponivel para esta instalacao. Verifique antes de voltar ao trabalho.";
            localized["desktop.update.intro.attention"] = "Revise esta instalacao antes de trata-la como atual.";
            localized["desktop.update.intro.never_checked"] = "Nenhum status de atualizacao foi carregado para esta instalacao.";
            localized["desktop.update.intro.current"] = "Esta instalacao esta atual o suficiente para continuar.";
            localized["desktop.update.checking"] = "Verificando atualizacoes.";
            ...
            localized["desktop.update.mode"] = "Modo de atualizacao: {0}";
            localized["desktop.update.status.clipboard_unavailable"] = "O acesso à área de transferência não está disponível neste host de desktop.";
            localized["desktop.update.status.install_command_copied"] = "O comando de instalação foi copiado.";
            localized["desktop.update.status.install_command_unavailable"] = "Nenhum comando de instalação local está disponível para esta atualização.";
            localized["desktop.update.manifest_location"] = "Fonte de atualizacao: {0}";
            ...
            localized["desktop.support.section.follow_through"] = "Próximos passos";
            localized["desktop.support.section.diagnostics"] = "Resumo do sistema";
            ...
            localized["desktop.support.intro.quiet"] = "Nenhum caso rastreado esta anexado agora. O suporte mostrara os proximos passos quando houver um caso real.";
            ...
            localized["desktop.report.button.open_bug"] = "Abrir relatório de bug";
            localized["desktop.report.button.open_feedback"] = "Abrir feedback";
            ...
            localized["desktop.report.context.supportability"] = "Status de suporte: {0}";
            ...
            localized["desktop.support_case.section.follow_through"] = "Próximos passos";
            localized["desktop.support_case.section.diagnostics"] = "Resumo do sistema";
            ...
            localized["desktop.support_case.intro.action_needed"] = "Este caso rastreado ainda precisa de acompanhamento antes de poder ser fechado para esta copia.";
            ...
            localized["desktop.report.intro"] = "Envie um relato claro com os detalhes que o suporte precisa. Voce pode abrir no navegador ou copiar.";
            localized["desktop.report.private_split"] = "Os relatos incluem apenas contexto do app. Adicione capturas ou arquivos se precisar.";
            localized["desktop.report.button.copy_bug"] = "Copiar relatório de bug";
            localized["desktop.report.button.copy_feedback"] = "Copiar feedback";
            localized["desktop.report.status.ready"] = "Pronto.";
            localized["desktop.report.status.bug_opened"] = "Relatório de bug aberto.";
            localized["desktop.report.status.feedback_opened"] = "Feedback aberto.";
            localized["desktop.report.status.bug_copied"] = "Relatório de bug copiado.";
            localized["desktop.report.status.feedback_copied"] = "Feedback copiado.";
            localized["desktop.report.status.bug_copied_fallback"] = "O navegador não abriu, então o relatório de bug foi copiado.";
            localized["desktop.report.status.feedback_copied_fallback"] = "O navegador não abriu, então o feedback foi copiado.";
            localized["desktop.report.status.clipboard_unavailable"] = "Área de transferência indisponível.";
            localized["desktop.report.status.portal_unavailable"] = "Não foi possível abrir o navegador ou copiar o relatório.";
            ...
            localized["desktop.dialog.action.cancel"] = "Cancel";
            localized["desktop.dialog.global_settings.title"] = "Global Settings";
            localized["desktop.dialog.global_settings.message"] = "Mudancas de idioma valem apos reiniciar. Idiomas disponiveis: {0}";
            localized["desktop.dialog.global_settings.field.ui_scale"] = "UI Scale (%)";
            localized["desktop.dialog.global_settings.field.theme"] = "Theme";
            localized["desktop.dialog.global_settings.field.language"] = "Language";
            localized["desktop.dialog.global_settings.field.compact_mode"] = "Compact Mode";
            localized["desktop.dialog.global_settings.notice.updated"] = "Global settings updated.";
            localized["desktop.dialog.global_settings.notice.updated_restart"] = "Configuracoes atualizadas. Reinicie o Chummer para aplicar {0} em todos os lugares.";
            localized["desktop.dialog.translator.title"] = "Translator";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.value.na"] = "n/a";
            localized["desktop.shell.state.snapshot"] = "{0}, workspace={1}, open={2}, saved={3}, last-command={4}";
            localized["desktop.shell.state.error"] = "错误 - {0}";
            localized["desktop.shell.feedback.import_raw_required"] = "导入前请先提供角色 XML 内容。";
            localized["desktop.shell.feedback.import_file_unavailable"] = "此平台无法使用文件选择器。";
            localized["desktop.shell.feedback.import_file_cancelled"] = "已取消 {0} 文件选择。";
            localized["desktop.shell.feedback.demo_runner_unavailable"] = "此构建中的内置示例角色不可用。";
            localized["desktop.shell.feedback.demo_runner_loading"] = "正在从 {0} 打开内置示例角色。";
            localized["desktop.shell.feedback.no_active_workspace"] = "没有可关闭的活动工作区。";
            localized["desktop.shell.feedback.desktop_home_reviewed"] = "已查看桌面首页。";
            localized["desktop.shell.feedback.campaign_workspace_reviewed"] = "已查看战役工作区。";
            localized["desktop.shell.feedback.update_reviewed"] = "已查看更新状态。";
            localized["desktop.shell.feedback.install_linking_reviewed"] = "已查看副本认领。";
            localized["desktop.shell.feedback.support_reviewed"] = "已查看支持。";
            localized["desktop.shell.feedback.report_issue_reviewed"] = "已查看问题报告。";
            localized["desktop.shell.feedback.settings_reviewed"] = "已查看设置。";
            localized["desktop.shell.feedback.install_support_unavailable"] = "此主机上不提供支持跟进。";
            localized["desktop.shell.feedback.operation_failed_state"] = "错误 - {0} 失败: {1}";
            ...
            localized["desktop.horizons.intro"] = "从一个桌面中枢打开 Chummer 工具。优先留在应用内；只有在确实需要时才打开登录网页或公开网页。";
            localized["desktop.horizons.button.open_public_index"] = "打开路线图";
            ...
            localized["desktop.home.button.open_horizons_public"] = "打开路线图";
            localized["desktop.home.install_summary.install_id"] = "安装 ID: {0}";
            localized["desktop.home.install_summary.head"] = "应用: {0}";
            ...
            localized["desktop.home.install_summary.linked_status"] = "已绑定账户。授权于 {0} UTC 到期。";
            localized["desktop.home.install_summary.unlinked_status"] = "尚未绑定。认领安装后，支持与闭环能力会更强。";
            ...
            localized["desktop.install_link.preference.title"] = "显示可选故事工具？";
            localized["desktop.install_link.preference.summary"] = "选择 Chummer 是否显示 Alice、Origin Dossier 和可选故事工具。角色创建在两种设置下都可正常使用。";
            localized["desktop.install_link.preference.checkbox"] = "显示可选故事工具";
            localized["desktop.install_link.preference.visible_choice"] = "显示 Alice 和 Origin Dossier";
            localized["desktop.install_link.preference.hidden_choice"] = "专注于角色创建";
            localized["desktop.install_link.preference.on"] = "此安装中会显示可选故事工具。";
            localized["desktop.install_link.preference.off"] = "此安装中会隐藏可选故事工具。";
            localized["desktop.install_link.preference.tip"] = "隐藏 Alice、Origin Dossier 和可选故事入口。角色创建、规则、更新和下载仍可使用。";
            ...
            localized["desktop.install_link.button.unlink_copy"] = "解除此副本绑定";
            ...
            localized["desktop.install_link.fallback.heading"] = "手动打开认领链接";
            localized["desktop.install_link.fallback.summary"] = "Chummer 无法自动打开浏览器。请打开或复制此链接，认领此副本，然后回到这里。本地回调到达后会自动完成。";
            localized["desktop.install_link.fallback.detail"] = "如果此桌面上的浏览器被阻止，你仍可在其他浏览器中完成认领，然后再返回这里。";
            localized["desktop.install_link.fallback.detail_with_reason"] = "浏览器详情: {0}";
            ...
            localized["desktop.install_link.status.opened_downloads"] = "已打开下载页。";
            localized["desktop.install_link.status.unable_open_downloads"] = "此主机无法打开下载页。";
            localized["desktop.install_link.status.opened_support"] = "已打开此副本的支持页。";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "帮助按钮已显示。";
            localized["desktop.install_link.status.guided_tools_hidden"] = "帮助按钮已隐藏。";
            localized["desktop.install_link.summary.installation_id"] = "安装 ID: {0}";
            localized["desktop.install_link.summary.head"] = "应用: {0}";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "复制登录链接";
            localized["desktop.install_link.status.login_url_copied"] = "登录链接已复制。请将其粘贴到浏览器中以完成此安装的绑定。";
            ...
            localized["desktop.update.heading"] = "更新状态";
            localized["desktop.update.section.current"] = "当前版本";
            localized["desktop.update.section.follow_through"] = "后续步骤";
            localized["desktop.update.section.install"] = "安装上下文";
            localized["desktop.update.button.check_now"] = "检查更新";
            localized["desktop.update.button.open_pending_installer"] = "打开已下载的安装程序";
            localized["desktop.update.button.copy_install_command"] = "复制安装命令";
            localized["desktop.update.button.refresh"] = "重新检查";
            localized["desktop.update.intro.disabled"] = "此安装尚未配置自更新。";
            localized["desktop.update.intro.available"] = "此安装有可用更新。返回工作前请先检查。";
            localized["desktop.update.intro.attention"] = "继续之前请先检查此安装的更新状态。";
            localized["desktop.update.intro.never_checked"] = "此安装尚未加载更新状态。";
            localized["desktop.update.intro.current"] = "此安装可以继续使用。";
            localized["desktop.update.checking"] = "正在检查更新。";
            ...
            localized["desktop.update.mode"] = "更新模式: {0}";
            localized["desktop.update.status.clipboard_unavailable"] = "此桌面宿主环境无法访问剪贴板。";
            localized["desktop.update.status.install_command_copied"] = "安装命令已复制。";
            localized["desktop.update.status.install_command_unavailable"] = "此更新没有可用的本地安装命令。";
            localized["desktop.update.manifest_location"] = "更新来源: {0}";
            ...
            localized["desktop.support.section.follow_through"] = "后续步骤";
            localized["desktop.support.section.diagnostics"] = "系统摘要";
            localized["desktop.support.button.refresh"] = "重新载入支持状态";
            localized["desktop.support.intro.guest"] = "此桌面副本处于访客模式。绑定后即可启用针对该安装的修复和通知。";
            localized["desktop.support.intro.quiet"] = "当前没有关联的跟踪工单。有真实工单时，支持界面会显示下一步。";
            ...
            localized["desktop.report.button.open_bug"] = "打开缺陷报告";
            localized["desktop.report.button.open_feedback"] = "打开反馈";
            ...
            localized["desktop.report.context.supportability"] = "支持状态: {0}";
            ...
            localized["desktop.support_case.section.follow_through"] = "后续步骤";
            localized["desktop.support_case.section.diagnostics"] = "系统摘要";
            ...
            localized["desktop.support_case.intro.action_needed"] = "此跟踪工单仍需跟进，之后才能为此副本关闭。";
            ...
            localized["desktop.support_case.follow_through.link_install"] = "下一步: 打开 Your Copy，重新关联受影响安装。";
            ...
            localized["desktop.report.intro"] = "发送一份清晰报告，包含支持所需的细节。你可以在浏览器中打开，也可以复制。";
            localized["desktop.report.private_split"] = "报告只包含应用上下文。如需截图或文件，请自行添加。";
            localized["desktop.report.button.copy_bug"] = "复制缺陷报告";
            localized["desktop.report.button.copy_feedback"] = "复制反馈";
            localized["desktop.report.status.ready"] = "就绪。";
            localized["desktop.report.status.bug_opened"] = "已打开缺陷报告。";
            localized["desktop.report.status.feedback_opened"] = "已打开反馈。";
            localized["desktop.report.status.bug_copied"] = "已复制缺陷报告。";
            localized["desktop.report.status.feedback_copied"] = "已复制反馈。";
            localized["desktop.report.status.bug_copied_fallback"] = "浏览器未打开，因此已复制缺陷报告。";
            localized["desktop.report.status.feedback_copied_fallback"] = "浏览器未打开，因此已复制反馈。";
            localized["desktop.report.status.clipboard_unavailable"] = "剪贴板不可用。";
            localized["desktop.report.status.portal_unavailable"] = "无法打开浏览器或复制报告。";
            ...
            localized["desktop.dialog.action.cancel"] = "Cancel";
            localized["desktop.dialog.global_settings.title"] = "Global Settings";
            localized["desktop.dialog.global_settings.message"] = "语言更改将在重启后生效。可用语言: {0}";
            localized["desktop.dialog.global_settings.field.ui_scale"] = "UI Scale (%)";
            localized["desktop.dialog.global_settings.field.theme"] = "Theme";
            localized["desktop.dialog.global_settings.field.language"] = "Language";
            localized["desktop.dialog.global_settings.field.compact_mode"] = "Compact Mode";
            localized["desktop.dialog.global_settings.notice.updated"] = "Global settings updated.";
            localized["desktop.dialog.global_settings.notice.updated_restart"] = "设置已更新。重启 Chummer 后将在所有位置应用 {0}。";
            localized["desktop.dialog.translator.title"] = "Translator";
