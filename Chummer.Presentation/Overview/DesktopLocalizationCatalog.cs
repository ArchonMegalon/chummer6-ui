...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.campaign.intro.ready"] = "This campaign workspace is ready to restore session state, runboard state, and support closure from the desktop.",
        ...
        ["desktop.support_case.follow_through.verify"] = "This linked install already has the reporter-ready fix. Use signed-in support to record final confirmation without losing case continuity.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.support_case.intro.fallback"] = "Die vollstandigen Fall-Details sind derzeit nicht verfügbar, daher zeigt dieser Desktop die starkste sichere lokale Support-Zusammenfassung, statt Sie aus dem Flagship-Client herauszuwerfen.";
            localized["desktop.support_case.intro.action_needed"] = "Dieser verfolgte Fall braucht noch Nachverfolgung, bevor er für diese Kopie geschlossen werden kann.";
            localized["desktop.support_case.intro.current"] = "Dieser verfolgte Fall ist am Flagship-Desktop verankert und kann erklaren, warum er noch offen ist, was sich geandert hat und was als Nächstes sicher ist.";
            ...
            localized["desktop.support_case.status.case_unavailable"] = "Verfolgter-Fall-Status: der detaillierte Support-Datensatz ist nicht verfügbar, daher wird weiterhin die begrenzte lokale Zusammenfassung angezeigt.";
            ...
            localized["desktop.support_case.follow_through.attention"] = "Für denselben verfolgten Fall ist weiterhin Nachverfolgung nötig, bevor der Abschluss ehrlich ist.";
            ...
            localized["desktop.support_case.follow_through.update_install"] = "Nächste sichere Aktion: Öffnen Sie Update-Status und bringen Sie diese verknüpfte Installation auf das reporter-bereite Release, bevor Sie den Fix verifizieren.";
            localized["desktop.support_case.follow_through.verify"] = "Diese verknüpfte Installation hat bereits den reporter-bereiten Fix. Nutzen Sie angemeldeten Support für die finale Bestätigung, ohne die Fall-Kontinuität zu verlieren.";
