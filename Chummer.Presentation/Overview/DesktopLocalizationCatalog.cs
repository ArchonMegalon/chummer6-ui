...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.shell.feedback.install_linking_reviewed"] = "State: copy claim reviewed.",
        ...
        ["desktop.install_link.preference.title"] = "Use guided story tools?",
        ["desktop.install_link.preference.summary"] = "Show or hide Alice, Origin Dossier, and generated story tools. Character creation still works normally.",
        ["desktop.install_link.preference.checkbox"] = "Enable guided story tools",
        ["desktop.install_link.preference.visible_choice"] = "Show Alice and Origin Dossier",
        ["desktop.install_link.preference.hidden_choice"] = "Hide guided story tools",
        ["desktop.install_link.preference.on"] = "Guided story tools are enabled in this install.",
        ["desktop.install_link.preference.off"] = "Guided story tools are disabled in this install.",
        ["desktop.install_link.preference.tip"] = "Hides Alice, Origin Dossier, and generated story entry points. Character creation, rules, updates, and downloads stay available.",
        ...
        ["desktop.home.install_summary.unlinked_status"] = "Status: not linked yet. Support gets stronger once this copy is claimed.",
        ...
        ["desktop.install_link.status.opened_origin_dossier"] = "Opened Origin Dossier.",
        ["desktop.install_link.status.unable_open_origin_dossier"] = "Unable to open Origin Dossier from this host.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.feedback.install_linking_reviewed"] = "Status: Kopie-Claim wurde geprüft.";
            localized["desktop.shell.feedback.support_reviewed"] = "Status: Support wurde geprüft.";
            localized["desktop.shell.feedback.report_issue_reviewed"] = "Status: Fehlerbericht wurde geprüft.";
            localized["desktop.shell.feedback.settings_reviewed"] = "Status: Einstellungen wurden geprüft.";
            ...
            localized["desktop.home.install_summary.linked_status"] = "Status: Mit Konto verknüpft. Grant läuft um {0} UTC ab.";
            localized["desktop.home.install_summary.unlinked_status"] = "Status: Noch nicht verknüpft. Support und Abschluss sind stärker, sobald die Installation beansprucht ist.";
            ...
            localized["desktop.install_link.preference.title"] = "Geführte Story-Werkzeuge verwenden?";
            localized["desktop.install_link.preference.summary"] = "Zeigt oder versteckt Alice, Origin Dossier und generierte Story-Werkzeuge. Die Charaktererstellung funktioniert weiter normal.";
            localized["desktop.install_link.preference.checkbox"] = "Geführte Story-Werkzeuge aktivieren";
            localized["desktop.install_link.preference.visible_choice"] = "Alice und Origin Dossier anzeigen";
            localized["desktop.install_link.preference.hidden_choice"] = "Geführte Story-Werkzeuge ausblenden";
            localized["desktop.install_link.preference.on"] = "Geführte Story-Werkzeuge sind in dieser Installation aktiviert.";
            localized["desktop.install_link.preference.off"] = "Geführte Story-Werkzeuge sind in dieser Installation deaktiviert.";
            localized["desktop.install_link.preference.tip"] = "Blendet Alice, Origin Dossier und generierte Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfügbar.";
            ...
            localized["desktop.install_link.status.opened_origin_dossier"] = "Origin Dossier wurde geöffnet.";
            localized["desktop.install_link.status.unable_open_origin_dossier"] = "Origin Dossier kann auf diesem Host nicht geöffnet werden.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Utiliser les outils narratifs guides ?";
            localized["desktop.install_link.preference.summary"] = "Affiche ou masque Alice, Origin Dossier et les outils narratifs generes. La creation de personnage fonctionne toujours normalement.";
            localized["desktop.install_link.preference.checkbox"] = "Activer les outils narratifs guides";
            localized["desktop.install_link.preference.visible_choice"] = "Afficher Alice et Origin Dossier";
            localized["desktop.install_link.preference.hidden_choice"] = "Masquer les outils narratifs guides";
            localized["desktop.install_link.preference.on"] = "Les outils narratifs guides sont actives dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les outils narratifs guides sont desactives dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Masque Alice, Origin Dossier et les entrees narratives generees. Creation de personnage, regles, mises a jour et telechargements restent disponibles.";
            ...
            localized["desktop.install_link.status.opened_origin_dossier"] = "Origin Dossier ouvert.";
            localized["desktop.install_link.status.unable_open_origin_dossier"] = "Impossible d'ouvrir Origin Dossier depuis cet hote.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "ガイド付きストーリーツールを使いますか？";
            localized["desktop.install_link.preference.summary"] = "Alice、Origin Dossier、生成ストーリーツールの表示を切り替えます。キャラクター作成は通常どおり使えます。";
            localized["desktop.install_link.preference.checkbox"] = "ガイド付きストーリーツールを有効にする";
            localized["desktop.install_link.preference.visible_choice"] = "Alice と Origin Dossier を表示";
            localized["desktop.install_link.preference.hidden_choice"] = "ガイド付きストーリーツールを隠す";
            localized["desktop.install_link.preference.on"] = "このインストールではガイド付きストーリーツールが有効です。";
            localized["desktop.install_link.preference.off"] = "このインストールではガイド付きストーリーツールが無効です。";
            localized["desktop.install_link.preference.tip"] = "Alice、Origin Dossier、生成ストーリー入口を隠します。キャラクター作成、ルール、更新、ダウンロードは利用できます。";
            ...
            localized["desktop.install_link.status.opened_origin_dossier"] = "Origin Dossier を開きました。";
            localized["desktop.install_link.status.unable_open_origin_dossier"] = "このホストでは Origin Dossier を開けません。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Usar ferramentas guiadas de historia?";
            localized["desktop.install_link.preference.summary"] = "Mostre ou oculte Alice, Origin Dossier e ferramentas de historia geradas. A criacao de personagem continua funcionando normalmente.";
            localized["desktop.install_link.preference.checkbox"] = "Ativar ferramentas guiadas de historia";
            localized["desktop.install_link.preference.visible_choice"] = "Mostrar Alice e Origin Dossier";
            localized["desktop.install_link.preference.hidden_choice"] = "Ocultar ferramentas guiadas de historia";
            localized["desktop.install_link.preference.on"] = "Ferramentas guiadas de historia estao ativadas nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Ferramentas guiadas de historia estao desativadas nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Oculta Alice, Origin Dossier e entradas de historia geradas. Criacao de personagem, regras, atualizacoes e downloads continuam disponiveis.";
            ...
            localized["desktop.install_link.status.opened_origin_dossier"] = "Origin Dossier foi aberto.";
            localized["desktop.install_link.status.unable_open_origin_dossier"] = "Nao foi possivel abrir Origin Dossier neste host.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "使用引导故事工具？";
            localized["desktop.install_link.preference.summary"] = "显示或隐藏 Alice、Origin Dossier 和生成的故事工具。角色创建仍可正常使用。";
            localized["desktop.install_link.preference.checkbox"] = "启用引导故事工具";
            localized["desktop.install_link.preference.visible_choice"] = "显示 Alice 和 Origin Dossier";
            localized["desktop.install_link.preference.hidden_choice"] = "隐藏引导故事工具";
            localized["desktop.install_link.preference.on"] = "此安装中引导故事工具已启用。";
            localized["desktop.install_link.preference.off"] = "此安装中引导故事工具已禁用。";
            localized["desktop.install_link.preference.tip"] = "隐藏 Alice、Origin Dossier 和生成的故事入口。角色创建、规则、更新和下载仍可使用。";
            ...
            localized["desktop.install_link.status.opened_origin_dossier"] = "已打开 Origin Dossier。";
            localized["desktop.install_link.status.unable_open_origin_dossier"] = "此主机无法打开 Origin Dossier。";
