...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.preference.title"] = "Optional helpers",
        ["desktop.install_link.preference.summary"] = "Show or hide helper buttons and story tools. Character tools stay the same.",
        ["desktop.install_link.preference.checkbox"] = "Show helper buttons",
        ["desktop.install_link.preference.visible_choice"] = "Show helper buttons",
        ["desktop.install_link.preference.hidden_choice"] = "Hide helper buttons",
        ["desktop.install_link.preference.on"] = "Helper buttons are visible in this install.",
        ["desktop.install_link.preference.off"] = "Helper buttons are hidden in this install.",
        ["desktop.install_link.preference.tip"] = "Hides optional helpers and story entry points. Character creation, rules, updates, and downloads stay available.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Optionale Helfer";
            localized["desktop.install_link.preference.summary"] = "Zeigt oder versteckt Helfer-Buttons und Story-Werkzeuge. Die Charakterwerkzeuge bleiben gleich.";
            localized["desktop.install_link.preference.checkbox"] = "Helfer-Buttons anzeigen";
            localized["desktop.install_link.preference.visible_choice"] = "Helfer-Buttons anzeigen";
            localized["desktop.install_link.preference.hidden_choice"] = "Helfer-Buttons ausblenden";
            localized["desktop.install_link.preference.on"] = "Helfer-Buttons sind in dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "Helfer-Buttons sind in dieser Installation ausgeblendet.";
            localized["desktop.install_link.preference.tip"] = "Blendet optionale Helfer und Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfugbar.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Aides optionnelles";
            localized["desktop.install_link.preference.summary"] = "Affiche ou masque les boutons d'aide et les outils narratifs. Les outils de personnage ne changent pas.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher les boutons d'aide";
            localized["desktop.install_link.preference.visible_choice"] = "Afficher les boutons d'aide";
            localized["desktop.install_link.preference.hidden_choice"] = "Masquer les boutons d'aide";
            localized["desktop.install_link.preference.on"] = "Les boutons d'aide sont visibles dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les boutons d'aide sont masques dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Masque les aides optionnelles et les entrees narratives. Creation de personnage, regles, mises a jour et telechargements restent disponibles.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "任意のヘルプ";
            localized["desktop.install_link.preference.summary"] = "ヘルプボタンとストーリーツールの表示を選びます。キャラクターツールは変わりません。";
            localized["desktop.install_link.preference.checkbox"] = "ヘルプボタンを表示";
            localized["desktop.install_link.preference.visible_choice"] = "ヘルプボタンを表示";
            localized["desktop.install_link.preference.hidden_choice"] = "ヘルプボタンを非表示";
            localized["desktop.install_link.preference.on"] = "このインストールではヘルプボタンが表示されます。";
            localized["desktop.install_link.preference.off"] = "このインストールではヘルプボタンが非表示です。";
            localized["desktop.install_link.preference.tip"] = "任意のヘルプとストーリー入口を隠します。キャラクター作成、ルール、更新、ダウンロードは利用できます。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Ajudas opcionais";
            localized["desktop.install_link.preference.summary"] = "Mostre ou oculte botoes de ajuda e ferramentas de historia. As ferramentas de personagem continuam iguais.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar botoes de ajuda";
            localized["desktop.install_link.preference.visible_choice"] = "Mostrar botoes de ajuda";
            localized["desktop.install_link.preference.hidden_choice"] = "Ocultar botoes de ajuda";
            localized["desktop.install_link.preference.on"] = "Botoes de ajuda estao visiveis nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Botoes de ajuda estao ocultos nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Oculta ajudas opcionais e entradas de historia. Criacao de personagem, regras, atualizacoes e downloads continuam disponiveis.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "可选帮助";
            localized["desktop.install_link.preference.summary"] = "显示或隐藏帮助按钮和故事工具。角色工具保持不变。";
            localized["desktop.install_link.preference.checkbox"] = "显示帮助按钮";
            localized["desktop.install_link.preference.visible_choice"] = "显示帮助按钮";
            localized["desktop.install_link.preference.hidden_choice"] = "隐藏帮助按钮";
            localized["desktop.install_link.preference.on"] = "此安装中帮助按钮可见。";
            localized["desktop.install_link.preference.off"] = "此安装中帮助按钮隐藏。";
            localized["desktop.install_link.preference.tip"] = "隐藏可选帮助和故事入口。角色创建、规则、更新和下载仍可使用。";
