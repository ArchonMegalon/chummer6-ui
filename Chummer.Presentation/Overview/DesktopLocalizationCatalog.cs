...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.preference.summary"] = "Choose whether Chummer shows Alice, Origin Dossier, and generated story tools. Character creation still works normally either way.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.summary"] = "Waehlen Sie, ob Chummer Alice, Origin Dossier und generierte Story-Werkzeuge zeigt. Die Charaktererstellung funktioniert in beiden Faellen normal.";
            ...
            localized["desktop.install_link.preference.tip"] = "Blendet Alice, Origin Dossier und generierte Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfuegbar.";
