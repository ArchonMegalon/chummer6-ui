...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.summary"] = "Link this install once. Downloads and updates stay the same for everyone.",
        ...
        ["desktop.install_link.claim_code_label"] = "Sign-in code",
        ["desktop.install_link.more_tools"] = "More tools",
        ["desktop.install_link.next_step"] = "Next step",
        ["desktop.install_link.preference.title"] = "Assisted features",
        ["desktop.install_link.preference.summary"] = "Choose whether this install shows character guidance and story helpers. You can change this later in Settings.",
        ["desktop.install_link.preference.checkbox"] = "Show assisted features",
        ["desktop.install_link.preference.visible_choice"] = "Use assisted features",
        ["desktop.install_link.preference.hidden_choice"] = "Keep the interface manual",
        ["desktop.install_link.preference.on"] = "Assisted features are visible in this install.",
        ["desktop.install_link.preference.off"] = "Assisted features are hidden in this install.",
        ["desktop.install_link.preference.tip"] = "Hides guidance and story entry points. Character creation, rules, updates, and downloads stay available.",
        ...
        ["desktop.install_link.button.open_work"] = "Open Workspace",
        ["desktop.install_link.button.open_account"] = "Open Account",
        ["desktop.install_link.button.link_copy"] = "Link This Copy",
        ["desktop.install_link.button.copy_login_url"] = "Copy Login URL",
        ["desktop.install_link.button.redeem_claim_code"] = "Finish Sign-in",
        ...
        ["desktop.install_link.claim_code_watermark"] = "Paste sign-in code",
        ["desktop.install_link.status.prompt_guest_claim"] = "If the browser did not finish linking this install, paste the sign-in code here.",
        ...
        ["desktop.install_link.status.opened_account"] = "Opened your account so you can finish sign-in or review this install.",
        ["desktop.install_link.status.unable_open_account"] = "Unable to open the Hub account page from this host.",
        ["desktop.install_link.status.login_url_copied"] = "Copied the login URL. Paste it into your browser to finish linking this install.",
        ["desktop.install_link.status.manual_login_url"] = "Browser launch failed. Open or copy this login URL to finish linking this install:",
        ...
        ["desktop.install_link.status.claim_code_required"] = "Paste the sign-in code first.",
        ["desktop.install_link.status.linking"] = "Linking this installation with Hub...",
        ["desktop.install_link.status.guided_tools_visible"] = "Assisted features are visible.",
        ["desktop.install_link.status.guided_tools_hidden"] = "Assisted features are hidden.",
        ...
        ["desktop.install_link.summary.browser_open_attempt"] = "Browser handoff attempt: {0} UTC.",
        ["desktop.install_link.summary.browser_open_error"] = "Browser handoff error: {0}",
        ...
        ["desktop.install_link.summary.next_safe_action_guest"] = "Next step: sign in and link this install before using account recovery or support history.",
        ["desktop.devices.title"] = "Account and Devices",
        ["desktop.devices.heading"] = "Account and devices",
        ["desktop.devices.section.current"] = "This install",
        ["desktop.devices.section.claimed"] = "Your devices",
        ["desktop.devices.section.claims"] = "Sign-in link",
        ["desktop.devices.section.follow_through"] = "Help and support",
        ["desktop.devices.section.current_description"] = "Local copy, version, update channel, and account link.",
        ["desktop.devices.section.claimed_description"] = "Other linked installs that can restore this account.",
        ["desktop.devices.section.claims_description"] = "Pending sign-in links and recent downloads.",
        ["desktop.devices.section.follow_through_description"] = "Support, recovery, and account pages.",
        ["desktop.devices.section.interface"] = "Interface",
        ["desktop.devices.button.reload"] = "Check again",
        ["desktop.devices.button.use_latest_claim"] = "Finish sign-in",
        ["desktop.devices.button.copy_claim_code"] = "Open Install Handoff",
        ["desktop.devices.intro.guest"] = "Link this install to keep account, recovery, and support information attached to this machine.",
        ["desktop.devices.intro.pending"] = "A sign-in link is ready. Finish it here when you are ready.",
        ...
        ["desktop.devices.status.claim_code_copied"] = "Opened the current sign-in link inside Chummer.",
        ["desktop.devices.status.no_claim_code"] = "No sign-in link is visible for this account right now.",
        ...
        ["desktop.devices.context.claims_none"] = "No pending sign-in links or recent downloads are visible right now.",
        ["desktop.devices.context.claims_pending"] = "Sign-in link for {1} {2} stays ready until {3} UTC.",
        ["desktop.devices.context.claims_pending_install"] = "Sign-in link is already bound to install {1} until {2} UTC.",
        ["desktop.devices.context.claims_local_last"] = "A previous sign-in attempt is saved locally on this install.",
        ["desktop.devices.context.claims_receipt"] = "Recent download: {0} · {1} {2} on {3}/{4}, issued {5} UTC.",
        ["desktop.devices.context.access_guest"] = "Link this install before using account recovery or support history.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Assistierte Funktionen";
            localized["desktop.install_link.preference.summary"] = "Wahlen Sie, ob diese Installation Charakterhilfe und Story-Einstiege zeigt. Das kann spater in Einstellungen geandert werden.";
            localized["desktop.install_link.preference.checkbox"] = "Assistierte Funktionen anzeigen";
            localized["desktop.install_link.preference.visible_choice"] = "Assistierte Funktionen nutzen";
            localized["desktop.install_link.preference.hidden_choice"] = "Oberflache manuell halten";
            localized["desktop.install_link.preference.on"] = "Assistierte Funktionen sind in dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "Assistierte Funktionen sind in dieser Installation ausgeblendet.";
            localized["desktop.install_link.preference.tip"] = "Blendet Hilfe- und Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfugbar.";
            ...
            localized["desktop.install_link.button.open_work"] = "Arbeitsbereich offnen";
            ...
            localized["desktop.install_link.button.redeem_claim_code"] = "Anmeldung abschliessen";
            ...
            localized["desktop.install_link.status.prompt_guest_claim"] = "Wenn der Browser diese Installation nicht verknupft hat, fugen Sie hier den Anmeldecode ein.";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "Login-URL kopieren";
            localized["desktop.install_link.status.login_url_copied"] = "Die Login-URL wurde in die Zwischenablage kopiert. Fügen Sie sie in den Browser ein, um diese Installation zu verknüpfen.";
            localized["desktop.install_link.status.manual_login_url"] = "Browserstart fehlgeschlagen. Öffnen oder kopieren Sie diese Login-URL, um die Verknüpfung abzuschließen:";
            localized["desktop.install_link.summary.browser_open_attempt"] = "Browserweitergabeversuch: {0} UTC.";
            localized["desktop.install_link.summary.browser_open_error"] = "Browserweitergabefehler: {0}";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Assistierte Funktionen sind sichtbar.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Assistierte Funktionen sind ausgeblendet.";
            ...
            localized["desktop.devices.title"] = "Konto und Gerate";
            localized["desktop.devices.heading"] = "Konto und Gerate";
            localized["desktop.devices.section.current"] = "Diese Installation";
            localized["desktop.devices.section.claimed"] = "Ihre Gerate";
            localized["desktop.devices.section.claims"] = "Anmeldelink";
            localized["desktop.devices.section.follow_through"] = "Hilfe und Support";
            localized["desktop.devices.section.current_description"] = "Lokale Installation, Version, Update-Kanal und Kontolink.";
            localized["desktop.devices.section.claimed_description"] = "Andere verknupfte Installationen fur die Wiederherstellung.";
            localized["desktop.devices.section.claims_description"] = "Offene Anmeldelinks und letzte Downloads.";
            localized["desktop.devices.section.follow_through_description"] = "Support, Wiederherstellung und Kontoseiten.";
            localized["desktop.devices.section.interface"] = "Oberflache";
            localized["desktop.devices.button.reload"] = "Erneut prufen";
            localized["desktop.devices.button.use_latest_claim"] = "Anmeldung abschliessen";
            localized["desktop.devices.button.copy_claim_code"] = "Anmeldelink offnen";
            localized["desktop.devices.intro.guest"] = "Verknupfen Sie diese Installation, damit Konto, Wiederherstellung und Support an diesen Rechner gebunden bleiben.";
            localized["desktop.devices.intro.pending"] = "Ein Anmeldelink ist bereit. Schliessen Sie ihn hier ab, wenn Sie bereit sind.";
            ...
            localized["desktop.devices.status.claim_code_copied"] = "Der aktuelle Anmeldelink wurde in Chummer geoffnet.";
            localized["desktop.devices.status.no_claim_code"] = "Aktuell ist kein Anmeldelink fur dieses Konto sichtbar.";
            ...
            localized["desktop.devices.context.claims_none"] = "Aktuell sind keine offenen Anmeldelinks oder neuen Downloads sichtbar.";
            localized["desktop.devices.context.claims_pending"] = "Anmeldelink fur {1} {2} bleibt bis {3} UTC bereit.";
            localized["desktop.devices.context.claims_pending_install"] = "Anmeldelink ist bereits bis {2} UTC an Installation {1} gebunden.";
            ...
            localized["desktop.devices.context.access_guest"] = "Verknupfen Sie diese Installation, bevor Sie Kontowiederherstellung oder Supportverlauf nutzen.";
            localized["desktop.devices.context.access_claimed"] = "Support, Updates und Arbeitsbereich-Wiederherstellung sind mit dieser verknupften Installation verbunden.";
            localized["desktop.devices.context.access_no_grants"] = "Fur dieses Konto sind noch keine aktiven Zugriffsgrants sichtbar.";
            localized["desktop.devices.context.access_grant"] = "Grant {0} fur {1} bleibt {2} bis {3} UTC.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Fonctions assistees";
            localized["desktop.install_link.preference.summary"] = "Choisissez si cette installation affiche l'aide de personnage et les entrees narratives. Vous pourrez le modifier plus tard dans Parametres.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher les fonctions assistees";
            localized["desktop.install_link.preference.visible_choice"] = "Utiliser les fonctions assistees";
            localized["desktop.install_link.preference.hidden_choice"] = "Garder l'interface manuelle";
            localized["desktop.install_link.preference.on"] = "Les fonctions assistees sont visibles dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les fonctions assistees sont masquees dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Masque les entrees d'aide et de narration. Creation de personnage, regles, mises a jour et telechargements restent disponibles.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Les fonctions assistees sont visibles.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Les fonctions assistees sont masquees.";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "Copier l'URL de connexion";
            localized["desktop.install_link.status.login_url_copied"] = "L'URL de connexion a été copiée dans le presse-papiers. Collez-la dans votre navigateur pour terminer la liaison de cette installation.";
            localized["desktop.install_link.status.manual_login_url"] = "Le lancement du navigateur a échoué. Ouvrez ou copiez cette URL de connexion pour terminer la liaison :";
            localized["desktop.install_link.summary.browser_open_attempt"] = "Tentative d'ouverture du navigateur : {0} UTC.";
            localized["desktop.install_link.summary.browser_open_error"] = "Erreur d'ouverture du navigateur : {0}";
            ...
            localized["desktop.devices.title"] = "Account and Devices";
            localized["desktop.devices.heading"] = "Account and devices";
            localized["desktop.devices.section.current"] = "This install";
            localized["desktop.devices.section.claimed"] = "Your devices";
            localized["desktop.devices.section.claims"] = "Sign-in link";
            localized["desktop.devices.section.follow_through"] = "Help and support";
            localized["desktop.devices.section.current_description"] = "Local copy, version, update channel, and account link.";
            localized["desktop.devices.section.claimed_description"] = "Other linked installs that can restore this account.";
            localized["desktop.devices.section.claims_description"] = "Pending sign-in links and recent downloads.";
            localized["desktop.devices.section.follow_through_description"] = "Support, recovery, and account pages.";
            localized["desktop.devices.section.interface"] = "Interface";
            localized["desktop.devices.button.reload"] = "Check again";
            localized["desktop.devices.button.use_latest_claim"] = "Finish sign-in";
            localized["desktop.devices.button.copy_claim_code"] = "Open sign-in link";
            localized["desktop.devices.intro.guest"] = "Link this install to keep account, recovery, and support information attached to this machine.";
            localized["desktop.devices.intro.pending"] = "A sign-in link is ready. Finish it here when you are ready.";
            ...
            localized["desktop.devices.status.claim_code_copied"] = "Opened the current sign-in link inside Chummer.";
            localized["desktop.devices.status.no_claim_code"] = "No sign-in link is visible for this account right now.";
            ...
            localized["desktop.devices.context.claimed_restore"] = "Restore: {0}";
            localized["desktop.devices.context.claimed_fallback"] = "Linked copy: {0} · {1} {2} on {3}/{4}.";
            localized["desktop.devices.context.claims_none"] = "No pending sign-in links or recent downloads are visible right now.";
            localized["desktop.devices.context.claims_pending"] = "Sign-in link for {1} {2} stays ready until {3} UTC.";
            localized["desktop.devices.context.claims_pending_install"] = "Sign-in link is already bound to install {1} until {2} UTC.";
            localized["desktop.devices.context.claims_local_last"] = "A previous sign-in attempt is saved locally on this install.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "支援機能";
            localized["desktop.install_link.preference.summary"] = "このインストールでキャラクター支援とストーリー入口を表示するか選びます。後で設定から変更できます。";
            localized["desktop.install_link.preference.checkbox"] = "支援機能を表示";
            localized["desktop.install_link.preference.visible_choice"] = "支援機能を使う";
            localized["desktop.install_link.preference.hidden_choice"] = "手動インターフェイスにする";
            localized["desktop.install_link.preference.on"] = "このインストールでは支援機能が表示されます。";
            localized["desktop.install_link.preference.off"] = "このインストールでは支援機能が非表示です。";
            localized["desktop.install_link.preference.tip"] = "支援とストーリーの入口を隠します。キャラクター作成、ルール、更新、ダウンロードは利用できます。";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "支援機能は表示されています。";
            localized["desktop.install_link.status.guided_tools_hidden"] = "支援機能は非表示です。";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "ログイン URL をコピー";
            localized["desktop.install_link.status.login_url_copied"] = "ログイン URL をクリップボードにコピーしました。 このインストールのリンクを完了するためブラウザーに貼り付けてください。";
            localized["desktop.install_link.status.manual_login_url"] = "ブラウザー起動に失敗しました。このログイン URL を開くかコピーして、インストールのリンクを完了してください:";
            ...
            localized["desktop.support_case.follow_through.link_install"] = "次の手順: Account and Devices を開き、影響を受けるインストールをリンクし直してください。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Recursos assistidos";
            localized["desktop.install_link.preference.summary"] = "Escolha se esta instalacao mostra ajuda de personagem e entradas de historia. Voce pode alterar depois em Configuracoes.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar recursos assistidos";
            localized["desktop.install_link.preference.visible_choice"] = "Usar recursos assistidos";
            localized["desktop.install_link.preference.hidden_choice"] = "Manter a interface manual";
            localized["desktop.install_link.preference.on"] = "Recursos assistidos estao visiveis nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Recursos assistidos estao ocultos nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Oculta entradas de ajuda e historia. Criacao de personagem, regras, atualizacoes e downloads continuam disponiveis.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Recursos assistidos estao visiveis.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Recursos assistidos estao ocultos.";
            ...
            localized["desktop.install_link.button.copy_login_url"] = "Copiar URL de login";
            localized["desktop.install_link.status.login_url_copied"] = "A URL de login foi copiada. Cole-a no navegador para concluir o vínculo desta instalação.";
            localized["desktop.install_link.status.manual_login_url"] = "Falha ao abrir o navegador. Abra ou copie esta URL de login para concluir a vinculação desta instalação:";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "辅助功能";
            localized["desktop.install_link.preference.summary"] = "选择此安装是否显示角色指导与故事入口。稍后可在设置中更改。";
            localized["desktop.install_link.preference.checkbox"] = "显示辅助功能";
            localized["desktop.install_link.preference.visible_choice"] = "使用辅助功能";
            localized["desktop.install_link.preference.hidden_choice"] = "保持手动界面";
            localized["desktop.install_link.preference.on"] = "此安装中辅助功能可见。";
            localized["desktop.install_link.preference.off"] = "此安装中辅助功能隐藏。";
            localized["desktop.install_link.preference.tip"] = "隐藏指导与故事入口。角色创建、规则、更新和下载仍可使用。";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "辅助功能已显示。";
            localized["desktop.install_link.status.guided_tools_hidden"] = "辅助功能已隐藏。";
            ...
            localized["desktop.support_case.follow_through.link_install"] = "下一步: 打开 Account and Devices，重新关联受影响安装。";
