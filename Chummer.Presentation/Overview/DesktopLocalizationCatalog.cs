...
public static class DesktopLocalizationCatalog
{
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.campaign.intro.local_fallback"] = "Die Live-Kampagnen-Serverebene ist nicht verfügbar, daher zeigt dieser Arbeitsbereich die starkste sichere lokale Kampagnenzusammenfassung und Wiederherstellungs-Posture auf diesem Desktop.";
            ...
            localized["desktop.support.follow_through.guest"] = "Die Support-Spur ist derzeit auf Gast-Posture begrenzt, bis diese Kopie verknüpft ist.";
            ...
            localized["desktop.support_case.follow_through.verify"] = "Diese verknüpfte Installation trägt bereits die reporter-bereite Fix-Posture. Nutzen Sie den angemeldeten Support-Weg für die finale Bestätigung, ohne die Fall-Kontinuität zu verlieren.";
