...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.campaign.intro.guest"] = "This campaign workspace is still local-only. Claim this copy before you rely on restore, device status, or support.",
        ["desktop.campaign.intro.local_fallback"] = "The campaign service is unavailable, so this workspace is showing the best local campaign summary and restore status available on this desktop.",
        ["desktop.campaign.intro.watchouts"] = "This campaign workspace is ready to continue, but a few things still need review before you jump back into live session work.",
        ["desktop.campaign.intro.ready"] = "This campaign workspace can reopen session context, runboard context, and support status from the desktop.",
        ["desktop.campaign.status.local_fallback"] = "Campaign workspace status: local campaign data is shown because the live campaign service is unavailable.",
        ["desktop.campaign.status.server_generated"] = "Campaign workspace status: live service updated {0} UTC.",
        ["desktop.campaign.status.refresh_failed"] = "Campaign workspace status: refresh failed, so the last good local state is still shown.",
        ...
        ["desktop.campaign.restore.no_workspace"] = "No local workspace is pinned yet, so restore status is limited to the campaign summary and linked-copy state.",
        ...
        ["desktop.install_link.preference.title"] = "Assistant features",
        ["desktop.install_link.preference.summary"] = "Choose whether Chummer shows Alice, Origin Dossier, and optional story tools. Character creation still works normally either way.",
        ["desktop.install_link.preference.checkbox"] = "Show assistant features",
        ["desktop.install_link.preference.visible_choice"] = "Show assistant features",
        ["desktop.install_link.preference.hidden_choice"] = "Hide assistant features",
        ["desktop.install_link.preference.on"] = "Assistant features are shown in this install.",
        ["desktop.install_link.preference.off"] = "Assistant features are hidden in this install.",
        ...
        ["desktop.install_link.button.open_work"] = "Open linked workspace",
        ...
        ["desktop.home.intro.ready_recent_workspaces"] = "This copy is linked, current enough to continue, and ready to reopen recent workspaces.",
        ["desktop.home.intro.ready_current_campaign_workspace"] = "This copy is linked, current enough to continue, and ready to reopen the current campaign workspace.",
        ...
        ["desktop.home.workspace_summary.empty"] = "No recent workspaces were restored yet. Import or create a runner to get started.",
        ...
        ["desktop.home.button.open_work_support"] = "Get workspace help",
        ...
        ["desktop.home.button.open_workspace_followthrough"] = "Open Workspace Help",
        ...
        ["desktop.install_link.summary.next_safe_action_claimed"] = "Next step: open your workspace.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.feedback.campaign_workspace_reviewed"] = "Status: Kampagnen-Arbeitsbereich wurde geprüft.";
            ...
            localized["desktop.home.button.open_work_support"] = "Arbeitsbereich-Hilfe öffnen";
            ...
            localized["desktop.home.button.open_workspace_followthrough"] = "Arbeitsbereich-Hilfe öffnen";
            ...
            localized["desktop.home.intro.ready_recent_workspaces"] = "Diese Kopie ist verknüpft, aktuell genug und bereit, letzte Arbeitsbereiche wieder zu öffnen.";
            localized["desktop.home.intro.ready_current_campaign_workspace"] = "Diese Kopie ist verknüpft, aktuell genug und bereit, den aktuellen Kampagnen-Arbeitsbereich wieder zu öffnen.";
            localized["desktop.home.update_summary"] = "Build: {1}\nAktualisiert: {3} UTC\nKanal: {4}\nUpdate-Einstellung: {6}\nStatus: {0}\nNächster Schritt: {15}\nProblem: {16}";
            localized["desktop.home.workspace_summary.empty"] = "Es wurden noch keine letzten Arbeitsbereiche wiederhergestellt. Importieren oder erstellen Sie einen Runner, um zu beginnen.";
            ...
            localized["desktop.campaign.intro.guest"] = "Dieser Kampagnen-Arbeitsbereich ist noch lokal. Beanspruchen Sie diese Kopie, bevor Sie Wiederherstellung, Gerätestatus oder Support nutzen.";
            ...
            localized["desktop.campaign.intro.watchouts"] = "Dieser Kampagnen-Arbeitsbereich ist fast bereit, aber vor der Fortsetzung der Live-Sitzung müssen noch ein paar Punkte geprüft werden.";
            localized["desktop.campaign.intro.ready"] = "Dieser Kampagnen-Arbeitsbereich kann Sitzungsstand, Runboard-Stand und Support-Status vom Desktop wieder öffnen.";
            localized["desktop.campaign.status.local_fallback"] = "Kampagnen-Arbeitsbereich-Status: Lokale Kampagnendaten werden angezeigt, weil der Live-Kampagnendienst nicht verfügbar ist.";
            localized["desktop.campaign.status.server_generated"] = "Kampagnen-Arbeitsbereich-Status: Live-Dienst aktualisiert um {0} UTC.";
            localized["desktop.campaign.status.refresh_failed"] = "Kampagnen-Arbeitsbereich-Status: Aktualisierung fehlgeschlagen, daher wird weiter der letzte gute lokale Stand angezeigt.";
            ...
            localized["desktop.install_link.preference.title"] = "Assistentenfunktionen";
            localized["desktop.install_link.preference.summary"] = "Waehlen Sie, ob Chummer Alice, Origin Dossier und optionale Story-Werkzeuge zeigt. Die Charaktererstellung funktioniert in beiden Faellen normal.";
            localized["desktop.install_link.preference.checkbox"] = "Assistentenfunktionen anzeigen";
            localized["desktop.install_link.preference.visible_choice"] = "Assistentenfunktionen anzeigen";
            localized["desktop.install_link.preference.hidden_choice"] = "Assistentenfunktionen ausblenden";
            localized["desktop.install_link.preference.on"] = "Assistentenfunktionen sind in dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "Assistentenfunktionen sind in dieser Installation ausgeblendet.";
            localized["desktop.install_link.preference.tip"] = "Blendet Alice, Origin Dossier und optionale Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfuegbar.";
            ...
            localized["desktop.install_link.summary.next_safe_action_claimed"] = "Nächster Schritt: Arbeitsbereich öffnen.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Fonctions d'assistance";
            localized["desktop.install_link.preference.summary"] = "Choisissez si Chummer affiche Alice, Origin Dossier et les outils narratifs generes. La creation de personnage fonctionne normalement dans les deux cas.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher les fonctions d'assistance";
            localized["desktop.install_link.preference.visible_choice"] = "Afficher les fonctions d'assistance";
            localized["desktop.install_link.preference.hidden_choice"] = "Masquer les fonctions d'assistance";
            localized["desktop.install_link.preference.on"] = "Les fonctions d'assistance sont affichees dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les fonctions d'assistance sont masquees dans cette installation.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "アシスタント機能";
            localized["desktop.install_link.preference.summary"] = "Alice、Origin Dossier、生成ストーリーツールを表示するか選べます。キャラクター作成はどちらでも通常どおり使えます。";
            localized["desktop.install_link.preference.checkbox"] = "アシスタント機能を表示";
            localized["desktop.install_link.preference.visible_choice"] = "アシスタント機能を表示";
            localized["desktop.install_link.preference.hidden_choice"] = "アシスタント機能を隠す";
            localized["desktop.install_link.preference.on"] = "このインストールではアシスタント機能を表示します。";
            localized["desktop.install_link.preference.off"] = "このインストールではアシスタント機能を隠します。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Recursos assistivos";
            localized["desktop.install_link.preference.summary"] = "Escolha se Chummer mostra Alice, Origin Dossier e ferramentas de historia geradas. A criacao de personagem funciona normalmente de qualquer forma.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar recursos assistivos";
            localized["desktop.install_link.preference.visible_choice"] = "Mostrar recursos assistivos";
            localized["desktop.install_link.preference.hidden_choice"] = "Ocultar recursos assistivos";
            localized["desktop.install_link.preference.on"] = "Recursos assistivos estao visiveis nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Recursos assistivos estao ocultos nesta instalacao.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "助手功能";
            localized["desktop.install_link.preference.summary"] = "选择 Chummer 是否显示 Alice、Origin Dossier 和生成的故事工具。角色创建在两种设置下都可正常使用。";
            localized["desktop.install_link.preference.checkbox"] = "显示助手功能";
            localized["desktop.install_link.preference.visible_choice"] = "显示助手功能";
            localized["desktop.install_link.preference.hidden_choice"] = "隐藏助手功能";
            localized["desktop.install_link.preference.on"] = "此安装中助手功能会显示。";
            localized["desktop.install_link.preference.off"] = "此安装中助手功能会隐藏。";
