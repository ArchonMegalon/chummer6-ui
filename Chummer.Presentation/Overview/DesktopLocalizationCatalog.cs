...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.home.section.horizons"] = "Product areas",
        ["desktop.home.section.language_trust"] = "Language and trust surfaces",
        ["desktop.home.section.recent_workspaces"] = "Recent workspaces",
        ["desktop.home.horizons.summary"] = "Open the main product areas from desktop home. Alice, Ready for Tonight, Run Control, Table Pulse, Black Ledger, and deeper tools stay one click away.",
        ["desktop.horizons.title"] = "Workbenches",
        ["desktop.horizons.heading"] = "Workbenches",
        ["desktop.horizons.intro"] = "Open Chummer product areas from one desktop hub. Use native workbenches first; open the signed-in or public page only when it is the right target.",
        ...
        ["desktop.update.intro.disabled"] = "Self-update is not configured for this install yet.",
        ...
        ["desktop.support_case.intro.action_needed"] = "This tracked case still needs follow-through before it can be closed for this copy.",
        ...
        ["desktop.crash.recovery.private_local"] = "Diagnostics stay local by default. Automatic send uses a redacted crash report and does not replace support follow-through.",
        ...
        ["desktop.crash.recovery.preview"] = "Preview mode skips hosted send and only checks that this recovery window opens cleanly.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.horizons"] = "Werkbänke";
            ...
            localized["desktop.home.section.horizons"] = "Produktbereiche";
            ...
            localized["desktop.horizons.title"] = "Werkbänke";
            localized["desktop.horizons.heading"] = "Werkbänke";
            localized["desktop.horizons.intro"] = "Öffne Chummer-Produktbereiche aus einem Desktop-Hub. Nutze zuerst native Werkbänke; öffne die angemeldete oder öffentliche Webseite nur, wenn sie das richtige Ziel ist.";
            ...
            localized["desktop.home.button.open_horizons_public"] = "Öffentliche Seite öffnen";
            ...
            localized["desktop.home.intro.claim_failed_guest"] = "Diese Kopie lauft noch als Gast, weil der letzte Claim-Versuch fehlgeschlagen ist. Beanspruchen Sie sie, bevor Sie Support, Fix-Hinweise oder Wiederherstellung nutzen.";
            ...
            localized["desktop.home.intro.release_posture_review"] = "Diese Kopie ist verknupft, aber das aktuelle Release muss gepruft werden, bevor Sie Updates, Support oder Kampagnen-Kontinuitat nutzen.";
            ...
            localized["desktop.campaign.intro.guest"] = "Dieser Kampagnen-Arbeitsbereich ist noch lokal. Beanspruchen Sie diese Kopie, bevor Sie Wiederherstellung, Geratestatus oder Support nutzen.";
            ...
            localized["desktop.install_link.preference.visible_choice"] = "Ja, ich bin bereit fuer eine moderne Welt wie Shadowrun";
            localized["desktop.install_link.preference.hidden_choice"] = "Nein, emotional bin ich ein aengstlicher Hoehlenmensch";
            ...
            localized["desktop.install_link.preference.tip"] = "Deaktiviert Alice, Origin Dossier und generierte Story-Einstiege. Charaktererstellung, Regeln, Updates und Downloads bleiben verfuegbar.";
            ...
            localized["desktop.install_link.shipping_locales"] = "Verfugbare Sprachen: {0}.";
            ...
            localized["desktop.install_link.status.opened_work_route"] = "Der Arbeitsbereich wurde geoffnet.";
            localized["desktop.install_link.status.unable_open_work_route"] = "Der Arbeitsbereich kann auf diesem Host nicht geoffnet werden.";
            ...
            localized["desktop.install_link.status.opened_downloads"] = "Downloads wurden geoffnet.";
            localized["desktop.install_link.status.unable_open_downloads"] = "Downloads konnen auf diesem Host nicht geoffnet werden.";
            localized["desktop.install_link.status.opened_support"] = "Support fur diese Kopie wurde geoffnet.";
            ...
            localized["desktop.install_link.summary.next_safe_action_claimed"] = "Nachster Schritt: Arbeitsbereich offnen.";
            localized["desktop.install_link.summary.next_safe_action_guest"] = "Nachster Schritt: diese Kopie online beanspruchen, bevor Sie Konto-Wiederherstellung oder Support-Verlauf nutzen.";
            ...
            localized["desktop.update.intro.disabled"] = "Selbstaktualisierung ist fur diese Installation noch nicht konfiguriert.";
            ...
            localized["desktop.support_case.intro.action_needed"] = "Dieser verfolgte Fall braucht noch Nachverfolgung, bevor er fur diese Kopie geschlossen werden kann.";
            ...
            localized["desktop.dialog.global_settings.message"] = "Sprachanderungen gelten nach dem Neustart. Verfugbare Sprachen: {0}";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.horizons"] = "Ateliers";
            ...
            localized["desktop.home.section.horizons"] = "Espaces produit";
            ...
            localized["desktop.horizons.title"] = "Ateliers";
            localized["desktop.horizons.heading"] = "Ateliers";
            localized["desktop.horizons.intro"] = "Ouvrez les espaces produit Chummer depuis un hub desktop. Utilisez d’abord les ateliers natifs ; ouvrez la page web connectée ou publique seulement quand c’est la bonne cible.";
            ...
            localized["desktop.home.button.open_horizons_public"] = "Ouvrir la page publique";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.horizons"] = "ワークベンチ";
            ...
            localized["desktop.home.section.horizons"] = "製品エリア";
            ...
            localized["desktop.horizons.title"] = "ワークベンチ";
            localized["desktop.horizons.heading"] = "ワークベンチ";
            localized["desktop.horizons.intro"] = "1 つのデスクトップハブから Chummer の製品エリアを開きます。まずネイティブのワークベンチを使い、必要な場合だけサインイン済みまたは公開 Web ページを開きます。";
            ...
            localized["desktop.home.button.open_horizons_public"] = "公開ページを開く";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.horizons"] = "Bancadas";
            ...
            localized["desktop.home.section.horizons"] = "Áreas do produto";
            ...
            localized["desktop.horizons.title"] = "Bancadas";
            localized["desktop.horizons.heading"] = "Bancadas";
            localized["desktop.horizons.intro"] = "Abra as áreas do Chummer em um único hub do desktop. Use primeiro as bancadas nativas; abra a página web autenticada ou pública só quando ela for o alvo certo.";
            ...
            localized["desktop.home.button.open_horizons_public"] = "Abrir página pública";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.shell.tool.horizons"] = "工作台";
            ...
            localized["desktop.home.section.horizons"] = "产品区域";
            ...
            localized["desktop.horizons.title"] = "工作台";
            localized["desktop.horizons.heading"] = "工作台";
            localized["desktop.horizons.intro"] = "从一个桌面中枢打开 Chummer 产品区域。优先使用原生工作台；只有在确实需要时才打开登录网页或公开网页。";
            ...
            localized["desktop.home.button.open_horizons_public"] = "打开公开页面";
