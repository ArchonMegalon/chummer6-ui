...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.campaign.intro.ready"] = "This campaign workspace can restore session state, runboard state, and support status from the desktop.",
        ...
        ["desktop.campaign.readiness.local_fallback"] = "Runboard detail is currently limited to locally available campaign data until the live server plane returns.",
        ["desktop.campaign.restore.latest_workspace"] = "Latest local workspace: {0} . {1} UTC",
        ["desktop.campaign.restore.no_workspace"] = "No local workspace is pinned yet, so restore status stays limited to the campaign digest and claimed-device state.",
        ...
        ["desktop.home.intro.update_available"] = "An update is ready for this install. Check Updates before you jump back into campaign work.",
        ["desktop.home.intro.release_posture_review"] = "This copy is linked, but the current release needs attention before you rely on updates, support, or campaign continuity.",
        ...
        ["desktop.update.checked"] = "Update result: {0}.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.home.intro.update_available"] = "Ein Update ist für diese Installation bereit. Prüfen Sie die Aktualisierungen, bevor Sie zur Kampagnenarbeit zurückkehren.";
            localized["desktop.home.intro.release_posture_review"] = "Diese Kopie ist verknüpft, aber das aktuelle Release braucht Aufmerksamkeit, bevor Sie Updates, Support oder Kampagnen-Kontinuität nutzen.";
            ...
            localized["desktop.campaign.intro.ready"] = "Dieser Kampagnen-Arbeitsbereich ist bereit, Sitzungsstand, Runboard-Zustand und Support-Abschluss vom Desktop wiederherzustellen.";
            localized["desktop.campaign.status.local_fallback"] = "Kampagnen-Arbeitsbereich-Status: Begrenzter lokaler Fallback ist aktiv, weil die Live-Kampagnen-Serverebene nicht verfügbar ist.";
            ...
            localized["desktop.campaign.readiness.local_fallback"] = "Runboard-Details sind derzeit auf lokal verfügbare Kampagnendaten begrenzt, bis die Live-Serverebene zurückkehrt.";
            localized["desktop.campaign.restore.latest_workspace"] = "Letzter lokaler Arbeitsbereich: {0} . {1} UTC";
            localized["desktop.campaign.restore.no_workspace"] = "Noch ist kein lokaler Arbeitsbereich angeheftet, daher bleibt die Wiederherstellung auf Kampagnenzusammenfassung und verknüpften Geraetestatus begrenzt.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.update.intro.available"] = "Une mise a jour est disponible pour cette installation. Verifiez les mises a jour avant de revenir au travail de campagne.";
            localized["desktop.update.intro.attention"] = "Cette installation doit etre verifiee avant de lui faire confiance.";
