...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.shell.workspace_strip.caption"] = "Ruleset, tabs, and save posture stay visible while you move through dense builder sections.",
        ["desktop.shell.workspace_strip.quick_start_caption"] = "Load the bundled demo runner to open a real workbench immediately.",
