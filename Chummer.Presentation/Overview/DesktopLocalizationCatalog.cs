...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.install_link.preference.title"] = "Optional tools",
        ["desktop.install_link.preference.summary"] = "Choose whether this copy shows optional character guidance and story tools. You can change this later in Settings.",
        ["desktop.install_link.preference.checkbox"] = "Show optional tools",
        ["desktop.install_link.preference.visible_choice"] = "Show optional tools",
        ["desktop.install_link.preference.hidden_choice"] = "Keep Chummer quiet",
        ["desktop.install_link.preference.on"] = "Optional tools are visible in this install.",
        ["desktop.install_link.preference.off"] = "Optional tools are hidden in this install.",
        ["desktop.install_link.preference.tip"] = "This hides optional guidance and story entry points. Character creation, rules, updates, and downloads stay available.",
        ...
        ["desktop.install_link.status.guided_tools_visible"] = "Optional tools are visible.",
        ["desktop.install_link.status.guided_tools_hidden"] = "Optional tools are hidden.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Optionale Werkzeuge";
            localized["desktop.install_link.preference.summary"] = "Wahlen Sie, ob diese Installation optionale Charakterhilfe und Story-Werkzeuge zeigt. Das kann spater in Einstellungen geandert werden.";
            localized["desktop.install_link.preference.checkbox"] = "Optionale Werkzeuge anzeigen";
            localized["desktop.install_link.preference.visible_choice"] = "Optionale Werkzeuge anzeigen";
            localized["desktop.install_link.preference.hidden_choice"] = "Chummer ruhig halten";
            localized["desktop.install_link.preference.on"] = "Optionale Werkzeuge sind in dieser Installation sichtbar.";
            localized["desktop.install_link.preference.off"] = "Optionale Werkzeuge sind in dieser Installation ausgeblendet.";
            localized["desktop.install_link.preference.tip"] = "Blendet optionale Hilfe- und Story-Einstiege aus. Charaktererstellung, Regeln, Updates und Downloads bleiben verfugbar.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Optionale Werkzeuge sind sichtbar.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Optionale Werkzeuge sind ausgeblendet.";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Outils optionnels";
            localized["desktop.install_link.preference.summary"] = "Choisissez si cette installation affiche l'aide de personnage et les outils narratifs optionnels. Vous pourrez le modifier plus tard dans Parametres.";
            localized["desktop.install_link.preference.checkbox"] = "Afficher les outils optionnels";
            localized["desktop.install_link.preference.visible_choice"] = "Afficher les outils optionnels";
            localized["desktop.install_link.preference.hidden_choice"] = "Garder Chummer discret";
            localized["desktop.install_link.preference.on"] = "Les outils optionnels sont visibles dans cette installation.";
            localized["desktop.install_link.preference.off"] = "Les outils optionnels sont masques dans cette installation.";
            localized["desktop.install_link.preference.tip"] = "Masque les entrees optionnelles d'aide et de narration. Creation de personnage, regles, mises a jour et telechargements restent disponibles.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Les outils optionnels sont visibles.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Les outils optionnels sont masques.";
        ...
        if (string.Equals(languageCode, "ja-jp", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "任意ツール";
            localized["desktop.install_link.preference.summary"] = "このコピーで任意のキャラクター支援と物語ツールを表示するか選びます。後で設定から変更できます。";
            localized["desktop.install_link.preference.checkbox"] = "任意ツールを表示";
            localized["desktop.install_link.preference.visible_choice"] = "任意ツールを表示";
            localized["desktop.install_link.preference.hidden_choice"] = "Chummer を静かに保つ";
            localized["desktop.install_link.preference.on"] = "このインストールでは任意ツールが表示されます。";
            localized["desktop.install_link.preference.off"] = "このインストールでは任意ツールが非表示です。";
            localized["desktop.install_link.preference.tip"] = "任意の支援と物語の入口を隠します。キャラクター作成、ルール、更新、ダウンロードは利用できます。";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "任意ツールは表示されています。";
            localized["desktop.install_link.status.guided_tools_hidden"] = "任意ツールは非表示です。";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "Ferramentas opcionais";
            localized["desktop.install_link.preference.summary"] = "Escolha se esta instalacao mostra ajuda opcional de personagem e ferramentas de historia. Voce pode alterar depois em Configuracoes.";
            localized["desktop.install_link.preference.checkbox"] = "Mostrar ferramentas opcionais";
            localized["desktop.install_link.preference.visible_choice"] = "Mostrar ferramentas opcionais";
            localized["desktop.install_link.preference.hidden_choice"] = "Manter Chummer discreto";
            localized["desktop.install_link.preference.on"] = "Ferramentas opcionais estao visiveis nesta instalacao.";
            localized["desktop.install_link.preference.off"] = "Ferramentas opcionais estao ocultas nesta instalacao.";
            localized["desktop.install_link.preference.tip"] = "Oculta entradas opcionais de ajuda e historia. Criacao de personagem, regras, atualizacoes e downloads continuam disponiveis.";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "Ferramentas opcionais estao visiveis.";
            localized["desktop.install_link.status.guided_tools_hidden"] = "Ferramentas opcionais estao ocultas.";
        ...
        if (string.Equals(languageCode, "zh-cn", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.title"] = "可选工具";
            localized["desktop.install_link.preference.summary"] = "选择此副本是否显示可选的角色指导与故事工具。稍后可在设置中更改。";
            localized["desktop.install_link.preference.checkbox"] = "显示可选工具";
            localized["desktop.install_link.preference.visible_choice"] = "显示可选工具";
            localized["desktop.install_link.preference.hidden_choice"] = "保持 Chummer 安静";
            localized["desktop.install_link.preference.on"] = "此安装中可选工具可见。";
            localized["desktop.install_link.preference.off"] = "此安装中可选工具隐藏。";
            localized["desktop.install_link.preference.tip"] = "隐藏可选指导与故事入口。角色创建、规则、更新和下载仍可使用。";
            ...
            localized["desktop.install_link.status.guided_tools_visible"] = "可选工具已显示。";
            localized["desktop.install_link.status.guided_tools_hidden"] = "可选工具已隐藏。";
