...
public static class DesktopLocalizationCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultTrustSurfaceStrings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["desktop.campaign.intro.guest"] = "This campaign workspace is still using guest and local fallback posture. Claim this copy before you trust restore, device-role, or support closure as install-aware truth.",
        ...
        ["desktop.install_link.preference.hidden_choice"] = "Hide assisted features",
        ...
        ["desktop.home.intro.claim_failed_guest"] = "This desktop is still running as a guest because the last claim attempt failed. Claim this copy before you rely on install-aware support, fix notices, or roaming continuity.",
        ...
        ["desktop.devices.section.claims_description"] = "Online claim links and recent downloads.",
        ...
        ["desktop.devices.intro.pending"] = "A claim link is ready. Finish it online when you are ready.",
    ...
    private static IReadOnlyDictionary<string, string> BuildLocaleTrustSurfaceStrings(string languageCode)
    {
        ...
        if (string.Equals(languageCode, "de-de", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.hidden_choice"] = "Assistierte Funktionen ausblenden";
            ...
            localized["desktop.install_link.status.manual_login_url"] = "Der Browser-Claim wurde nicht automatisch geoffnet. Offnen oder kopieren Sie diesen Claim-Link, um diese Kopie zu beanspruchen:";
        ...
        if (string.Equals(languageCode, "fr-fr", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.hidden_choice"] = "Masquer les fonctions assistees";
            ...
            localized["desktop.devices.section.claims_description"] = "Online claim links and recent downloads.";
            ...
            localized["desktop.devices.intro.pending"] = "A claim link is ready. Finish it online when you are ready.";
        ...
        if (string.Equals(languageCode, "pt-br", StringComparison.Ordinal))
        {
            ...
            localized["desktop.install_link.preference.hidden_choice"] = "Ocultar recursos assistidos";
