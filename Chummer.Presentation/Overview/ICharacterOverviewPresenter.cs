...
public interface ICharacterOverviewPresenter
{
    ...
    Task ApplyCareerMugshotDeleteAsync(
    ...
    Task<CareerKarmaExpenseEditorState?> PrepareCareerKarmaExpenseEditAsync(CancellationToken ct)
        => Task.FromResult<CareerKarmaExpenseEditorState?>(null);

    Task ApplyCareerKarmaExpenseEditAsync(CareerKarmaExpenseEditRequest request, CancellationToken ct)
        => Task.CompletedTask;

    Task<CareerCalendarEditorState?> PrepareCareerCalendarEditAsync(CancellationToken ct)
        => Task.FromResult<CareerCalendarEditorState?>(null);

    Task ApplyCareerCalendarAddAsync(CareerCalendarAddRequest request, CancellationToken ct)
        => Task.CompletedTask;

    Task ApplyCareerCalendarEditAsync(CareerCalendarEditRequest request, CancellationToken ct)
        => Task.CompletedTask;
    ...
    Task<CharacterCareerSkillSpecializationQuote?> PrepareCareerSkillSpecializationQuoteAsync(
        CareerSkillSpecializationQuoteRequest request,
        CancellationToken ct)
        => Task.FromResult<CharacterCareerSkillSpecializationQuote?>(null);

    Task ApplyCareerSkillSpecializationAsync(CareerSkillSpecializationRequest request, CancellationToken ct)
        => Task.CompletedTask;
    ...
    Task ApplyVehicleActiveCommlinkEditAsync(VehicleActiveCommlinkEditRequest request, CancellationToken ct)
        => Task.CompletedTask;
