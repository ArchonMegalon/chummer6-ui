...
public sealed class DesktopAliceWindowTests
{
    ...
    public void DesktopAliceWindow_source_uses_build_handoffs_and_account_alice_routes()
    {
        ...
        StringAssert.Contains(source, "AliceOriginStorySteeringPanel");
        StringAssert.Contains(source, "Draft story");
        StringAssert.Contains(source, "Start with a story draft");
        StringAssert.Contains(source, "AliceOriginBuildFrameCombo");
        StringAssert.Contains(source, "AliceOriginPressureCombo");
        StringAssert.Contains(source, "AliceOriginBookSurfaceCombo");
        StringAssert.Contains(source, "AliceOriginPrimaryVoiceCombo");
        StringAssert.Contains(source, "AliceOriginAlternateVoiceCombo");
        StringAssert.Contains(source, "AliceOriginPortraitStyleCombo");
        StringAssert.Contains(source, "AliceOriginVideoStyleCombo");
        StringAssert.Contains(source, "AliceOriginGmConstraintList");
        ...
        StringAssert.Contains(source, "myfirstbook-origin-story.packet.json");
        StringAssert.Contains(source, "myfirstbook-origin-story.presentation.html");
        StringAssert.Contains(source, "Open story");
        StringAssert.Contains(source, "Race / metatype");
        StringAssert.Contains(source, "Open presentation");
        ...
        StringAssert.Contains(source, "Set up main voice");
        StringAssert.Contains(source, "Set up alternate voice");
        ...
        StringAssert.Contains(source, "MyFirstBook");
        StringAssert.Contains(source, "Creative Direction");
        StringAssert.Contains(source, "Primary voice");
        ...
        StringAssert.Contains(source, "TryGetMyFirstBookQuotaSnapshotAsync()");
        StringAssert.Contains(source, "ShouldAllowLivePremiumConsumption()");
        StringAssert.Contains(source, "ShouldAllowLiveMediaFactoryExecution()");
