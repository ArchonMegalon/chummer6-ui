...
public sealed class AccessibilitySignoffSmokeTests
{
    ...
    private static void DesktopExplainReceipts_and_diagnostics_diffs_are_visible_on_trust_surfaces()
    {
        ...
        RequireContains(resultPanelSource, "<details class=\"result-portability-details\" data-result-trust-receipt>");
        RequireContains(resultPanelSource, "<summary>Import details</summary>");
        RequireContains(resultPanelSource, "BuildImportWarning(portability.Receipt)");
        RequireContains(resultPanelSource, "<dt>Reference</dt>");
        RequireContains(resultPanelSource, "data-result-trust-receipt");
        RequireDoesNotContain(resultPanelSource, "Import environment before:");
        RequireDoesNotContain(resultPanelSource, "Import change summary:");
        RequireDoesNotContain(resultPanelSource, "Import change details:");
        RequireDoesNotContain(resultPanelSource, "Support details:");
        RequireDoesNotContain(resultPanelSource, "Import support reuse:");
        RequireDoesNotContain(resultPanelSource, "Import review");
        RequireDoesNotContain(resultPanelSource, "UI: @State.Preferences");
        RequireDoesNotContain(resultPanelSource, "Character: @State.Preferences");
