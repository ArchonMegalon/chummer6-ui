...
public class DesktopDialogFactoryTests
{
    ...
    public void CreateCommandDialog_master_index_surfaces_sourcebook_and_parity_posture()
    {
        ...
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "masterIndexSelectionTrail"), "Selected Result | Core Rulebook (CRB)");
        ...
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "masterIndexResultList"), "> Core Rulebook [CRB]");
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "masterIndexResultList"), "always on");
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "masterIndexSourceCommands"), "Open linked PDF");
        ...
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "masterIndexResultCommands"), "Jump to linked source page");
    ...
    public void CreateCommandDialog_character_roster_summarizes_open_workspaces()
    {
        ...
        Assert.AreEqual("0", DesktopDialogFieldValueParser.GetValue(dialog, "rosterWatchedCount"));
        ...
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "rosterTree"), "not configured");
        ...
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "rosterMugshot"), "legacy roster portrait slot");
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "rosterWatchFolderStatus"), "Watch Folder | not configured");
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "rosterWatchFolderStatus"), "Watcher | inactive");
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "rosterRunnerCommands"), "Open selected runner");
        StringAssert.Contains(DesktopDialogFieldValueParser.GetValue(dialog, "rosterWatchFolderCommands"), "Configure watch folder");
