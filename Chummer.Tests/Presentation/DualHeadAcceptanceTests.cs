...
public class DualHeadAcceptanceTests
{
    ...
    public async Task Avalonia_and_Blazor_translator_and_xml_editor_dialogs_preserve_matching_lane_posture()
    {
        ...
        CollectionAssert.Contains(avaloniaSnapshots["translator"].Fields, "translatorLanePosture=governed");
        CollectionAssert.Contains(avaloniaSnapshots["translator"].Fields, "translatorBridgePosture=governed");
        CollectionAssert.Contains(avaloniaSnapshots["xml_editor"].Fields, "xmlEditorXmlBridgePosture=governed");
        CollectionAssert.Contains(avaloniaSnapshots["hero_lab_importer"].Fields, "heroLabImportOracleReceipt=import oracle partial");
    }
