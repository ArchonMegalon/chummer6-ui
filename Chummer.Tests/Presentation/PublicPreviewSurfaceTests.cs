...
public sealed class PublicPreviewSurfaceTests
{
    ...
    public void Preview_renders_explicit_boundary_banner_around_desktop_shell()
    {
        ...
        StringAssert.Contains(cut.Markup, "href=\"/downloads/\"");
        StringAssert.Contains(cut.Markup, "href=\"/docs/\"");
        StringAssert.Contains(cut.Markup, "Open Build Lab proof");
        ...
        StringAssert.Contains(cut.Markup, "Open New Character proof");
        StringAssert.Contains(cut.Markup, "Open Character proof");
        StringAssert.Contains(cut.Markup, "Open for Printing proof");
        StringAssert.Contains(cut.Markup, "Open for Export proof");
        StringAssert.Contains(cut.Markup, "Open Print Result proof");
        StringAssert.Contains(cut.Markup, "Open Export Result proof");
        StringAssert.Contains(cut.Markup, "Open Save Result proof");
        StringAssert.Contains(cut.Markup, "Open Save As Result proof");
        StringAssert.Contains(cut.Markup, "Open Origin Dossier proof");
