...
public class MigrationComplianceTests
{
    ...
    public void Portal_playwright_e2e_uses_portal_stack_dependencies()
    {
        ...
        StringAssert.Contains(portalFixtureProbeText, "expectedImplicitOwner");
        StringAssert.Contains(portalFixtureProbeText, "Mode: implicit self-host sign-in");
        StringAssert.Contains(portalFixtureProbeText, "Current owner: <code>");
