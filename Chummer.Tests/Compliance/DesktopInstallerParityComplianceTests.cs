...
public sealed class DesktopInstallerParityComplianceTests
{
    ...
    public void Windows_desktop_installer_splash_uses_compact_non_clipping_layout()
    {
        ...
        StringAssert.Contains(installerProgramText, "ClientSize = new Size(900, 460),");
        StringAssert.Contains(installerProgramText, "MinimumSize = new Size(900, 460),");
        StringAssert.Contains(installerProgramText, "Height = 88,");
        StringAssert.Contains(installerProgramText, "Use only when support asks.");
        StringAssert.Contains(installerProgramText, "MinimumSize = new Size(172, 42),");
