...
public sealed class DesktopUpdateManifestParserTests
{
    ...
    [TestMethod]
    public void Parse_canonical_manifest_accepts_origin_root_relative_bootstrap_payload_url()
    {
        const string json = """
            {
              "channelId": "preview",
              ...
              "artifacts": [
                {
                  ...
                  "kind": "installer",
                  "fileName": "chummer-avalonia-win-x64-installer.exe",
                  "downloadUrl": "/downloads/g/test/files/chummer-avalonia-win-x64-installer.exe",
                  "sha256": "2f4ad755491b86e3a4ae0fb3251b0c863552ec4f0ae29049cedb7973bc372a4f",
                  "sizeBytes": 51856809,
                  "installerMode": "bootstrap",
                  "payloadFileName": "chummer-avalonia-win-x64-payload.zip",
                  "payloadDownloadUrl": "/downloads/g/test/files/chummer-avalonia-win-x64-payload.zip",
                  "payloadSha256": "00d34c7514b9e44bd315c3d9914547d0c750865ddf5bffaf3e17f861648fe4b7",
                  "payloadSizeBytes": 47152146
                }
              ]
        ...
        DesktopUpdateChannelManifest manifest = DesktopUpdateManifestParser.Parse(
            json,
            new Uri("https://chummer.run/downloads/g/test/RELEASE_CHANNEL.generated.json"));

        Assert.AreEqual(
            "/downloads/g/test/files/chummer-avalonia-win-x64-payload.zip",
            manifest.Artifacts[0].PayloadDownloadUrl);
    }
