...
This source-staged proof keeps accessibility posture visible on the promoted Blazor workbench route.
...
- an accessibility strip on the promoted workbench route
...
This is source alignment only. It proves that promoted workbench accessibility source, style, status reporting, and docs agree.
