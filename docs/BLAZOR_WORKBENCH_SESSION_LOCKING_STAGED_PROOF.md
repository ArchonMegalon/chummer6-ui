...
This staged proof keeps the Chummer Online and proof-compatible Blazor workbench source aligned around session-locking and edit-ownership posture for browser editing.
...
This is source-staged alignment only. It does not prove hosted browser execution, Docker self-host execution, lock acquisition, takeover mutation, cross-tab arbitration, stale lock cleanup, conflict persistence, or portal help runtime behavior.
