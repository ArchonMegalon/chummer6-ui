...
This is source alignment only. It proves that Chummer Online and proof-compatible workbench context-actions source, style, status reporting, and docs agree.
