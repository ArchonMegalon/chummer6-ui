...
- a hosted security/access strip on the user-facing Chummer Online route and /blazor/workbench compatibility route
...
This is source alignment only. It proves that Chummer Online and /blazor/workbench compatibility route security-access source, style, status reporting, and docs agree.
