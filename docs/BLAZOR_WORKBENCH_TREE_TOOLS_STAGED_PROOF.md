...
This source-staged proof keeps dense tree and list affordances visible on the user-facing Chummer Online route and proof-compatible Blazor workbench route.
...
- a tree/list tools strip on the user-facing Chummer Online route and proof-compatible workbench route
