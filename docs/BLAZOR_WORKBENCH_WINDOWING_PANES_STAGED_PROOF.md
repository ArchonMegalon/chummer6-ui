...
Chummer Online should expose split view, pop-out detail panes, pinned inspectors, focus mode, second-screen table views, layout restore, and same-origin help posture near dense dossier workflows.

## Source-Staged Scope

The staged windowing-panes lane covers:

- a windowing/pane management strip on the user-facing Chummer Online route and /blazor/workbench compatibility route
...
This is source alignment only. It proves that Chummer Online and /blazor/workbench compatibility route windowing-panes source, style, status reporting, and docs agree.
