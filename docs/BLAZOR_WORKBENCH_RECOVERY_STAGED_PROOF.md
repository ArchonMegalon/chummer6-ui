...
This source-staged proof keeps the Chummer App and proof-compatible Blazor workbench recovery posture tied to the browser-client parity goal.
...
- a Session recovery strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench recovery source, style, status reporting, and docs agree.
