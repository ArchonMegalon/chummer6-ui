## SR6 Ruleset UI Sophistication Exit Tests

This gate exists to stop SR6 from shipping as a thinner, weaker, or more generic shell lane than SR5.

The rule is simple:

- SR6 does not get a weaker parity dimension than SR5.
- SR6 does not get a summary-only substitute where SR5 has a real authored surface.
- SR6 does not get a thin shared-shell fallback while SR5 keeps editor-grade headings, commands, dialogs, workflow surfaces, and runtime-backed interaction.
...
- SR6 keeps runtime-backed commands, dialogs, menus, tooltips, and secondary routes rather than zero-host placeholders
- SR6 keeps equal UI sophistication against SR5 for shell richness, command richness, workflow richness, and branch richness
...
- equal UI sophistication against SR5 is not proven
