# Blazor Workbench Help/Recovery Guidance Staged Proof

## Purpose

This staged proof keeps Chummer Online and /blazor/workbench sources aligned around contextual help and guided recovery posture for browser workflows.
...
```bash
bash scripts/ai/milestones/blazor-workbench-help-recovery-guidance-staged-proof-check.sh
```

The command writes:

```text
.codex-studio/published/BLAZOR_WORKBENCH_HELP_RECOVERY_GUIDANCE_STAGED_PROOF.generated.json
```
