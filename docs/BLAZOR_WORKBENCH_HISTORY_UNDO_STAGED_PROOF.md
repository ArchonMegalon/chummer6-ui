...
This source-staged proof keeps history, undo, and recovery affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a history/recovery strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench history-undo source, style, status reporting, and docs agree.
