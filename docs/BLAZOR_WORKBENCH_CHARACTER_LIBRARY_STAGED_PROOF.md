...
This source-staged proof keeps character library and recent-file management affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a character library strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench character-library source, style, status reporting, and docs agree.
