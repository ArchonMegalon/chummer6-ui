...
- `scripts/materialize-blazor-pwa-public-edge-proof.py`: live public-edge materializer for the clean `/app` entry plus hosted `/blazor` installable PWA shell, static-cache privacy boundary, offline copy, app-head service-worker registration, static deployed assets, and mobile viewport posture
