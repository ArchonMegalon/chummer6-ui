...
This source-staged proof keeps browser-to-desktop continuity visible on the user-facing Chummer Online route and proof-compatible Blazor workbench route.
...
- a desktop install strip on the user-facing Chummer Online route and proof-compatible workbench route
