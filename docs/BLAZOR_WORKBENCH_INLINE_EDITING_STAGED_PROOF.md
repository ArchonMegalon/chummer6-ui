...
- an inline-editing strip on the user-facing Chummer Online route and /blazor/workbench compatibility route
...
This is source alignment only. It proves that Chummer Online and /blazor/workbench compatibility route inline-editing source, style, status reporting, and docs agree.
