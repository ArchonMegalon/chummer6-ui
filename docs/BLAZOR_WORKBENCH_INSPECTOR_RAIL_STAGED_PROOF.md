...
This source-staged proof keeps side-context affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- an inspector rail on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench inspector-rail source, style, status reporting, and docs agree.
