...
This source-staged proof keeps runner and task tabs visible on the promoted Blazor workbench route.
...
- a workspace tab strip on the promoted workbench route
...
This is source alignment only. It proves that promoted workbench workspace-tabs source, style, status reporting, and docs agree.
