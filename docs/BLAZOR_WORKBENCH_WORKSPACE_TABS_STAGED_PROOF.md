...
This source-staged proof keeps runner and task tabs visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a workspace tab strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench workspace-tabs source, style, status reporting, and docs agree.
