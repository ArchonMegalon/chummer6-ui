...
This is source alignment only. It proves that Chummer Online and /blazor/workbench compatibility route workspace-tabs source, style, status reporting, and docs agree.
