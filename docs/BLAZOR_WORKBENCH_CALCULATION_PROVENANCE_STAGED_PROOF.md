...
This source-staged proof keeps derived-stat and modifier provenance affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a calculation provenance strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench calculation-provenance source, style, status reporting, and docs agree.
