...
This is source alignment only. It proves that Chummer Online and proof-compatible workbench calculation-provenance source, style, status reporting, and docs agree.
