...
This source-staged proof keeps touch and mobile ergonomics affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a touch/mobile ergonomics strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench touch-mobile source, style, status reporting, and docs agree.
