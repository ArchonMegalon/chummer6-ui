...
This source-staged proof keeps web app install and update affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a PWA install/update strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench PWA-install source, style, status reporting, and docs agree.
