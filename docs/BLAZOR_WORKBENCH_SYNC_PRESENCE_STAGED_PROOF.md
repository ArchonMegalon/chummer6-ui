...
This source-staged proof keeps hosted and self-hosted session-state affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a hosted/self-hosted session strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench sync-presence source, style, status reporting, and docs agree.
