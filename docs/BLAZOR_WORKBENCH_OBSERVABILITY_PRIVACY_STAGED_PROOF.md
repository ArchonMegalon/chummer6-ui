...
This is source alignment only. It proves that Chummer Online and proof-compatible workbench observability-privacy source, style, status reporting, and docs agree.
