...
- staged hosted workbench character-roster posture for open, recent, pin, clone, archive, import, and help actions, keeping desktop-like character roster management visible on public Chummer Online and /blazor/workbench compatibility routes while not yet claiming file-open, roster persistence, clone, archive, import, or portal help runtime parity
