...
- staged hosted workbench section-rail posture for profile, build, skills, gear, combat, magic, matrix, contacts, and career shortcuts, keeping sheet-scale navigation visible on public Chummer Online and /blazor/workbench compatibility routes while not yet claiming section rendering or browser execution parity
