...
- dense runner dossier navigation covers the same core sections and quick actions as Avalonia
...
- staged hosted workbench workspace-tabs posture for active dossier, Build Lab, print/export, and recent import lanes, keeping dossier task tabs visible on public Chummer Online and /blazor/workbench compatibility routes while not yet claiming multi-document state or tab persistence parity
