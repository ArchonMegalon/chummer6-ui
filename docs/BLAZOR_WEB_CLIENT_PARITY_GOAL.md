...
- staged hosted workbench polish posture for the Desktop-style task dock, keeping start, edit, output, and portal handoff shortcuts visible on the promoted browser route without yet claiming screenshot, accessibility, or runtime workflow parity
