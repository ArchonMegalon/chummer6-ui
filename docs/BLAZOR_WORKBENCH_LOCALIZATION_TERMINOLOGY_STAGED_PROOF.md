# Blazor Workbench Localization/Terminology Staged Proof

## Purpose

This staged proof keeps the Chummer Online and proof-compatible Blazor workbench source aligned around localization and table terminology posture for hosted and self-hosted browser use.
...
```bash
bash scripts/ai/milestones/blazor-workbench-localization-terminology-staged-proof-check.sh
```

The command writes:

```text
.codex-studio/published/BLAZOR_WORKBENCH_LOCALIZATION_TERMINOLOGY_STAGED_PROOF.generated.json
```
