...
This is source alignment only. It proves that Chummer Online and proof-compatible workbench diagnostics source, style, status reporting, shared dialog source, and docs agree.
