...
This source-staged proof keeps browser file-intake posture visible on the user-facing Chummer Online route and /blazor/workbench compatibility route.
...
- a file-intake strip on the user-facing Chummer Online route and /blazor/workbench compatibility route
...
This is source alignment only. It proves that Chummer Online and /blazor/workbench compatibility route file-intake source, style, status reporting, shared dialog source, and docs agree.
