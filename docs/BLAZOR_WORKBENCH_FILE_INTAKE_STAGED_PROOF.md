...
This source-staged proof keeps browser file-intake posture visible on the promoted Blazor workbench route.
...
- a file-intake strip on the promoted workbench route
...
This is source alignment only. It proves that promoted workbench file-intake source, style, status reporting, shared dialog source, and docs agree.
