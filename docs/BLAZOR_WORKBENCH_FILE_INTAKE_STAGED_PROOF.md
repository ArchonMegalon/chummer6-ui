...
This source-staged proof keeps browser file-intake posture visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a file-intake strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench file-intake source, style, status reporting, shared dialog source, and docs agree.
