...
This source-staged proof keeps table handoff affordances visible on the user-facing Chummer App route and proof-compatible Blazor workbench route.
...
- a table strip on the user-facing Chummer App route and proof-compatible workbench route
...
This is source alignment only. It proves that Chummer App and proof-compatible workbench table-handoff source, style, status reporting, and docs agree.
