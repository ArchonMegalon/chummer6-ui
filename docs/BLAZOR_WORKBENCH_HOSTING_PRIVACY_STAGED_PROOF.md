...
This is source alignment only. It proves that Chummer Online and /blazor/workbench compatibility route hosting/privacy source, style, status reporting, and docs agree, including the default-off Rybbit boundary for self-hosted deployments.
