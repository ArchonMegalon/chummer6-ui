...
CHECKS = [
    {
        ...
        "tokens": [
            "Browser-client Docker self-host operator lane",
            "data-workbench-docker-operator=\"strip\"",
            "Keep Docker operations visible.",
            "private const string DockerContainerHealthCommand = \"docker_container_health\"",
            "private const string DockerEnvCheckCommand = \"docker_env_check\"",
            "private const string DockerVolumeMountsCommand = \"docker_volume_mounts\"",
            "private const string DockerBackupCommand = \"docker_backup\"",
            "private const string DockerImageUpdateCommand = \"docker_image_update\"",
            "private const string DockerSupportBundleCommand = \"docker_support_bundle\"",
            "command: DockerContainerHealthCommand",
            "command: DockerEnvCheckCommand",
            "command: DockerVolumeMountsCommand",
            "command: DockerBackupCommand",
            "command: DockerImageUpdateCommand",
            "command: DockerSupportBundleCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route Docker-operator source, style, status, and docs agree.",
