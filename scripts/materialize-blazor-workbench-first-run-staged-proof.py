...
CHECKS = [
    {
        ...
        "tokens": [
            "Workbench first-run onboarding lane",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and proof-compatible workbench first-run source, style, status, and docs agree.",
