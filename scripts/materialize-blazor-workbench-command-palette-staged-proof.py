...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "<kbd>Ctrl</kbd><kbd>S</kbd><span>Save Dossier</span>",
            "aria-keyshortcuts=\"Control+P\"",
            "<kbd>Ctrl</kbd><kbd>P</kbd><span>Print Dossier</span>",
    ...
    },
    {
        ...
        "tokens": [
            ...
            "reload-safe Chummer Online links",
            "same-origin help",
        ],
    },
    {
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route command-palette source, style, status, and docs agree, including the same-origin /help command.",
