...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "href=\"@ReleaseChannelManifestHref\"",
            "private const string ReleaseChannelManifestHref = \"/downloads/RELEASE_CHANNEL.generated.json\"",
    ...
    },
    {
        ...
        "tokens": [
            "source-staged Chummer Online and /blazor/workbench compatibility route desktop install handoff contract",
            "native desktop installer progress chrome",
            "amber accent bar, deep slate shell, mint progress fill, warm ink metadata, and amber hint text",
            "native installer high-contrast system-color fallback",
        ],
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route desktop install handoff source, style, status, and docs agree.",
