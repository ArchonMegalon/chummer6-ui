...
CHECKS = [
    ...
    },
    {
        ...
        "tokens": [
            ...
            "Self-host browser analytics is metadata-only and allows boolean presence fields such as has_workspace and has_dossier while excluding workspace ids, dossier ids, XML, payloads, hashes, and generated dossier text.",
        ],
    },
]
