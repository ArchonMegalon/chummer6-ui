...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "publicInstallerRedirectMatches(response, 'avalonia-linux-x64-installer')",
            "publicInstallerRedirectMatches(response, 'avalonia-win-x64-installer')",
            ...
            "payload?.paths?.['/blazor/app']",
            "payload?.paths?.['/blazor/home']",
            "payload?.paths?.['/blazor/']",
    ...
    },
    {
        ...
        "tokens": [
            ...
            'data-portal-status-action="open-discord"',
            ...
            'data-download-action="open-status"',
            'data-download-action="open-help"',
            ...
            'data-portal-contact-context=',
            'data-portal-contact-public-route=',
            'data-portal-contact-action="open-discord"',
    ...
    {
        "id": "portal_release_manifest_reader",
        "path": "Chummer.Portal/PortalReleaseManifestReader.cs",
        "tokens": [
            "PortalReleaseManifestReader",
    ...
    },
    {
        ...
        "tokens": [
            ...
            "local download",
            'aria-label="{WebUtility.HtmlEncode($"{download.Label} for {download.Platform} {modeLabel}")}"',
    ...
    },
    {
        ...
        "tokens": EXPECTED_ROUTES + [
            ...
            "`/blazor/` resolves into Chummer Online and immediately opens the Character Roster workflow via `app?command=character_roster`",
            'aria-label="Chummer Online routes"',
            "reduced-motion guard",
            "`data-self-host-downloads-panel=\"docker-operator\"`",
            "`docker compose --profile portal up -d`",
            "tells operators to mount `releases.json` and the sibling `RELEASE_CHANNEL.generated.json` into the downloads volume before claiming installer availability.",
            ...
            "operator shortcut opens the roster-start `/app?command=character_roster`",
            ...
            'aria-label="Contact recovery actions"',
            'aria-label="Status recovery actions"',
            "`Open Character Roster`, `Open Chummer Online`, `Open Chummer Online overview`, and `Get desktop client` choices",
            'a.cta[href="/app?command=character_roster"][data-portal-home-action="explore-chummer-online"]',
    ...
    },
    {
        ...
        "tokens": [
            ...
            "Character Roster primary CTA selector",
            "hosted `/blazor/` root redirect that immediately opens the Character Roster workflow via `app?command=character_roster`",
            'a.cta[href="/app?command=character_roster"][data-portal-home-action="explore-chummer-online"]',
            ...
            "data-docs-panel=\"operator-openapi-explorer\"",
            "data-docs-action=\"open-chummer-app\"",
            "roster-start `/app?command=character_roster`",
            "Chummer Online routes",
            "same polished Chummer Online slate/amber/mint/blue visual language",
            "restrained ambient glow",
            "deep ink/surface contrast",
