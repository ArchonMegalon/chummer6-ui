...
CHECKS = [
    ...
    },
    {
        ...
        "tokens": [
            ...
            "data-self-host-release-manifest",
            "data-self-host-browser-app",
            "Use /blazor/app when installer proof is pending.",
            'data-self-host-installer-boundary="proof-required"',
    ...
    },
    {
        ...
        "tokens": [
            ...
            'a.cta[href="/app?command=character_roster"][data-portal-home-action="explore-chummer-online"]',
            "portal route values centralized through `PortalRoutes.PublicApp`, `PortalRoutes.PublicAppSlash`, `PortalRoutes.PublicAppRoster`, `PortalRoutes.CharacterRosterCommand`, `PortalRoutes.BlazorApp`, `PortalRoutes.BlazorAppSegment`, and `BuildBlazorAppUrl`",
    ...
    },
    {
        ...
        "tokens": [
            ...
            "not members of the Chummer Online and proof-compatible workbench source-staged proof set",
    ...
    },
    {
        ...
        "tokens": [
            ...
            "must not be treated as a workbench-family receipt or runtime installer proof",
        ],
    },
    {
