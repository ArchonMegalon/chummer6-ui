...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "private const string HeroLabImporterCommand = \"hero_lab_importer\"",
            "command: HeroLabImporterCommand",
            "data-workbench-file-intake-action=\"desktop-handoff\"",
            "data-workbench-file-intake-action=\"support\"",
            "Open or import a dossier.",
            "Review dossier XML in the browser",
            "Paste or stage Chummer dossier XML.",
            "Bring in a Hero Lab dossier.",
            "Inspect dossier bridges and custom data.",
            "Get help with dossier files or installs.",
            "Desktop",
        ],
    },
    {
    ...
    {
        "id": "blazor_import_panel_dossier_review_copy",
        "path": "Chummer.Blazor/Components/Shell/ImportPanel.razor",
        "tokens": [
            "Dossier file:",
    ...
    {
        "id": "ruleset_import_dossier_copy",
        "path": "Chummer.Presentation/Rulesets/RulesetUiDirectiveCatalog.cs",
        "tokens": [
            "Import SR5 Dossier File",
            "(no SR5 dossier file selected)",
            "SR5 Dossier XML Review",
            "Import SR5 Dossier XML",
            "Import Dossier File",
            "(no dossier file selected)",
            "Raw Dossier XML Review",
            "Import Dossier XML",
        ],
    },
    {
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route file-intake source, style, status, and docs agree.",
