...
def main() -> int:
    ...
    receipt = {
        ...
        "expected_routes": ["/blazor/workbench", "/play", "/session/", "/coach/", "/status"],
        "checks": checks,
        "failures": failures,
        "notes": [
            "This receipt only proves that promoted workbench connected-runtime source, style, status, and docs agree.",
