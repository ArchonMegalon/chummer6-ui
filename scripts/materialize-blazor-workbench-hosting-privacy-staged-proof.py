...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route hosting/privacy source, style, status, and docs agree, including the self-host default-off Rybbit boundary.",
