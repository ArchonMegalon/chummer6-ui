...
CHECKS = [
    ...
    },
    {
        ...
        "tokens": [
            ...
            "startup command links for new/import/origin flows derive from local command constants",
    ...
    },
    {
        ...
        "tokens": [
            ...
            "startup command links for new/import/origin flows derived from local command constants",
