...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "Open browser-safe dossier save/download handoff.",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route status-bar source, style, status, and docs agree.",
