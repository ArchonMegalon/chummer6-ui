...
CHECKS = [
    {
        ...
        "tokens": [
            "Workbench history and undo lane",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and proof-compatible workbench history-undo source, style, status, and docs agree.",
