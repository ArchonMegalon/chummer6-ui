...
REQUIRED_DOC_TOKENS = {
    ...
    "docs/BLAZOR_WEB_CLIENT_PARITY_GOAL.md": [
        ...
        "`/app` remains the clean public Chummer App route, `/blazor/app` remains the hosted app path, and `/blazor/workbench` remains the proof-compatible execution lane",
    ],
    "docs/MIGRATION_BACKLOG.md": [
        ...
        "`/app` kept as the clean public Chummer App route, `/blazor/app` kept as the hosted app path, and `/blazor/workbench` kept as the proof-compatible execution lane",
    ],
    "docs/WORKBENCH_RELEASE_SIGNOFF.md": [
        ...
        "route-entry posture for clean public `/app`, `/blazor/`, hosted `/blazor/app`, and `/blazor/workbench`",
        "canonical `https://chummer.run/blazor/workbench` proof base",
        "public product navigation remains `https://chummer.run/app`",
        "`/app` remains the clean public Chummer App route",
    ...
    "docs/BLAZOR_WEB_CLIENT_DOCS_INDEX.md": [
        ...
        "`/app`: clean public Chummer App route",
        "`/blazor/app`: hosted Blazor app path",
        "`/blazor/workbench`: explicit proof-compatible compatibility route",
        "docs/WORKBENCH_RELEASE_SIGNOFF.md#extended-goal-release-blockers",
...
def main() -> int:
    ...
    payload = {
        ...
        "notes": [
            ...
            "Hosted route-entry refresh expects public_blazor_home_roster_entry so /blazor/home proves the roster-first home route pill.",
