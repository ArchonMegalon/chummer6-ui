...
CHECKS = [
    {
        ...
        "tokens": [
            "Browser-client help and recovery guidance posture",
            ...
            "private const string HelpContextCommand = \"help_context\"",
            "private const string HelpShortcutsCommand = \"help_shortcuts\"",
            "private const string HelpErrorsCommand = \"help_errors\"",
            "private const string HelpRecoveryCommand = \"help_recovery\"",
            "command: HelpContextCommand",
            "command: HelpShortcutsCommand",
            "command: HelpErrorsCommand",
            "command: HelpRecoveryCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route help and recovery source, style, status, and docs agree, including the same-origin /help handoff action.",
