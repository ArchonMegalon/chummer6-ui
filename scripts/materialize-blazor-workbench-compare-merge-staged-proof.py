...
CHECKS = [
    {
        ...
        "tokens": [
            "Workbench compare and merge posture",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and proof-compatible workbench compare/merge source, style, status, and docs agree.",
