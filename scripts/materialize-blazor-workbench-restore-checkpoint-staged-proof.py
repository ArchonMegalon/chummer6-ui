...
CHECKS = [
    {
        ...
        "tokens": [
            "Browser-client restore and checkpoint posture",
            ...
            "private const string CheckpointAutosaveCommand = \"checkpoint_autosave\"",
            "private const string CheckpointNamedCommand = \"checkpoint_named\"",
            "private const string CheckpointBackupCommand = \"checkpoint_backup\"",
            "private const string CheckpointRestorePreviewCommand = \"checkpoint_restore_preview\"",
            "private const string CheckpointRollbackCommand = \"checkpoint_rollback\"",
            "private const string CheckpointRetentionCommand = \"checkpoint_retention\"",
            "command: CheckpointAutosaveCommand",
            "command: CheckpointNamedCommand",
            "command: CheckpointBackupCommand",
            "command: CheckpointRestorePreviewCommand",
            "command: CheckpointRollbackCommand",
            "command: CheckpointRetentionCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route restore/checkpoint source, style, status, and docs agree.",
