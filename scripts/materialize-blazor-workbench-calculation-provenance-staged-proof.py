...
CHECKS = [
    {
        ...
        "tokens": [
            "Browser-client calculation provenance lane",
            ...
            "private const string DerivedBreakdownCommand = \"derived_breakdown\"",
            "private const string ModifierStackCommand = \"modifier_stack\"",
            "private const string RuleSourceCommand = \"rule_source\"",
            "private const string StaleValuesCommand = \"stale_values\"",
            "private const string ManualOverrideCommand = \"manual_override\"",
            "private const string DependencyPathCommand = \"dependency_path\"",
            "command: DerivedBreakdownCommand",
            "command: ModifierStackCommand",
            "command: RuleSourceCommand",
            "command: StaleValuesCommand",
            "command: ManualOverrideCommand",
            "command: DependencyPathCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route calculation-provenance source, style, status, and docs agree.",
