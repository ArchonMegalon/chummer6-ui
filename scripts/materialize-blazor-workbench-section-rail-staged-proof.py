...
CHECKS = [
    {
        ...
        "path": "Chummer.Blazor/Components/Pages/Preview.razor",
            "tokens": [
                "Browser-client dossier section rail",
                "data-workbench-section-rail=\"strip\"",
                "Move straight to a section.",
                'private const string ProfileTabId = "tab-info"',
                'private const string CareerTabId = "tab-calendar"',
                "BuildWorkbenchLaneHref(ProfileTabId)",
                "BuildWorkbenchLaneHref(CareerTabId)",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route section-rail source, style, status, and docs agree.",
