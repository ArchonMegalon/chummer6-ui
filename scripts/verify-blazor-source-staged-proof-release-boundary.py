...
REQUIRED_SEPARATION_DOC_TOKENS = {
    ...
    "docs/BLAZOR_RUNTIME_PROOF_REFRESH_PLAN.md": [
        ...
        "MIG-106` through `MIG-109",
        "refreshed hosted route-entry, hosted execution, Docker self-host, analytics posture, connected-runtime, source-boundary, and aggregate browser-lane receipts prove the browser-client release claim",
