...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "private const string LazySectionsCommand = \"lazy_sections\"",
            "private const string VirtualListsCommand = \"virtual_lists\"",
            "private const string RenderBudgetCommand = \"render_budget\"",
            "private const string MemoryPostureCommand = \"memory_posture\"",
            "private const string DegradedModeCommand = \"degraded_mode\"",
            "private const string RenderProfilerCommand = \"render_profiler\"",
            "command: LazySectionsCommand",
            "command: VirtualListsCommand",
            "command: RenderBudgetCommand",
            "command: MemoryPostureCommand",
            "command: DegradedModeCommand",
            "command: RenderProfilerCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route performance-virtualization source, style, status, and docs agree.",
