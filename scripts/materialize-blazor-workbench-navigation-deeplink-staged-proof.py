...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "private const string OpenBreadcrumbsCommand = \"open_breadcrumbs\"",
            "private const string SyncUrlStateCommand = \"sync_url_state\"",
            "private const string BrowserHistoryCommand = \"browser_history\"",
            "private const string CopyRouteLinkCommand = \"copy_route_link\"",
            "private const string RestoreRouteTabsCommand = \"restore_route_tabs\"",
            "private const string OpenSharedAnchorCommand = \"open_shared_anchor\"",
            "command: OpenBreadcrumbsCommand",
            "command: SyncUrlStateCommand",
            "command: BrowserHistoryCommand",
            "command: CopyRouteLinkCommand",
            "command: RestoreRouteTabsCommand",
            "command: OpenSharedAnchorCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route navigation-deeplink source, style, status, and docs agree.",
