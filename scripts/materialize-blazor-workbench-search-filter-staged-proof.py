...
OUTPUT_PATH = Path(
    os.environ.get(
        "CHUMMER_BLAZOR_WORKBENCH_SEARCH_FILTER_STAGED_PROOF_PATH",
        REPO_ROOT / ".codex-studio" / "published" / "BLAZOR_WORKBENCH_SEARCH_FILTER_STAGED_PROOF.generated.json",
    )
)
...
CHECKS = [
    ...
    {
        "id": "scoped_search_filter_visual_design",
        "path": "Chummer.Blazor/Components/Pages/Preview.razor.css",
        "tokens": [
            ".browser-workbench-search-filter",
            ".browser-workbench-search-filter-copy",
            ".browser-workbench-search-filter-actions",
    ...
    },
    {
        ...
        "tokens": [
            "workbench search/filter posture",
            "blazor-workbench-search-filter-staged-proof-check.sh",
    ...
    },
    {
        ...
        "tokens": [
            "WORKBENCH_SEARCH_FILTER_STAGED_PROOF",
            "workbench_search_filter_staged_status",
            "workbench_search_filter_staged_source_checks",
...
def main() -> int:
    ...
    print(f"blazor_workbench_search_filter_staged_proof:ok {OUTPUT_PATH}")
    return 0
