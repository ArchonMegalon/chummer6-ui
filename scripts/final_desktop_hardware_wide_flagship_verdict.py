...
def main() -> int:
    ...
    lines.extend(
        [
            ...
            "",
            "- Mixed-DPI and multi-monitor hardware-lab equivalence are not separately certified yet, and are excluded from this scoped Windows/Linux public-release verdict.",
            "",
            "## Not allowed yet",
            "",
