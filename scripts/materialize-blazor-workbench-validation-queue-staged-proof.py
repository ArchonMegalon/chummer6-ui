...
CHECKS = [
    {
        ...
        "tokens": [
            "Workbench validation and build readiness",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and proof-compatible workbench validation-queue source, style, status, and docs agree.",
