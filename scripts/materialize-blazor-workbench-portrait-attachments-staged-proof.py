...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "private const string SetCharacterPortraitCommand = \"set_character_portrait\"",
            "private const string SetTokenArtCommand = \"set_token_art\"",
            "private const string OpenCharacterNotesCommand = \"open_character_notes\"",
            "private const string OpenAttachmentsCommand = \"open_attachments\"",
            "private const string ImportMediaCommand = \"import_media\"",
            "private const string CleanupMediaCommand = \"cleanup_media\"",
            "command: SetCharacterPortraitCommand",
            "command: SetTokenArtCommand",
            "command: OpenCharacterNotesCommand",
            "command: OpenAttachmentsCommand",
            "command: ImportMediaCommand",
            "command: CleanupMediaCommand",
            "data-workbench-portrait-attachments-action=\"help\"",
            "href=\"@HelpHref\"",
    ...
    },
    {
        ...
        "tokens": [
            ...
            "portrait, token art, notes, attachments, import media, cleanup, and help",
            "not yet claiming file upload, storage persistence, thumbnail generation, attachment cleanup, or portal help runtime parity",
        ],
    },
    {
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route portrait-attachments source, style, status, and docs agree.",
            "It is not a substitute for hosted Playwright execution proof, Docker self-host proof, file-upload proof, storage-persistence proof, thumbnail-generation proof, attachment-cleanup proof, or portal help runtime proof.",
            "Do not use this receipt to claim file upload, storage persistence, thumbnail generation, attachment cleanup, portal help runtime, or browser execution parity.",
        ],
    }
