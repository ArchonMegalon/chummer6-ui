...
CHECKS = [
    {
        ...
        "tokens": [
            "Browser-client inline editing lane",
            ...
            "private const string OpenDirtyFieldsCommand = \"open_dirty_fields\"",
            "private const string NumericSteppersCommand = \"numeric_steppers\"",
            "private const string CommitEditsCommand = \"commit_edits\"",
            "private const string RevertEditsCommand = \"revert_edits\"",
            "private const string PreviewFormulaCommand = \"preview_formula\"",
            "private const string BulkApplyCommand = \"bulk_apply\"",
            "command: OpenDirtyFieldsCommand",
            "command: NumericSteppersCommand",
            "command: CommitEditsCommand",
            "command: RevertEditsCommand",
            "command: PreviewFormulaCommand",
            "command: BulkApplyCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route inline-editing source, style, status, and docs agree.",
