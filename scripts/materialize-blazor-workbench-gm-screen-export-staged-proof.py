...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "private const string GmScreenCardsCommand = \"gm_screen_cards\"",
            "private const string GmPlayerSafeViewCommand = \"gm_player_safe_view\"",
            "private const string GmInitiativePanelCommand = \"gm_initiative_panel\"",
            "private const string GmConditionRailCommand = \"gm_condition_rail\"",
            "private const string GmSceneNotesCommand = \"gm_scene_notes\"",
            "private const string GmExportBundleCommand = \"gm_export_bundle\"",
            "command: GmScreenCardsCommand",
            "command: GmPlayerSafeViewCommand",
            "command: GmInitiativePanelCommand",
            "command: GmConditionRailCommand",
            "command: GmSceneNotesCommand",
            "command: GmExportBundleCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route GM-screen export source, style, status, and docs agree.",
