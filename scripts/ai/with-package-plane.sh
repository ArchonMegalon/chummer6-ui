...
contracts_version="${configured_contracts_version:-0.0.0-packageplane.candidate.v20260926.1.shc27201749190d}"
...
core_runtime_version="${CHUMMER_CORE_RUNTIME_PACKAGE_VERSION:-0.0.0-packageplane.candidate.v20260926.1.shc27201749190d}"
