...
contracts_version="${configured_contracts_version:-0.0.0-packageplane.candidate.v20260925.5.sh35f488463e0a3}"
campaign_contracts_version="${CHUMMER_CAMPAIGN_CONTRACTS_PACKAGE_VERSION:-0.1.0-preview}"
run_contracts_version="${configured_run_contracts_version:-0.1.1-packageplane.20260924.3}"
hub_registry_contracts_version="${configured_hub_registry_contracts_version:-0.1.1-packageplane.20260924.3}"
ui_kit_version="${CHUMMER_UI_KIT_PACKAGE_VERSION:-0.1.0-preview}"
core_runtime_version="${CHUMMER_CORE_RUNTIME_PACKAGE_VERSION:-0.0.0-packageplane.candidate.v20260925.5.sh35f488463e0a3}"
