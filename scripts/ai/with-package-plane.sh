...
contracts_version="${configured_contracts_version:-0.0.0-packageplane.candidate.v20260925.3.shf3ca90e11c838}"
...
core_runtime_version="${CHUMMER_CORE_RUNTIME_PACKAGE_VERSION:-0.0.0-packageplane.candidate.v20260925.3.shf3ca90e11c838}"
