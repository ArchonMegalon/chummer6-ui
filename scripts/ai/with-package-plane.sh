...
contracts_version="${configured_contracts_version:-0.0.0-packageplane.candidate.shf7500ef8c2f59}"
campaign_contracts_version="${CHUMMER_CAMPAIGN_CONTRACTS_PACKAGE_VERSION:-0.1.0-preview}"
run_contracts_version="${configured_run_contracts_version:-0.1.0-packageplane.candidate.shfe4b2706c44d}"
hub_registry_contracts_version="${configured_hub_registry_contracts_version:-0.1.0-packageplane.candidate.shfe4b2706c44d}"
ui_kit_version="${CHUMMER_UI_KIT_PACKAGE_VERSION:-0.1.0-preview}"
core_runtime_version="${CHUMMER_CORE_RUNTIME_PACKAGE_VERSION:-0.0.0-packageplane.candidate.shf7500ef8c2f59}"
