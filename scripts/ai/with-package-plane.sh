...
contracts_version="${configured_contracts_version:-0.0.0-packageplane.candidate.shd9051e0d214a5}"
...
core_runtime_version="${CHUMMER_CORE_RUNTIME_PACKAGE_VERSION:-0.0.0-packageplane.candidate.shd9051e0d214a5}"
