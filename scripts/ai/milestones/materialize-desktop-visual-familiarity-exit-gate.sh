...
required_test_names = [
    ...
    "Runtime_backed_mouse_only_first_minute_controls_stay_inside_flagship_viewport_without_scroll_dependency",
    "Runtime_backed_mouse_only_loaded_runner_controls_stay_inside_flagship_viewport_without_scroll_dependency",
