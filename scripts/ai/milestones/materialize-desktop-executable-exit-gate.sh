...
def validate_linux_gate(
    ...
    gate_release_version_alias_conflict = (
        bool(gate_release_version_primary)
        and bool(gate_release_version_alias)
        and gate_release_version_primary != gate_release_version_alias
    )
    ...
    gate_release_version = str(
        ...
        or gate_release_version_primary
        or gate_release_version_alias
        or ""
    ).strip()
    ...
    gate_evidence["primary_receipt_timestamp_alias_conflict"] = startup_smoke_timestamp_alias_conflicts(
        primary_receipt_for_validation
    )
...
def validate_windows_gate(
    ...
    if not startup_smoke_receipt_exists:
        ...
        startup_smoke_timestamp_alias_conflict = startup_smoke_timestamp_alias_conflicts(
            startup_smoke_receipt_payload
        )
...
def validate_macos_gate(
    ...
    gate_evidence["startup_smoke_receipt_timestamp_alias_conflict"] = startup_smoke_timestamp_alias_conflict
...
if [[ "$campaign_operability_mode" != "1" \
