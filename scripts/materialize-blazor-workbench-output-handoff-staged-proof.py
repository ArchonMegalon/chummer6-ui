...
OUTPUT_PATH = Path(
    os.environ.get(
        "CHUMMER_BLAZOR_WORKBENCH_OUTPUT_HANDOFF_STAGED_PROOF_PATH",
        REPO_ROOT / ".codex-studio" / "published" / "BLAZOR_WORKBENCH_OUTPUT_HANDOFF_STAGED_PROOF.generated.json",
    )
)

CHECKS = [
    {
        "id": "product_workbench_output_handoff",
        "path": "Chummer.Blazor/Components/Pages/Preview.razor",
        "tokens": [
            "Browser-client output and export handoff",
            "data-workbench-output-handoff=\"strip\"",
            "Keep print, packet, and share paths explicit.",
            "Prepare a table-ready dossier packet.",
            "data-workbench-output-handoff-action=\"pdf_packet\"",
            "data-workbench-output-handoff-action=\"print_sheet\"",
            "data-workbench-output-handoff-action=\"html_summary\"",
            "data-workbench-output-handoff-action=\"share_link\"",
            "private const string CopyShareLinkCommand = \"copy_share_link\"",
            "private const string DownloadCharacterPackCommand = \"download_character_pack\"",
            "command: CopyShareLinkCommand",
            "command: DownloadCharacterPackCommand",
    ...
    {
        "id": "scoped_output_handoff_visual_design",
        "path": "Chummer.Blazor/Components/Pages/Preview.razor.css",
        "tokens": [
            ".browser-workbench-output-handoff",
            ".browser-workbench-output-handoff-copy",
            ".browser-workbench-output-handoff-actions",
    ...
    },
    {
        ...
        "tokens": [
            "workbench output-handoff posture",
            "blazor-workbench-output-handoff-staged-proof-check.sh",
    ...
    },
    {
        ...
        "tokens": [
            "WORKBENCH_OUTPUT_HANDOFF_STAGED_PROOF",
            "workbench_output_handoff_staged_status",
            "workbench_output_handoff_staged_source_checks",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route output-handoff source, style, status, and docs agree.",
    ...
    print(f"blazor_workbench_output_handoff_staged_proof:{receipt['status']} {OUTPUT_PATH}")
