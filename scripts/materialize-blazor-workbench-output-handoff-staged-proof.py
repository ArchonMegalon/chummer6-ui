...
CHECKS = [
    {
        ...
        "tokens": [
            "Workbench output and export handoff",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and proof-compatible workbench output-handoff source, style, status, and docs agree.",
