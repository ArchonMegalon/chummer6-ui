    ...
    add_check(
        ...
        contains_all(
            ...
            [
                ...
                "Configuration[AnalyticsProviderConfigKey]",
                "Configuration[RybbitSiteIdConfigKey]",
                "Configuration[RybbitScriptUrlConfigKey]",
                "Configuration[RybbitBaseUrlConfigKey]",
                "data-site-id",
    ...
    add_check(
        ...
        contains_all(
            ...
            [
                ...
                "maxQueueLength",
                "eventPrefix",
                "browserRouteEventName",
                "`${eventPrefix}${safeEventName}`",
                "allowedPropertyKeys",
                "propertyHostClass",
                ...
                "queryWorkspace",
                "queryFixture",
                "allowedPropertyKeys.has(normalized)",
                "return value;",
                "safeToken(query.get(queryCommand))",
                ...
                "routeFamilyChummerApp",
                "routeFamilyPreview",
                "routeFamilyShowcase",
                "routeFamilyDownloads",
                "routeFamilyDocs",
                "routeFamilyOther",
                "pathBlazor",
                "pathBlazorSlash",
    ...
    add_check(
        ...
        contains_all(
            ...
            [
                ...
                "AnalyticsProviderConfigKey = \"CHUMMER_ANALYTICS_PROVIDER\"",
                "RybbitSiteIdConfigKey = \"CHUMMER_RYBBIT_SITE_ID\"",
                "RybbitScriptUrlConfigKey = \"CHUMMER_RYBBIT_SCRIPT_URL\"",
                "RybbitBaseUrlConfigKey = \"CHUMMER_RYBBIT_BASE_URL\"",
                "configuration[AnalyticsProviderConfigKey]",
                "configuration[RybbitSiteIdConfigKey]",
                "configuration[RybbitScriptUrlConfigKey]",
                "configuration[RybbitBaseUrlConfigKey]",
                "AnalyticsProviderNone",
                "AnalyticsProviderRybbit",
                "AnalyticsSelfHostDefaultPolicy",
                "AnalyticsHostedPublicEdgePolicy",
                "AnalyticsSensitiveDataPolicy",
                "AnalyticsDisabledPolicy",
                ...
                "ExcludedDataClasses:",
                "BuildAnalyticsExcludedDataClasses",
                "RunnerIntelligencePrivacy.DefaultExcludedFields",
        ...
        "Chummer.Blazor /health reports non-secret analytics policy posture, including no-replay/no-autocapture policy, explicit metadata allowlist, analytics-specific exclusions, and shared Runner Intelligence sensitive-field exclusions for operators.",
    )
    ...
    add_check(
        ...
        contains_all(
            ...
            [
                ...
                "CHUMMER_ANALYTICS_PROVIDER=none",
                "CHUMMER_ANALYTICS_PROVIDER=rybbit",
                "does not emit runner names",
                "workspace or dossier identifiers",
                "owner identifiers",
                "XML",
                "payloads",
                "hashes",
    ...
    add_check(
        ...
        and contains_all(
            ...
            [
                ...
                "boolean fixture/workspace/dossier presence",
                "must not emit runner names",
                "session replay",
                "autocapture",
                "allowedMetadataFields",
                "excludedDataClasses",
                ...
                "has_dossier",
                "dossier identifiers",
                "presence fields remain booleans in the emitted payload",
                "selfHostDefault",
                "hostedPublicEdge",
                "sensitiveDataPolicy",
                "sessionReplayPolicy",
