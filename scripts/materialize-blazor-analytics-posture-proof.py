...
PUBLIC_EDGE_COMPOSE = Path("/docker/chummercomplete/chummer.run-services/docker-compose.public-edge.yml")
...
def main() -> int:
    ...
    add_check(
        ...
        "Chummer.Blazor/Components/App.razor conditionally renders the Rybbit script from configuration.",
    )
    ...
    add_check(
        ...
        "The Blazor shell event bridge emits route/workflow metadata instead of character payloads.",
    )
