...
CHECKS = [
    ...
    {
        "id": "result_panel_browser_output_receipts",
        "path": "Chummer.Blazor/Components/Shell/ResultPanel.razor",
        "tokens": [
            "private const string SaveCharacterCommandId = \"save_character\"",
            "string.Equals(State.LastCommandId, SaveCharacterCommandId, StringComparison.Ordinal)",
            "data-result-dispatch=\"save\"",
            "data-result-dispatch=\"download\"",
            "data-result-dispatch=\"export\"",
            "data-result-dispatch=\"print\"",
            "Browser save dispatch",
            "<strong>Dossier:</strong>",
            "persisted dossier state is marked saved and ready for continuity.",
            "Incoming {receipt.FormatId} payload before dossier merge.",
            "without changing the local dossier.",
            "before dossier/current-source/support-local",
            "current dossier, support status, and source toggles stay unchanged",
            "without changing local dossier state.",
            "Browser download dispatch",
            "Browser export dispatch",
            "Browser print dispatch",
        ],
    },
    {
        "id": "dialog_trust_receipt_dossier_copy",
        "path": "Chummer.Blazor/Components/Shell/DialogTrustReceiptText.cs",
        "tokens": [
