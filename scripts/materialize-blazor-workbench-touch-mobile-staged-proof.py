...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "private const string CompactMobileActionsCommand = \"compact_mobile_actions\"",
            "private const string KeyboardSafeLayoutCommand = \"keyboard_safe_layout\"",
            "private const string PointerHelpCommand = \"pointer_help\"",
            "command: ToggleTouchModeCommand",
            "command: AdjustWorkspaceZoomCommand",
            "command: DockMobilePanelsCommand",
            "command: CompactMobileActionsCommand",
            "command: KeyboardSafeLayoutCommand",
            "command: PointerHelpCommand",
...
def main() -> int:
    ...
    receipt = {
        ...
        "failures": failures,
        "notes": [
            "This receipt only proves that Chummer Online and /blazor/workbench compatibility route touch-mobile source, style, status, and docs agree.",
