...
OUTPUT_PATH = Path(
    os.environ.get(
        "CHUMMER_BLAZOR_WORKBENCH_CONTEXT_ACTIONS_STAGED_PROOF_PATH",
        REPO_ROOT / ".codex-studio" / "published" / "BLAZOR_WORKBENCH_CONTEXT_ACTIONS_STAGED_PROOF.generated.json",
    )
)
...
CHECKS = [
    {
        ...
        "tokens": [
            ...
            "data-workbench-context-actions-action=\"edit\"",
    ...
    {
        "id": "scoped_context_actions_visual_design",
        "path": "Chummer.Blazor/Components/Pages/Preview.razor.css",
        "tokens": [
            ".browser-workbench-context-actions",
            ".browser-workbench-context-actions-copy",
            ".browser-workbench-context-actions-list",
    ...
    },
    {
        ...
        "tokens": [
            "workbench context-actions posture",
            "blazor-workbench-context-actions-staged-proof-check.sh",
    ...
    },
    {
        ...
        "tokens": [
            "WORKBENCH_CONTEXT_ACTIONS_STAGED_PROOF",
            "workbench_context_actions_staged_status",
            "workbench_context_actions_staged_source_checks",
...
def main() -> int:
    ...
    print(f"blazor_workbench_context_actions_staged_proof:ok {OUTPUT_PATH}")
    return 0
