...
internal static class DesktopHorizonWorkbenchLauncher
{
    public static bool SupportsNativeWorkbench(string horizonId)
    {
        ...
        return horizonId switch
        {
            ...
            "alice" => true,
            "nexus_pan" => true,
            "ready_for_tonight" => true,
            "onramp" => true,
            "jackpoint" => true,
            "knowledge_fabric" => true,
            "runsite" => true,
            "run_control" => true,
            "runbook_press" => true,
            "table_pulse" => true,
    ...
    public static Task OpenAsync(Window owner, string headId, string horizonId, string? fallbackRelativeHref = null)
    {
        ...
        return horizonId switch
        {
            ...
            "nexus_pan" => DesktopNexusPanWindow.ShowAsync(owner, headId),
            "ready_for_tonight" => DesktopReadyForTonightWindow.ShowAsync(owner, headId),
            ...
            "runbook_press" => DesktopRunbookPressWindow.ShowAsync(owner, headId),
            ...
            "creator_os" => DesktopCreatorOsWindow.ShowAsync(owner, headId),
