...
Generated at: 2026-06-27T18:41:13.281871Z
...
- Active/productive/nonproductive shard runs: 1/1/0
...
- [HIGH] readiness_gap: Flagship readiness still contains open coverage keys outside the surface-level desktop parity matrix. desktop_client: Windows desktop exit gate proof is missing, not passed, or lacks payload/sample integrity proof., Chummer5A UI element parity audit still has unresolved release-blocking rows: Dice Initiative And Table Utilities (no/no), Sheet Export Print Viewer And Exchange (no/no)., Chummer5A UI element parity audit still reports open parity gaps: visual_no_count=2, behavioral_no_count=2.
