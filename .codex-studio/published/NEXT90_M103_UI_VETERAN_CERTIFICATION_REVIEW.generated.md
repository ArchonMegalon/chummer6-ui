...
| --- | --- | --- | --- | --- | ---: | --- |
| menu | Can a veteran find the same top-level command geography in the first minute? | Open the promoted Avalonia head and expand a primary menu to reveal command choices. | Chummer5a top menu roots remain visible as File, Edit, Special, Tools, Windows, and Help. | 02-menu-open-light.png | 3 | 75c893482ffcce61a844edd0468850cbc0a1641640e70c15b99780304311d122 |
| toolstrip | Can a veteran start normal character work from the same always-visible toolbar posture? | Inspect the initial shell and verify load, import, save, settings, support, and close actions stay in the toolstrip. | Classic flat workbench actions remain immediate toolbar buttons instead of dashboard cards. | 01-initial-shell-light.png | 3 | 5358c86b6073ee4bd757890dca43c8a3e7c95935c21efc43a766f7d66b3d9aaa |
